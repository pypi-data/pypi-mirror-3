...
class ConfFileParser(object):
    ...
    def darejob_desc(self, resource):

        desc = dict_section(self.config,resource )

        #do validation whether resource desc is useful other use minmum default values

        return desc


    def pilotjob_desc(self, resource):
    ...
    def wu_desc(self, resource):

        desc = dict_section(self.config, resource)

        #do validation whether wu desc is useful other use minmum default values

        return desc

    def ft_desc(self, resource):

        desc = dict_section(self.config, resource)

        #do validation whether file transfer desc is useful other use minmum default values

        return desc


    def dict_section(self, section):
