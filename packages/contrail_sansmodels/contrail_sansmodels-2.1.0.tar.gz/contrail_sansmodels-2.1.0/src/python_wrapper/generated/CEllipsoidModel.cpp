...
static PyMemberDef CEllipsoidModel_members[] = {
    {name_params, T_OBJECT, offsetof(CEllipsoidModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CEllipsoidModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CEllipsoidModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
static PyObject *evaluateOneDim(EllipsoidModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( EllipsoidModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CEllipsoidModelError, 
                   "CEllipsoidModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 */
static PyObject * calculate_ER(CEllipsoidModel *self) {
 ...
 */
static PyObject * calculate_VR(CEllipsoidModel *self) {
