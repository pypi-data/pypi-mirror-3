    ...
    def send(self, params_data):
        ...
        while Done == False:
            try:
                ...
                if e.reason[0] != 104:
                    print 'Connection reset by user - trying again...'
                    Done = True
            else:
                Done = True
...
class AutoAPI(object):
    ...
    def __call__(self, cls):
        ...
        NewClass.__handler_methods__ = handlers
...
def CreateNewClass(ClientClass, APIClass, autoload):
    ...
    class NewClass(ClientClass):
        ...
        __hidden__ = {}
        __old__ = {}
        __attrs_to_copy__ = ['__hidden__', '__old__', '__handlers_by_attr__']
        ...
        def __init__(self, *args, **kwargs):
            ...
            if self.__autoload__:
                self._update_()
            elif len(self.__require_to_load__)>0:
                """
        ...
        def __onRemoteResponse__(self, request_info, response):
            ...
            * Call a server-side function
            ...
            if attr in self.__api__.__exposed_attrs__ and operation=='pull':
                ...
                the object!
                """
                if attr in self.__require_to_load__:
