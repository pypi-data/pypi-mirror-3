...
setup(
    ...
    long_description="cache_toolbox is intended to be a lightweight series of independent tools to leverage caching within Django projects. Based on django-cache-toolbox by Playfire.com available at http://code.playfire.com/django-cache-toolbox",
