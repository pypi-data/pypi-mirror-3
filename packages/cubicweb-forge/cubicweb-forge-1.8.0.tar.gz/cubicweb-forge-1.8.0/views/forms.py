...
from cubicweb.selectors import is_instance, is_in_state, match_transition
...
class NotValidatedChangeView(ChangeStateFormView):
    ...
    def get_form(self, entity, transition, **kwargs):
        ...
        followup_form.add_hidden(eid_param('__cloned_eid', followup_tk.eid),
                                 entity.eid)
        followup_relation_field = RelationField(name='follow_up',
                                                 label=self._cw._('follow-up ticket'),
                                                 role='subject',
                                                 eidparam=True,
                                                 choices=[(entity.dc_title(), entity.eid)])
        followup_form.append_field(followup_relation_field)
