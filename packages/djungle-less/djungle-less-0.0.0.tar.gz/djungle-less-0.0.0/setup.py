...
# -*- coding: utf-8 -*-
#
# Djungle Less – The dynamic stylesheet language for Django.
...
"""
Installation script for djungle-less.
"""
...
def main():
    ...
    setup(
        name='djungle-less',
        version='0.0.0',
        description='The dynamic stylesheet language for Django',
        long_description=readme,
        author='Hendrik M Halkow',
        author_email='hendrik@halkow.com',
        url='https://github.com/djungle/djungle-less',
        classifiers=[
