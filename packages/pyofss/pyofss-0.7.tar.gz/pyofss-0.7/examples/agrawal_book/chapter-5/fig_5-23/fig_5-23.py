...
system.add( Fibre(length = length, gamma = gamma, beta = beta,
                  raman_scattering = True, rs_factor = T_R,
                  self_steepening = True, traces = 200, method = 'ARK4IP') )
system.run()
# ==============================================================================
...
z = stepper.storage.z * 1.0e5
# ==============================================================================
x, y = reduce_to_range( x, y, 71.9, 314.9 )
# ==============================================================================
map_plot( x, y, z, labels["nu"], labels["P_nu"], z_label,
          "lanczos", True, "5-23_map_nu.png", 100 )
# ==============================================================================
waterfall_plot( x, y, z, labels["nu"], z_label, labels["P_nu"],
                True, 0.2, "5-23_waterfall_nu.png", 100, (0.0, 1.1) )
# ==============================================================================
animated_plot( x, y, z, labels["nu"], labels["P_nu"], "$z = {0:7.3f} \, cm$", 
               (x[0], x[-1]), (0.0, 1.1), fps = stepper.traces / 5,
               frame_prefix = "nu_", filename = "5-23_animation_nu.avi" )
# ==============================================================================
stepper.storage.reduce_to_range( 0.9, 1.4 )
# ==============================================================================
x = stepper.storage.t
...
map_plot( x, y, z, labels["t"], labels["P_t"], z_label,
          "lanczos", True, "5-23_map_t.png", 100 )
# ==============================================================================
waterfall_plot( x, y, z, labels["t"], z_label, labels["P_t"],
                True, 0.2, "5-23_waterfall_t.png", 100, (0.0, 2.6) )
# ==============================================================================
animated_plot( x, y, z, labels["t"], labels["P_t"], "$z = {0:7.3f} \, cm$", 
               (x[0], x[-1]), (0.0, 2.6), fps = stepper.traces / 5,
               frame_prefix = "t_", filename = "5-23_animation_t.avi" )
# ==============================================================================
