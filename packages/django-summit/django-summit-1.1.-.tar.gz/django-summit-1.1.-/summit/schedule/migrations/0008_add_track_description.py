...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('schedule_track', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Track.description'
        db.delete_column('schedule_track', 'description')
