    ...
    def __init__(self, template_path):
        ...
        try:
            ...
            try:
                ...
                shutil.copytree(self.temp_project_path, self.template_path)
                self.modify_files()
            finally:
...
class UseProjectTemplate(object):
    ...
    def __init__(self, template_path, project_path, template_exts=None):
        ...
        shutil.copytree(self.template_path, self.project_path)
    ...
    def setup_jinja2_env(self):
        self.env.globals['random_secret_key'] = self.random_secret_key
    ...
    def modify_file(self, source):
        return self.env.from_string(source).render(dict(
