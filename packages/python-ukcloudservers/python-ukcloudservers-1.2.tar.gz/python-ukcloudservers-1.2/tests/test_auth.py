...
def test_authenticate_success():
    cs = ukcloudservers.CloudServers("username", "apikey")
...
def test_authenticate_failure():
    ...
    @mock.patch.object(httplib2.Http, "request", mock_request)
    def test_auth_call():
        assert_raises(ukcloudservers.Unauthorized, cs.client.authenticate)
        
    test_auth_call()
        
def test_auth_automatic():
    client = ukcloudservers.CloudServers("username", "apikey").client
...
def test_auth_manual():
    cs = ukcloudservers.CloudServers("username", "password")
