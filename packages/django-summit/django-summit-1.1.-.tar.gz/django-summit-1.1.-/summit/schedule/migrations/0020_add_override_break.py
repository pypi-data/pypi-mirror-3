...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.override_break'
        db.add_column('schedule_meeting', 'override_break', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.override_break'
        db.delete_column('schedule_meeting', 'override_break')
    ...
    models = {
        ...
        'schedule.meeting': {
            ...
            'override_break': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
