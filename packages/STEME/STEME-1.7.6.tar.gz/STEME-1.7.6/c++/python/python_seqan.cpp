...
static const unsigned long long index_max_seqs = ( unsigned long long )( std::numeric_limits< seq_index_t >::max() ) + 1;
static const unsigned long long index_max_seq_length = ( unsigned long long )( std::numeric_limits< seq_offset_t >::max() ) + 1;
static const unsigned long long index_max_text_length = ( unsigned long long )( std::numeric_limits< text_offset_t >::max() ) + 1;
