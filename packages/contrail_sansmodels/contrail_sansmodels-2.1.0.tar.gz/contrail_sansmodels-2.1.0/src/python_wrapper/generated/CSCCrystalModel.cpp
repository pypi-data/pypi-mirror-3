 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/sc.h
...
static PyObject * CSCCrystalModelError = NULL;
...
static void
CSCCrystalModel_dealloc(CSCCrystalModel* self)
{
...
static PyObject *
CSCCrystalModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CSCCrystalModel *self;
    
    self = (CSCCrystalModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CSCCrystalModel_init(CSCCrystalModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
...
static PyMemberDef CSCCrystalModel_members[] = {
    {name_params, T_OBJECT, offsetof(CSCCrystalModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CSCCrystalModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CSCCrystalModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CSCCrystalModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(SCCrystalModel* model, PyArrayObject *q){
 ...
 */
static PyObject * run(CSCCrystalModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(q,phi)
	    q_value = CSCCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CSCCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CSCCrystalModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CSCCrystalModel *self) {
 ...
 */
static PyObject * calculate_VR(CSCCrystalModel *self) {
...
static PyObject * reset(CSCCrystalModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CSCCrystalModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CSCCrystalModelError,
	    	"CSCCrystalModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "radius")) {
	    ...
	    PyErr_SetString(CSCCrystalModelError,
	    	"CSCCrystalModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CSCCrystalModel_methods[] = {
...
static PyTypeObject CSCCrystalModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CSCCrystalModel",             /*tp_name*/
    sizeof(CSCCrystalModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CSCCrystalModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CSCCrystalModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CSCCrystalModel_methods,             /* tp_methods */
    CSCCrystalModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CSCCrystalModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CSCCrystalModel_new,                 /* tp_new */
};
...
void addCSCCrystalModel(PyObject *module) {
    ...
    if (PyType_Ready(&CSCCrystalModelType) < 0)
        return;

    Py_INCREF(&CSCCrystalModelType);
