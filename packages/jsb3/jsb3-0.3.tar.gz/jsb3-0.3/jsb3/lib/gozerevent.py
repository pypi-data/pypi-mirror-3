...
""" 
    basic event used in jsb3. supports json dumping and loading plus toxml
    functionality. 
"""
...
from jsb3.contrib.xmlstream import NodeBuilder, XMLescape, XMLunescape
...
from jsb3.drivers.xmpp.namespace import attributes, subelements
