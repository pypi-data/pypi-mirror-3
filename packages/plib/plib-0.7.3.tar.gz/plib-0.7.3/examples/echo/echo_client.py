...
class in ``plib.classes``, which provides a simple way
of sending requests to servers and getting replies back.
It also illustrates how the ``plib.stdlib.io`` library
...
SocketClientWithTerminator = dotted_from_import(
    'plib.stdlib.io.%s' % iotype, "SocketClientWithTerminator")
