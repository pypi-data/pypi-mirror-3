...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('schedule_meeting', 'name', self.gf('summit.schedule.fields.NameField')(max_length=100))


    def backwards(self, orm):

        # Changing field 'Meeting.name'
        db.alter_column('schedule_meeting', 'name', self.gf('summit.schedule.fields.NameField')(max_length=50))
