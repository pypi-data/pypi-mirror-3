...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Meeting.videographer2'
        db.delete_column('schedule_meeting', 'videographer2_id')

        # Deleting field 'Meeting.videographer1'
        db.delete_column('schedule_meeting', 'videographer1_id')

        # Adding field 'Meeting.video'
        db.add_column('schedule_meeting', 'video', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Meeting.videographer2'
        db.add_column('schedule_meeting', 'videographer2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videographer2_set', null=True, to=orm['schedule.Attendee'], blank=True), keep_default=False)

        # Adding field 'Meeting.videographer1'
        db.add_column('schedule_meeting', 'videographer1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='videographer1_set', null=True, to=orm['schedule.Attendee'], blank=True), keep_default=False)

        # Deleting field 'Meeting.video'
        db.delete_column('schedule_meeting', 'video')
