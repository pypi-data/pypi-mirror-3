...
from acted.projects import config
...
projectsMessageFactory = MessageFactory('acted.projects')

#ivan
myPerm = "acted.projects: Add ACTED Project"
setDefaultRoles(myPerm, ("Manager","Editor","Contributor")) 
#ivan
