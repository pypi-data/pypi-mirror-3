...
class IThumbnailer(Interface):
    ...
    def createThumbnail(image, size, format='JPEG'):
        """Create a thumbnail for the given image
        
        Size is given as an (w,h) tuple
        """

    def createSquareThumbnail(image, size, source=None, format='JPEG'):
...
class IImageDisplayInfo(Interface):
    ...
    def getDisplaySize(display, forced=False):
    ...
    def getDisplayName(display=None, width=None, height=None):
        """Get matching name for the given size or display"""

    def getDisplay(display, format='jpeg'):
...
class IImageTag(Interface):
    ...
    def getTag(display=None, alt=None, title=None, width=None, height=None, **kw):
