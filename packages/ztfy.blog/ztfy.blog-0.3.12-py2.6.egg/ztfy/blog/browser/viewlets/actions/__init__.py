...
from ztfy.blog.browser.viewlets.actions.interfaces import IActionsViewletManager, IZMIActionsViewletManager
...
class BackToFrontMenu(MenuItem):
    ...
    @property
    def viewURL(self):
        adapter = queryMultiAdapter((self.context, IZTFYBlogLayer, self.__parent__), IDefaultView)
