...
from ztfy.blog.browser.interfaces import IDefaultView, ITopicAddFormMenuTarget
...
from ztfy.blog.browser.interfaces.skin import IEditFormButtons, ITopicIndexView
...
from ztfy.blog.browser.skin import BaseAddForm, BaseEditForm, BasePresentationEditForm, BaseIndexView
...
class BaseTopicIndexView(BaseIndexView):
    ...
    def update(self):
        ...
        self.renderers = [renderer for renderer in [queryMultiAdapter((paragraph, self, self.request), IParagraphRenderer) for paragraph in self.context.getVisibleParagraphs(self.request)]
