...
# -*- coding: utf-8 -*-
#
# Djungle head.js - fast JavaScript loading for Django
...
"""
Installation script for djungle-headjs.
"""
...
def main():
    ...
    setup(
        name='djungle-headjs',
        version='0.0.0',
        description='Fast JavaScript loading for Django',
        long_description=readme,
        author='Hendrik M Halkow',
        author_email='hendrik@halkow.com',
        url='https://github.com/djungle/djungle-headjs',
        classifiers=[
