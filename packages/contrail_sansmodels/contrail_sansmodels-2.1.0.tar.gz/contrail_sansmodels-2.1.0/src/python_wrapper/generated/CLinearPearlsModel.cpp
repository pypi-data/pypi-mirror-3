 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/linearpearls.h
...
static PyObject * CLinearPearlsModelError = NULL;
...
static void
CLinearPearlsModel_dealloc(CLinearPearlsModel* self)
{
...
static PyObject *
CLinearPearlsModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CLinearPearlsModel *self;
    
    self = (CLinearPearlsModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CLinearPearlsModel_init(CLinearPearlsModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new LinearPearlsModel();
        ...
        disp_dict = PyDict_New();
        self->model->edge_separation.dispersion->accept_as_source(visitor, self->model->edge_separation.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "edge_separation", disp_dict);
...
static PyMemberDef CLinearPearlsModel_members[] = {
    {name_params, T_OBJECT, offsetof(CLinearPearlsModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLinearPearlsModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLinearPearlsModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CLinearPearlsModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(LinearPearlsModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( LinearPearlsModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CLinearPearlsModelError, 
                   "CLinearPearlsModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CLinearPearlsModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->num_pearls = PyFloat_AsDouble( PyDict_GetItemString(self->params, "num_pearls") );
    self->model->scale = PyFloat_AsDouble( PyDict_GetItemString(self->params, "scale") );
    self->model->edge_separation = PyFloat_AsDouble( PyDict_GetItemString(self->params, "edge_separation") );
    self->model->sld_pearl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_pearl") );
    ...
    disp_dict = PyDict_GetItemString(self->dispersion, "edge_separation");
    self->model->edge_separation.dispersion->accept_as_destination(visitor, self->model->edge_separation.dispersion, disp_dict);

	
	// Get input and determine whether we have to supply a 1D or 2D return value.
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLinearPearlsModelError, 
	    	"CLinearPearlsModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CLinearPearlsModelError, 
                   "CLinearPearlsModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CLinearPearlsModelError, 
	    		"CLinearPearlsModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CLinearPearlsModelError, 
                   "CLinearPearlsModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CLinearPearlsModelError, 
                   "CLinearPearlsModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CLinearPearlsModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLinearPearlsModelError, 
	    	"CLinearPearlsModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CLinearPearlsModelError, 
	    		"CLinearPearlsModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CLinearPearlsModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CLinearPearlsModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CLinearPearlsModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CLinearPearlsModel *self) {
 ...
 */
static PyObject * calculate_VR(CLinearPearlsModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CLinearPearlsModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CLinearPearlsModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CLinearPearlsModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CLinearPearlsModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CLinearPearlsModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CLinearPearlsModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CLinearPearlsModelError,
	    	"CLinearPearlsModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    } else    if (!strcmp(par_name, "edge_separation")) {
        self->model->edge_separation.dispersion = dispersion;
    } else {
	    PyErr_SetString(CLinearPearlsModelError,
	    	"CLinearPearlsModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CLinearPearlsModel_methods[] = {
...
static PyTypeObject CLinearPearlsModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CLinearPearlsModel",             /*tp_name*/
    sizeof(CLinearPearlsModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CLinearPearlsModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CLinearPearlsModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CLinearPearlsModel_methods,             /* tp_methods */
    CLinearPearlsModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CLinearPearlsModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CLinearPearlsModel_new,                 /* tp_new */
};
...
void addCLinearPearlsModel(PyObject *module) {
    ...
    if (PyType_Ready(&CLinearPearlsModelType) < 0)
        return;

    Py_INCREF(&CLinearPearlsModelType);
    PyModule_AddObject(module, "CLinearPearlsModel", (PyObject *)&CLinearPearlsModelType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CLinearPearlsModel.error";
    CLinearPearlsModelError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CLinearPearlsModelError", CLinearPearlsModelError);
}
