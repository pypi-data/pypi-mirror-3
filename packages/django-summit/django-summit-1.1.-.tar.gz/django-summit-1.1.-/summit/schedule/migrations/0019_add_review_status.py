...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.approved'
        db.add_column('schedule_meeting', 'approved', self.gf('django.db.models.fields.CharField')(default='PENDING', max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.approved'
        db.delete_column('schedule_meeting', 'approved')
