...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('demo_cms_article', 'in_newsletter', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.in_newsletter'
        db.delete_column('demo_cms_article', 'in_newsletter')
