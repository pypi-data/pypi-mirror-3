...
class TwoPlayerCalculatorTests(CalculatorTests):
    ...
    def test_two_player_not_drawn(self):
        ...
        self.assertMatchQuality(0.447214, self.calculator.match_quality(game_info, teams))
    ...
    def test_two_player_drawn(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 1])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.447, self.calculator.match_quality(game_info, teams))
    ...
    def test_one_on_one_massive_upset_drawn(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 1])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.110, self.calculator.match_quality(game_info, teams))
...
class TwoTeamCalculatorTests(CalculatorTests):
    ...
    def test_two_on_two_unbalanced_draw(self):
        ...
        teams = Match([{1: (15.0, 8.0),
                      ...
                      rank=[1, 1])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.214, self.calculator.match_quality(game_info, teams))
    ...
    def test_two_on_two_upset(self):
        ...
        teams = Match([{1: (20.0, 8.0),
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.084, self.calculator.match_quality(game_info, teams))
    ...
    def test_one_on_two(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.135, self.calculator.match_quality(game_info, teams))
    ...
    def test_one_on_two_somewhat_balanced(self):
        ...
        teams = Match([{1: (40.0, 6.0)},
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.478, self.calculator.match_quality(game_info, teams))
    ...
    def test_one_on_three(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.012, self.calculator.match_quality(game_info, teams))
    ...
    def test_one_on_seven(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.000, self.calculator.match_quality(game_info, teams))
    ...
    def test_three_on_two(self):
        ...
        teams = Match([{1: (28.0, 7.0), 2: (27.0, 6.0), 3: (26.0, 5.0)},
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.254, self.calculator.match_quality(game_info, teams))
...
class MultipleTeamCalculatorTests(CalculatorTests):
    ...
    def test_two_on_four_on_two_win_draw(self):
        ...
        teams = Match([{1: (40.0, 4.0),
                      ...
                      rank=[1, 2, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.367, self.calculator.match_quality(game_info, teams))
    ...
    def test_three_teams_of_one_not_drawn(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2, 3])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.200, self.calculator.match_quality(game_info, teams))
    ...
    def test_four_teams_of_one_not_drawn(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2, 3, 4])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.089, self.calculator.match_quality(game_info, teams))
    ...
    def test_five_teams_of_one_not_drawn(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2, 3, 4, 5])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.040, self.calculator.match_quality(game_info, teams))
    ...
    def test_eight_teams_of_one_drawn(self):
        ...
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.004, self.calculator.match_quality(game_info, teams))
...
class PartialPlayCalculatorTests(CalculatorTests):
    ...
    def test_one_on_two_balanced_partial_play(self):
        ...
        teams = Match([{1: (25.0, 25.0 / 3)},
                      ...
                      rank=[1, 2])
        new_ratings = self.calculator.new_ratings(game_info, teams)
        self.assertMatchQuality(0.4472135955, self.calculator.match_quality(game_info, teams))
