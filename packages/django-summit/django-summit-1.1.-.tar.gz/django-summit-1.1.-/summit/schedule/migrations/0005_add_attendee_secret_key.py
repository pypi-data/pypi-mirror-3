...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attendee.secret_key_id'
        db.add_column('schedule_attendee', 'secret_key_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attendee.secret_key_id'
        db.delete_column('schedule_attendee', 'secret_key_id')
