...
class ProblemWriterUtils(coopr.opt.AbstractProblemWriter):
    ...
    def _Collect1(self,exp):
        ...
        if isinstance(exp,expr.Expression):
            ...
            #
                ...
                for i in xrange(len(exp._args)):
                    ...
                    elif isinstance(e,_VarValue):
                        if v != "0":
                            raise ValueError, "Two variables in ProductExpression:",e
                        e._sno = 0
                    elif not isinstance(e,NumericConstant) and not isinstance(e,_ParamValue):
        ...
        #
        elif not isinstance(exp,NumericConstant) and not isinstance(exp,_ParamValue):
    ...
    def _Collect2(self, exp, x, scale=1.0):
        ...
        if isinstance(exp,expr.Expression):
            ...
            #
                ...
                for i in xrange(len(exp._args)):
                    e = exp._args[i]
                    if isinstance(e,NumericConstant) or isinstance(e,_ParamValue):
                        c *= e.value
        ...
        # Variable
        #
        elif isinstance(exp,_VarValue) or isinstance(exp,Var):
