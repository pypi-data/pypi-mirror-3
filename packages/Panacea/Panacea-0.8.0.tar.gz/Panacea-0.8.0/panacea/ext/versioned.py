...
from panacea                import Integer, DateTime
from panacea.statements     import Statement
from panacea.properties     import EntityBuilder
from panacea.entity         import getmembers
...
class VersionedEntityBuilder(EntityBuilder):
    ...
    def after_table(self):
        ...
        for name, func in getmembers(entity, inspect.ismethod):
            if getattr(func, '_panacea_after_revert', False):
...
def after_revert(func):
    ...
    """
    func._panacea_after_revert = True
    return func
