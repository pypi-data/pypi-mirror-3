...
from storescrapper.tests.scrappers.store_with_correct_results_sync_forced \
import StoreWithCorrectResultsSyncForced


class TestStoreScriptsShouldReturnCorrectResultsWhenSyncForced(
    unittest.TestCase):

    def setUp(self):
        self.store = StoreWithCorrectResultsSyncForced
    ...
    def test_retrieve_product(self):
        ...
        expected_product = Product(u'sapphire-hd6850', {},
            u'http://dummystore.com/?product=sapphire-hd6850&'
                u'availability=not-available&price=105500',
            u'VideoCard', u'StoreWithCorrectResultsSyncForced')
        ...
        expected_product = Product(u'intel-core-i5-2500k',
            ...
            u'Processor', u'StoreWithCorrectResultsSyncForced')
