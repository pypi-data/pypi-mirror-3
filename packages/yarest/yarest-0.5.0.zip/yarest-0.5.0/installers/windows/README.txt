...
2. Open the "yarest-x86.nsi" file and change the "RootSrcDir"
   definition at the very top to match the build environment.
...
3. Open a terminal and change to the directory containing
   this file, then run "makensis yarest-x86.nsi".
...
be too difficult to create another set of x64 scripts.

1. Copy "x86.nsh" to "x64.nsh", review and modify definitions appropriately.

2. Copy "yarest-x86.nsi" to "yarest-x64.nsi", open it and modify
   the main include as well as the AppOutputFile appropriately.
