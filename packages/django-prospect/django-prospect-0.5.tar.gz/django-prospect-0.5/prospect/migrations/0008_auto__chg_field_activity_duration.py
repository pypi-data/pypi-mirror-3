...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.duration'
        db.alter_column('prospect_activity', 'duration', self.gf('django.db.models.fields.TimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'Activity.duration'
        db.alter_column('prospect_activity', 'duration', self.gf('django.db.models.fields.TimeField')(default=0))
    models = {
        'prospect.activity': {
