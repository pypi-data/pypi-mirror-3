...
def _kwargs():
    ...
    download_url  = 'http://downloads.sourceforge.net/tenjin/Tenjin-1.1.0.tar.gz'
    #download_url = 'http://jaist.dl.sourceforge.net/sourceforge/tenjin/Tenjin-1.1.0.tar.gz'
    license       = 'MIT License'
    platforms     = 'any'
    py_modules    = ['tenjin']
