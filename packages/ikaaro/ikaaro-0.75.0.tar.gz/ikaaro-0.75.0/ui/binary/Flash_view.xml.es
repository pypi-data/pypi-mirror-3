...
<stl:block xmlns:stl="http://www.hforge.org/xml-namespaces/stl" xmlns="http://www.w3.org/1999/xhtml">
  <p>
  To download this file, click on <a href=";download">${filename}</a>
  </p>
  <object codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=4,0,2,0">
    <param value="high" name="quality"></param>
      <embed type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" width="530" quality="high" src="."/>
  </object>
</stl:block>
