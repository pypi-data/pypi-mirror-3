...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Lead'
        db.create_table('schedule_lead', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('summit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Summit'])),
            ('track', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead', to=orm['schedule.Track'])),
            ('lead', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lead', to=orm['schedule.Attendee'])),
        ))
        db.send_create_signal('schedule', ['Lead'])


    def backwards(self, orm):
        
        # Deleting model 'Lead'
        db.delete_table('schedule_lead')
    ...
    models = {
        ...
        'schedule.lead': {
            ...
            'summit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Summit']"}),
            'track': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lead'", 'to': "orm['schedule.Track']"})
        },
        'schedule.meeting': {
