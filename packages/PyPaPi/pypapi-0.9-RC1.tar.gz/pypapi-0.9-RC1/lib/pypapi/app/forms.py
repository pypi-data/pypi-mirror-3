...
from pypapi.ui.cute.interfaces import IDataContext, IPyPaPiForm, IForm,\
     ...
     IMainWindow, IPyPaPiDialog, ISelectFormLite, IModel
...
class MainWindow(QtGui.QMainWindow):
    ...
    def createTaskActions(self, config):
        ...
        def createAction(form, group_name='generale'):
            if form.toplevel:
                ...
                action.folderrule = form.folderrule
    ...
    def createForm(self, action):
        ...
        try:
            ...
            if action.folderrule is not None:
                form.folderrule = action.folderrule
            if form is not None:
                form.edit(0)
        except Exception, e:
            ...
            QtGui.QMessageBox.warning(self, "Errore nella preparazione della maschera",
                                      ...
                                      QtGui.QMessageBox.Abort)
            return
        form.setWindowTitle(action.toolTip())
        return form
