...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'deliveryinfo', (
    ...
    models = {
        ...
        'messages.deliveryinfo': {
            'Meta': {'ordering': "['-timestamp']", 'object_name': 'DeliveryInfo', 'db_table': "u'deliveryinfo'"},
