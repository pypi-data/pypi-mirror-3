...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('user_addresses', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('address_type', self.gf('django.db.models.fields.IntegerField')(default=2)),
            ('load_balance', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('accounts', ['UserAddresses'])

        # Adding model 'UserProfile'
        db.create_table('profiles', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('send_report', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('scan_mail', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('sa_high_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('sa_low_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('account_type', self.gf('django.db.models.fields.IntegerField')(default=3)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('user_addresses')
