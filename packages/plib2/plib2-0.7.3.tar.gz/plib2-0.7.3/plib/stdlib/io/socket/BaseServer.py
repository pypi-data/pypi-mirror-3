...
class BaseServer(object):
    ...
    def terminate(self):
        """Tell the server to break out of the ``serve_forever`` loop.
        
        The standard socket servers in this library use the self-pipe
        trick mixin class ``SelfPipeServerMixin`` to override this
        method.
        """
        raise NotImplementedError
