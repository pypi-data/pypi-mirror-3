...
static PyObject * CCoreFourShellModelError = NULL;
...
static void
CCoreFourShellModel_dealloc(CCoreFourShellModel* self)
{
...
static PyObject *
CCoreFourShellModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CCoreFourShellModel *self;
    
    self = (CCoreFourShellModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CCoreFourShellModel_init(CCoreFourShellModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
...
/** Read double from PyObject
    ...
    @return double
*/
double CCoreFourShellModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(CoreFourShellModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( CoreFourShellModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CCoreFourShellModelError, 
                   "CCoreFourShellModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CCoreFourShellModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->sld_shell4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_shell4") );
    self->model->scale = PyFloat_AsDouble( PyDict_GetItemString(self->params, "scale") );
    self->model->sld_shell2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_shell2") );
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCoreFourShellModelError, 
	    	"CCoreFourShellModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CCoreFourShellModelError, 
                   "CCoreFourShellModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CCoreFourShellModelError, 
	    		"CCoreFourShellModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CCoreFourShellModelError, 
                   "CCoreFourShellModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CCoreFourShellModelError, 
                   "CCoreFourShellModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CCoreFourShellModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCoreFourShellModelError, 
	    	"CCoreFourShellModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CCoreFourShellModelError, 
	    		"CCoreFourShellModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CCoreFourShellModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CCoreFourShellModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CCoreFourShellModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CCoreFourShellModel *self) {
 ...
 */
static PyObject * calculate_VR(CCoreFourShellModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CCoreFourShellModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CCoreFourShellModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CCoreFourShellModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CCoreFourShellModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CCoreFourShellModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CCoreFourShellModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CCoreFourShellModelError,
	    	"CCoreFourShellModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "rad_core0")) {
	    ...
	    PyErr_SetString(CCoreFourShellModelError,
	    	"CCoreFourShellModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CCoreFourShellModel_methods[] = {
...
static PyTypeObject CCoreFourShellModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CCoreFourShellModel",             /*tp_name*/
    sizeof(CCoreFourShellModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CCoreFourShellModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CCoreFourShellModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CCoreFourShellModel_methods,             /* tp_methods */
    CCoreFourShellModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CCoreFourShellModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CCoreFourShellModel_new,                 /* tp_new */
};
...
void addCCoreFourShellModel(PyObject *module) {
    ...
    if (PyType_Ready(&CCoreFourShellModelType) < 0)
        return;

    Py_INCREF(&CCoreFourShellModelType);
