 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/surfacefractal.h
...
static PyObject * CSurfaceFractalModelError = NULL;
...
static void
CSurfaceFractalModel_dealloc(CSurfaceFractalModel* self)
{
...
static PyObject *
CSurfaceFractalModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CSurfaceFractalModel *self;
    
    self = (CSurfaceFractalModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CSurfaceFractalModel_init(CSurfaceFractalModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new SurfaceFractalModel();
        
        // Initialize parameter dictionary
        PyDict_SetItemString(self->params,"co_length",Py_BuildValue("d",500.000000000000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"radius",Py_BuildValue("d",10.000000000000));
        PyDict_SetItemString(self->params,"surface_dim",Py_BuildValue("d",2.000000000000));
...
static PyMemberDef CSurfaceFractalModel_members[] = {
    {name_params, T_OBJECT, offsetof(CSurfaceFractalModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CSurfaceFractalModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CSurfaceFractalModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CSurfaceFractalModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(SurfaceFractalModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( SurfaceFractalModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CSurfaceFractalModelError, 
                   "CSurfaceFractalModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CSurfaceFractalModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->co_length = PyFloat_AsDouble( PyDict_GetItemString(self->params, "co_length") );
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CSurfaceFractalModelError, 
	    	"CSurfaceFractalModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CSurfaceFractalModelError, 
                   "CSurfaceFractalModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CSurfaceFractalModelError, 
	    		"CSurfaceFractalModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CSurfaceFractalModelError, 
                   "CSurfaceFractalModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CSurfaceFractalModelError, 
                   "CSurfaceFractalModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CSurfaceFractalModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CSurfaceFractalModelError, 
	    	"CSurfaceFractalModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CSurfaceFractalModelError, 
	    		"CSurfaceFractalModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CSurfaceFractalModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CSurfaceFractalModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CSurfaceFractalModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CSurfaceFractalModel *self) {
 ...
 */
static PyObject * calculate_VR(CSurfaceFractalModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CSurfaceFractalModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CSurfaceFractalModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CSurfaceFractalModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CSurfaceFractalModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CSurfaceFractalModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CSurfaceFractalModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CSurfaceFractalModelError,
	    	"CSurfaceFractalModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
 ...
 {
	    PyErr_SetString(CSurfaceFractalModelError,
	    	"CSurfaceFractalModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CSurfaceFractalModel_methods[] = {
...
static PyTypeObject CSurfaceFractalModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CSurfaceFractalModel",             /*tp_name*/
    sizeof(CSurfaceFractalModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CSurfaceFractalModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CSurfaceFractalModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CSurfaceFractalModel_methods,             /* tp_methods */
    CSurfaceFractalModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CSurfaceFractalModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CSurfaceFractalModel_new,                 /* tp_new */
};
...
void addCSurfaceFractalModel(PyObject *module) {
    ...
    if (PyType_Ready(&CSurfaceFractalModelType) < 0)
        return;

    Py_INCREF(&CSurfaceFractalModelType);
    PyModule_AddObject(module, "CSurfaceFractalModel", (PyObject *)&CSurfaceFractalModelType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CSurfaceFractalModel.error";
    CSurfaceFractalModelError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CSurfaceFractalModelError", CSurfaceFractalModelError);
}
