/* Generated by Cython 0.14.1 on Mon Nov 21 23:16:49 2011 */
...
typedef __pyx_t_5numpy_int32_t __pyx_t_6pandas_11_cppsandbox_i4;
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6pandas_11_cppsandbox_i4 = { "i4", NULL, sizeof(__pyx_t_6pandas_11_cppsandbox_i4), 'I' };
...
static PyObject *__pyx_pf_6pandas_11_cppsandbox_map_indices(PyObject *__pyx_self, PyObject *__pyx_v_values); /*proto*/
static PyMethodDef __pyx_mdef_6pandas_11_cppsandbox_map_indices = {__Pyx_NAMESTR("map_indices"), (PyCFunction)__pyx_pf_6pandas_11_cppsandbox_map_indices, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_6pandas_11_cppsandbox_map_indices(PyObject *__pyx_self, PyObject *__pyx_v_values) {
  __pyx_t_6pandas_11_cppsandbox_i4 __pyx_v_i;
  __pyx_t_6pandas_11_cppsandbox_i4 __pyx_v_n;
  std::map<__pyx_t_6pandas_11_cppsandbox_i4,__pyx_t_6pandas_11_cppsandbox_i4> __pyx_v_mapping;
  ...
  __pyx_t_6pandas_11_cppsandbox_i4 __pyx_t_3;
  __pyx_t_6pandas_11_cppsandbox_i4 __pyx_t_4;
  __pyx_t_6pandas_11_cppsandbox_i4 __pyx_t_5;
  int __pyx_t_6;
  __Pyx_RefNannySetupContext("map_indices");
  __pyx_self = __pyx_self;
  __pyx_bstruct_values.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_values), __pyx_ptype_5numpy_ndarray, 1, "values", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_values, (PyObject*)__pyx_v_values, &__Pyx_TypeInfo_nn___pyx_t_6pandas_11_cppsandbox_i4, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_values = __pyx_bstruct_values.strides[0];
  __pyx_bshape_0_values = __pyx_bstruct_values.shape[0];

  /* "pandas/src/cppsandbox.pyx":11
 *         map[i4, i4] mapping
 * 
 *     mapping = map[i4, i4]()             # <<<<<<<<<<<<<<
 * 
 *     n = len(values)
 */
  __pyx_v_mapping = std::map<__pyx_t_6pandas_11_cppsandbox_i4,__pyx_t_6pandas_11_cppsandbox_i4>();

  /* "pandas/src/cppsandbox.pyx":13
 *     mapping = map[i4, i4]()
 * 
 *     n = len(values)             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
    ...
    } else if (unlikely(__pyx_t_5 >= __pyx_bshape_0_values)) __pyx_t_6 = 0;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    (__pyx_v_mapping[__pyx_v_i]) = (*__Pyx_BufPtrStrided1d(__pyx_t_6pandas_11_cppsandbox_i4 *, __pyx_bstruct_values.buf, __pyx_t_5, __pyx_bstride_0_values));
  }
  ...
  __Pyx_AddTraceback("pandas._cppsandbox.map_indices");
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_values);
 ...
 *         i4 i, n
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6pandas_11_cppsandbox_map_indices, NULL, __pyx_n_s_13); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__map_indices, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pandas/src/cppsandbox.pyx":1
