...
from jsb3.utils.generic import jsonstring
from jsb3.utils.lazydict import LazyDict
from jsb3.utils.url import useragent, geturl2
...
from jsb3.utils.url import posturl
from jsb3.lib.errors import NoSuchBotType
from jsb3.lib.threads import start_new_thread
from jsb3.lib.datadir import getdatadir
from jsb3.lib.jsbimport import import_byfile
from jsb3.imports import getfeedparser
...
try:
    from jsb3plugins.tinyurl import get_tinyurl
except ImportError:
    def get_tinyurl(url):
        return [url, ]
...
class HubbubItem(Persist):
    ...
    def __init__(self, name, url="", owner="", itemslist=['title', 'link'], watchchannels=[], running=1):
        filebase = getdatadir() + os.sep + 'plugs' + os.sep + 'jsb3.plugs.wave.hubbub' + os.sep + name
