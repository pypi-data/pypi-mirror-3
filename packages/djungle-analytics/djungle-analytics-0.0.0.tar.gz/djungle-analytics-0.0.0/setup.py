...
def main():
    ...
    setup(
        name='djungle-analytics',
        version='0.0.0',
        description='Django template tags for Google Analytics',
        long_description=readme,
        author='Hendrik M Halkow',
        author_email='hendrik@halkow.com',
        url='https://github.com/djungle/djungle-analytics',
        classifiers=[
        ...
        package_data={
            'djungle.analytics': [
                'static/djungle/analytics/*',
                'templates/djungle/analytics/*.html',
                'locale/*/LC_MESSAGES/*',
            ],
        },
