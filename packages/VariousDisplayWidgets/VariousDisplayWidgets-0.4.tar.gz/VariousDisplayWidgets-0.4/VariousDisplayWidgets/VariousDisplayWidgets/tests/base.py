...
def setup_product():
    ...
    import VariousDisplayWidgets.VariousDisplayWidgets
    zcml.load_config('configure.zcml', VariousDisplayWidgets.VariousDisplayWidgets)
    ...
    ztc.installPackage('VariousDisplayWidgets.VariousDisplayWidgets')
...
setup_product()
ptc.setupPloneSite(products=['VariousDisplayWidgets.VariousDisplayWidgets'])
