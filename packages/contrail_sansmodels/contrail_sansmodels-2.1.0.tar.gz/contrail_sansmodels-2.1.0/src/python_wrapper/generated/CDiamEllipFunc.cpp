 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/DiamEllip.h
...
static PyMemberDef CDiamEllipFunc_members[] = {
    {name_params, T_OBJECT, offsetof(CDiamEllipFunc, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CDiamEllipFunc, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CDiamEllipFunc, log), 0, def_log},
    {NULL}  /* Sentinel */
};
 ...
 */
static PyObject * calculate_VR(CDiamEllipFunc *self) {
...
static PyObject * set_dispersion(CDiamEllipFunc *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CDiamEllipFuncError,
	    	"CDiamEllipFunc.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "radius_a")) {
	    ...
	    PyErr_SetString(CDiamEllipFuncError,
	    	"CDiamEllipFunc.set_dispersion expects a valid parameter name.");
		return NULL;
	}
