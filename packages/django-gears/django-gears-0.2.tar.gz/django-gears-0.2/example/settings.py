...
SECRET_KEY = '7j%#8nuex!m&#=(0d%y^6sro5f3oqg1j$(0s!usw0qj&_kwl7r'
...
GEARS_ROOT = os.path.join(PROJECT_DIR, 'static')
...
os.environ['NODE_PATH'] = os.path.join(PROJECT_DIR, 'node_modules')
