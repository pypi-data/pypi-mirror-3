...
"""
    ...
    1) setup
        ...
        * you can run !udp-cfgsave and edit ~/.jsb/config/jsb3.plugs.socket.udp/config if need be.
...
from jsb3.utils.generic import strippedtxt
...
from jsb3.contrib.rijndael import rijndael
from jsb3.lib.persistconfig import PersistConfig
from jsb3.lib.callbacks import first_callbacks
