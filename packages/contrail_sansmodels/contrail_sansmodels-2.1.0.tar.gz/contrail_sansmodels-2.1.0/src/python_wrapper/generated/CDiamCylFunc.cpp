 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/DiamCyl.h
...
static PyMemberDef CDiamCylFunc_members[] = {
    {name_params, T_OBJECT, offsetof(CDiamCylFunc, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CDiamCylFunc, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CDiamCylFunc, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
static PyObject *evaluateOneDim(DiamCylFunc* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( DiamCylFunc* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CDiamCylFuncError, 
                   "CDiamCylFunc.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CDiamCylFunc *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CDiamCylFuncError, 
	    	"CDiamCylFunc.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CDiamCylFuncError, 
                   "CDiamCylFunc.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CDiamCylFuncError, 
	    		"CDiamCylFunc.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CDiamCylFuncError, 
                   "CDiamCylFunc.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CDiamCylFuncError, 
 ...
 */
static PyObject * calculate_ER(CDiamCylFunc *self) {
 ...
 */
static PyObject * calculate_VR(CDiamCylFunc *self) {
...
static PyObject * set_dispersion(CDiamCylFunc *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CDiamCylFuncError,
	    	"CDiamCylFunc.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "radius")) {
	    ...
	    PyErr_SetString(CDiamCylFuncError,
	    	"CDiamCylFunc.set_dispersion expects a valid parameter name.");
		return NULL;
	}
