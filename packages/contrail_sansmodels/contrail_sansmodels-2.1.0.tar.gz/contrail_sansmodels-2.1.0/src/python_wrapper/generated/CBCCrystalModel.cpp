 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/bcc.h
...
static PyObject * CBCCrystalModelError = NULL;
...
static void
CBCCrystalModel_dealloc(CBCCrystalModel* self)
{
...
static PyObject *
CBCCrystalModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CBCCrystalModel *self;
    
    self = (CBCCrystalModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CBCCrystalModel_init(CBCCrystalModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
...
static PyMemberDef CBCCrystalModel_members[] = {
    {name_params, T_OBJECT, offsetof(CBCCrystalModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CBCCrystalModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CBCCrystalModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CBCCrystalModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(BCCrystalModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( BCCrystalModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CBCCrystalModelError, 
                   "CBCCrystalModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CBCCrystalModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CBCCrystalModelError, 
	    	"CBCCrystalModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CBCCrystalModelError, 
                   "CBCCrystalModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CBCCrystalModelError, 
	    		"CBCCrystalModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CBCCrystalModelError, 
                   "CBCCrystalModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CBCCrystalModelError, 
                   "CBCCrystalModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CBCCrystalModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CBCCrystalModelError, 
	    	"CBCCrystalModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CBCCrystalModelError, 
	    		"CBCCrystalModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CBCCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CBCCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CBCCrystalModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_VR(CBCCrystalModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CBCCrystalModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CBCCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CBCCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CBCCrystalModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CBCCrystalModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CBCCrystalModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CBCCrystalModelError,
	    	"CBCCrystalModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "radius")) {
	    ...
	    PyErr_SetString(CBCCrystalModelError,
	    	"CBCCrystalModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CBCCrystalModel_methods[] = {
...
static PyTypeObject CBCCrystalModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CBCCrystalModel",             /*tp_name*/
    sizeof(CBCCrystalModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CBCCrystalModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CBCCrystalModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CBCCrystalModel_methods,             /* tp_methods */
    CBCCrystalModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CBCCrystalModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CBCCrystalModel_new,                 /* tp_new */
};
...
void addCBCCrystalModel(PyObject *module) {
    ...
    if (PyType_Ready(&CBCCrystalModelType) < 0)
        return;

    Py_INCREF(&CBCCrystalModelType);
    PyModule_AddObject(module, "CBCCrystalModel", (PyObject *)&CBCCrystalModelType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CBCCrystalModel.error";
    CBCCrystalModelError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CBCCrystalModelError", CBCCrystalModelError);
}
