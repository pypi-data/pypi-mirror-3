 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/core_shell.h
...
CCoreShellModel_init(CCoreShellModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"solvent_sld",Py_BuildValue("d",0.000003000000));
        ...
        PyDict_SetItemString(self->params,"shell_sld",Py_BuildValue("d",0.000002000000));
...
static PyMemberDef CCoreShellModel_members[] = {
    {name_params, T_OBJECT, offsetof(CCoreShellModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CCoreShellModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CCoreShellModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
static PyObject *evaluateOneDim(CoreShellModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( CoreShellModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CCoreShellModelError, 
                   "CCoreShellModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CCoreShellModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCoreShellModelError, 
	    	"CCoreShellModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CCoreShellModelError, 
                   "CCoreShellModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CCoreShellModelError, 
	    		"CCoreShellModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CCoreShellModelError, 
                   "CCoreShellModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CCoreShellModelError, 
 ...
 */
static PyObject * calculate_VR(CCoreShellModel *self) {
...
static PyObject * set_dispersion(CCoreShellModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CCoreShellModelError,
	    	"CCoreShellModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "radius")) {
	    ...
	    PyErr_SetString(CCoreShellModelError,
	    	"CCoreShellModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
