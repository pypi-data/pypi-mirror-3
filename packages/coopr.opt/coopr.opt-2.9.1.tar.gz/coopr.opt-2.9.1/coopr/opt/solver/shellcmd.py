...
class SystemCallSolver(OptSolver):
    ...
    def _presolve(self, *args, **kwds):
        ...
        if 'generateSymbolicLabels' in kwds:
            self.generateSymbolicLabels = kwds['generateSymbolicLabels']
            del kwds['generateSymbolicLabels']
    ...
    def _apply_solver(self):
        ...
        sys.stdout.flush()
        self._status = Bunch(rc=rc, log=log)
    ...
    def _execute_command(self,command):
        ...
        try:
            ...
            raise ApplicationError, msg % ( command.cmd, str(err) )
        sys.stdout.flush()
        return [rc,log]
