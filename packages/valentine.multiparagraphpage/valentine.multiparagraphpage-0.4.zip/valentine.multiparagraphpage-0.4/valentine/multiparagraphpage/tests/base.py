...
def setup_product():
    ...
    import valentine.multiparagraphpage
    zcml.load_config('configure.zcml', valentine.multiparagraphpage)
    ...
    ztc.installPackage('valentine.multiparagraphpage')
...
setup_product()
ptc.setupPloneSite(products=['valentine.multiparagraphpage'])
