...
class IAuthentication(Interface):
    """
    Marca posto per l'utility che registra la codifica base64 dell'autenticazione
    """

class IConfig(Interface):
    """
    Marca posto per l'utility che registra la configurazione dell'applicazione PyPaPi
    """