...
"Nonlinear Fiber Optics" book, using the NLSE simulation software, it does match
results using LaserFOAM.
"""
...
map_plot( x, y, z, labels["t"], labels["P_t"], labels["z"],
          "lanczos", True, "5-9_map_t.png", 100 )
# ==============================================================================
waterfall_plot( x, y, z, labels["t"], labels["z"], labels["P_t"],
                True, 0.2, "5-9_waterfall_t.png", 100, (0.0, 1.64) )
# ==============================================================================
animated_plot( x, y, z, labels["t"], labels["P_t"], "$z = {0:7.3f} \, km$", 
               (x[0], x[-1]), (0.0, 1.64), fps = stepper.traces / 5,
               frame_prefix = "t_", filename = "5-9_animation_t.avi" )
# ==============================================================================
