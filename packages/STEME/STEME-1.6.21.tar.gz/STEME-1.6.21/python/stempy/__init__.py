...
class SequenceSet(object):
    ...
    def __init__(self, fasta_filename, options):
        ...
        # self.index = build_index(self.seqs) # already done in read_sequences()
    ...
    def get_bg_model(self, W):
        ...
        if W not in self.bg_models:
            self.bg_models[W] = create_bg_model_from_base_likelihoods(W, self.data, self.lls, self.freqs_with_pseudo_counts)
