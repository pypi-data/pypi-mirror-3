...
from sans.models.sans_extension.c_models import CBCCrystalModel
import copy    

def create_BCCrystalModel():
    obj = BCCrystalModel()
    #CBCCrystalModel.__init__(obj) is called by BCCrystalModel constructor
    return obj

class BCCrystalModel(CBCCrystalModel, BaseComponent):
    """ 
    Class that evaluates a BCCrystalModel model. 
    This file was auto-generated from include/bcc.h.
    ...
    def set_dispersion(self, parameter, dispersion):
        ...
        """
        return CBCCrystalModel.set_dispersion(self, parameter, dispersion.cdisp)
