...
class IExport(Interface):
    ...
    exportcomments = schema.Bool(title=_(u'Export Comments'),
                                 description=_(u'Export comments by embedding them in content object data.'),
                                 required=False)
...
class IZipFileTransportCommentsView(IViewletManager):
    """ Marker interface for comments view. """
