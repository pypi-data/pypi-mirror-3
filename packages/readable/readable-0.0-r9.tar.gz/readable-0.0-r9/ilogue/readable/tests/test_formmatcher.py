...
from ilogue.readable.readablemock import assertMethod
from ilogue.readable.readablemock import assertionMethod
...
class FormMatcherTestCase(unittest.TestCase):
    ...
    def test_Submit_method_fails_if_multiple_forms_match(self):
        ...
        with self.assertRaisesRegexp(AssertionError, 'Multiple'):
            matcher.submit()
    ...
    def test_Accepts_matcher_for_submit_label(self):
        ...
        (assertionMethod(formMatcher.withSubmitButtonWithLabel)
