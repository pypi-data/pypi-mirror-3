...
def self_test():
    ...
    def test_plain_success_failure():
        ...
        # success, using single participant syntax, unfortunately in it is impossible
        # to pass arguments to the resource (**hooks), therefore we resort to simple void
        ...
        # failure, using single participant syntax, unfortunately in it is impossible
        # to pass arguments to the resource (**hooks), therefore we resort to simple void
