...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.from_launchpad'
        db.add_column('schedule_participant', 'from_launchpad', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participant.from_launchpad'
        db.delete_column('schedule_participant', 'from_launchpad')
