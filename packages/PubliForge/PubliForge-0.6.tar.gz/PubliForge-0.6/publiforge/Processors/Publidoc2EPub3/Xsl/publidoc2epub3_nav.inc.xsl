...
<!-- $Id: publidoc2epub3_nav.inc.xsl c24008cf2ab8 2012/06/02 16:20:06 patrick $ -->
      ...
      <html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops">
        ...
        <body class="pdocToc">
          ...
          <nav epub:type="toc" id="toc">
            ...
            <ol>
              <xsl:apply-templates select="topic[not(@type='title')]|division"
                                   mode="nav_toc"/>
            </ol>
          </nav>
          ...
          <nav epub:type="landmarks">
            ...
            <ol>
              ...
              <xsl:apply-templates select=".//topic[not(@type='title')]" mode="nav_landmarks"/>
            </ol>
          </nav>
        </body>
      </html>
