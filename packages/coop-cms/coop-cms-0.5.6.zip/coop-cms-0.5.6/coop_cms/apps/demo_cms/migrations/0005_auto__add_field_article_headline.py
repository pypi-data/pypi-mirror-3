...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('demo_cms_article', 'headline', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Article.headline'
        db.delete_column('demo_cms_article', 'headline')
