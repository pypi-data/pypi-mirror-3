# $Id: test_scripts_pfbuild.py 34ecf5b4306a 2012/05/18 18:00:08 patrick $
...
BUILD2HTML_FILE = join(ROOT, 'Examples', 'Builds', 'publidoc2xhtml.pfb.xml')
BUILD2EPUB_FILE = join(ROOT, 'Examples', 'Builds', 'publidoc2epub2.pfb.xml')
BUILD_ID = 'Test'
XML_ID = 'torture_test'
