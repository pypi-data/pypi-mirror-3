...
class BaseBrowser(object):
    ...
    use_real_cookie_file = property(_set_use_real_cookie_file, _get_use_real_cookie_file)    
    ...
    keep_alive = property(_set_keep_alive, _get_keep_alive)
