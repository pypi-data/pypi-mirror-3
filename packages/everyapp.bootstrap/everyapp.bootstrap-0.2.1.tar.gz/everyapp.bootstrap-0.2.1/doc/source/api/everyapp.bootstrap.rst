...
.. index:: api documentation; everyapp.bootstrap
.. _everyapp.bootstrap_mod:
.. _e.bootstrap_mod:

E.bootstrap (E.B)
=================

.. automodule:: everyapp.bootstrap
   :synopsis: Provides enhanced virtualenv environment creation facilities.
