...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.twitter_id'
        db.add_column('blog_status', 'twitter_id', self.gf('django.db.models.fields.BigIntegerField')(default='102938'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Status.twitter_id'
        db.delete_column('blog_status', 'twitter_id')
