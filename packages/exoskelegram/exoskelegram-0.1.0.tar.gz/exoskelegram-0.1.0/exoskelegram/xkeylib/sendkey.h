 ...
 * Abstract filename: exoskelegram.xkeylib.sendkey.h
 */

#ifndef EXOSKELEGRAM_SENDKEYHEADER
#define EXOSKELEGRAM_SENDKEYHEADER

#include "common.h"

unsigned char sendkey_send_key(int, bool);
