...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Newsletter.content'
        db.alter_column('coop_cms_newsletter', 'content', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PieceOfHtml.content'
        db.alter_column('coop_cms_pieceofhtml', 'content', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Newsletter.content'
        db.alter_column('coop_cms_newsletter', 'content', self.gf('html_field.db.models.fields.HTMLField')())

        # Changing field 'PieceOfHtml.content'
        db.alter_column('coop_cms_pieceofhtml', 'content', self.gf('html_field.db.models.fields.HTMLField')())
