...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('coop_cms_link', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Link.url'
        db.alter_column('coop_cms_link', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
