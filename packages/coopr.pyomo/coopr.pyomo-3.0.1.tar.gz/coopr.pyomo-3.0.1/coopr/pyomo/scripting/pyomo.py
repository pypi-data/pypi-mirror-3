...
def run_pyomo(options=Options(), parser=None):
    ...
    #
    util.finalize(options, model=model_data.model, instance=model_data.instance, results=results)
    #
    return Container(options=options, instance=model_data.instance, results=results)
