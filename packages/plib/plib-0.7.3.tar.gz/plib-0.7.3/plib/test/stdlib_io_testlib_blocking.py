#!/usr/bin/env python
"""
STDLIB_IO_TESTLIB_BLOCKING.PY -- utility module for PLIB.STDLIB I/O tests
...
from plib.classes import EchoRequestMixin

from plib.stdlib.io.blocking import (SocketClient, BaseRequestHandler, SocketServer,
...
if sys.platform != 'win32':
    ...
    from plib.stdlib.io.blocking import ForkingServer as _ForkingServer

from stdlib_io_testlib import IOClientMixin, IOServerMixin
