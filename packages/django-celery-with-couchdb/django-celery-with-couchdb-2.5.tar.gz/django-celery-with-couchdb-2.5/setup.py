...
setup(name='django-celery-with-couchdb',
      version='2.5',
      description='''Bundle installing the dependencies for Django-Celery and CouchDB''',
      ...
      license='''BSD''',
      zip_safe=False,
      install_requires=['django-celery>=2.5,<3.0', 'couchdb'],
      classifiers=[
