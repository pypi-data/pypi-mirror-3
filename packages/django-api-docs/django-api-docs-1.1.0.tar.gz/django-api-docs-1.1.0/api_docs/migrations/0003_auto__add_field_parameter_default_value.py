...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Parameter.default_value'
        db.add_column('api_docs_parameter', 'default_value', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Parameter.default_value'
        db.delete_column('api_docs_parameter', 'default_value')
