 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/lorentzian.h
...
CLorentzian_init(CLorentzian *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"gamma",Py_BuildValue("d",1.000000000000));
...
static PyMemberDef CLorentzian_members[] = {
    {name_params, T_OBJECT, offsetof(CLorentzian, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLorentzian, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLorentzian, log), 0, def_log},
    {NULL}  /* Sentinel */
};
 ...
 */
static PyObject * calculate_ER(CLorentzian *self) {
 ...
 */
static PyObject * calculate_VR(CLorentzian *self) {
