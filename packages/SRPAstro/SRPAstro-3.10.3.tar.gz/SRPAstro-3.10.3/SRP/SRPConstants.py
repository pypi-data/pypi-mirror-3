...
SRPNFilesComm	 = "Nr. of files to generate results"
SRPMethod        = "SRPMethodology"
SRPAVERAGE	 = "average"
SRPAVERAGESC     = "average sigma clipping %.1f"  
...
SRPPREKEYDICT = {SRPVLTFORSIMA:VLTFORSIMA, SRPLASCIMA:LASCIMA, SRPTNGDOLORESIMA:TNGDOLORESIMA,
 SRPASIAGOAFOSCIMA:ASIAGOAFOSCIMA, SRPVLTISAACIMA:VLTISAACIMA, SRPVLTFORSSPEC:VLTFORSSPEC,
 SRPNTTEMMIIMA:NTTEMMIIMA, SRPNOTALFOSCIMA:NOTALFOSCIMA, SRPDOSDOSCALTOCAFOSIMA:DOSDOSCALTOCAFOSIMA,
 SRPDANISHDFOSCIMA:DANISHDFOSCIMA, SRPVLTNACOIMA:VLTNACOIMA, SRPTNGNICSIMA:TNGNICSIMA, SRPREMROSSIMA:REMROSSIMA,
 SRPNTTSOFIIMA:NTTSOFIIMA, SRPVLTFORSIPOL:VLTFORSIPOL, SRPVLTXSHOOTER:VLTXSHOOTER, SRPTNGDOLORESSPEC:TNGDOLORESSPEC,
 SRPGEMINIGMOSIMA:GEMINIGMOSIMA}
