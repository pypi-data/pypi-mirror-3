 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/capcyl.h
...
static PyObject * CCappedCylinderModelError = NULL;
...
static void
CCappedCylinderModel_dealloc(CCappedCylinderModel* self)
{
...
static PyObject *
CCappedCylinderModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CCappedCylinderModel *self;
    
    self = (CCappedCylinderModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CCappedCylinderModel_init(CCappedCylinderModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new CappedCylinderModel();
        
        // Initialize parameter dictionary
        PyDict_SetItemString(self->params,"phi",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"len_cyl",Py_BuildValue("d",400.000000000000));
        PyDict_SetItemString(self->params,"sld_capcyl",Py_BuildValue("d",0.000001000000));
        ...
        PyDict_SetItemString(self->params,"rad_cap",Py_BuildValue("d",40.000000000000));
        PyDict_SetItemString(self->params,"sld_solv",Py_BuildValue("d",0.000006300000));
        PyDict_SetItemString(self->params,"rad_cyl",Py_BuildValue("d",20.000000000000));
        // Initialize dispersion / averaging parameter dict
        DispersionVisitor* visitor = new DispersionVisitor();
        PyObject * disp_dict;
        disp_dict = PyDict_New();
        self->model->rad_cyl.dispersion->accept_as_source(visitor, self->model->rad_cyl.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "rad_cyl", disp_dict);
        disp_dict = PyDict_New();
        self->model->len_cyl.dispersion->accept_as_source(visitor, self->model->len_cyl.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "len_cyl", disp_dict);
        disp_dict = PyDict_New();
        self->model->rad_cap.dispersion->accept_as_source(visitor, self->model->rad_cap.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "rad_cap", disp_dict);
        disp_dict = PyDict_New();
...
static PyMemberDef CCappedCylinderModel_members[] = {
    {name_params, T_OBJECT, offsetof(CCappedCylinderModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CCappedCylinderModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CCappedCylinderModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CCappedCylinderModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(CappedCylinderModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( CappedCylinderModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CCappedCylinderModelError, 
                   "CCappedCylinderModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CCappedCylinderModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->len_cyl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "len_cyl") );
    self->model->sld_capcyl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_capcyl") );
    self->model->scale = PyFloat_AsDouble( PyDict_GetItemString(self->params, "scale") );
    self->model->background = PyFloat_AsDouble( PyDict_GetItemString(self->params, "background") );
    self->model->theta = PyFloat_AsDouble( PyDict_GetItemString(self->params, "theta") );
    self->model->rad_cap = PyFloat_AsDouble( PyDict_GetItemString(self->params, "rad_cap") );
    self->model->sld_solv = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_solv") );
    self->model->rad_cyl = PyFloat_AsDouble( PyDict_GetItemString(self->params, "rad_cyl") );
    // Read in dispersion parameters
    PyObject* disp_dict;
    DispersionVisitor* visitor = new DispersionVisitor();
    disp_dict = PyDict_GetItemString(self->dispersion, "rad_cyl");
    self->model->rad_cyl.dispersion->accept_as_destination(visitor, self->model->rad_cyl.dispersion, disp_dict);
    disp_dict = PyDict_GetItemString(self->dispersion, "len_cyl");
    self->model->len_cyl.dispersion->accept_as_destination(visitor, self->model->len_cyl.dispersion, disp_dict);
    disp_dict = PyDict_GetItemString(self->dispersion, "rad_cap");
    self->model->rad_cap.dispersion->accept_as_destination(visitor, self->model->rad_cap.dispersion, disp_dict);
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCappedCylinderModelError, 
	    	"CCappedCylinderModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CCappedCylinderModelError, 
                   "CCappedCylinderModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CCappedCylinderModelError, 
	    		"CCappedCylinderModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CCappedCylinderModelError, 
                   "CCappedCylinderModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CCappedCylinderModelError, 
                   "CCappedCylinderModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CCappedCylinderModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCappedCylinderModelError, 
	    	"CCappedCylinderModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CCappedCylinderModelError, 
	    		"CCappedCylinderModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CCappedCylinderModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CCappedCylinderModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CCappedCylinderModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CCappedCylinderModel *self) {
 ...
 */
static PyObject * calculate_VR(CCappedCylinderModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CCappedCylinderModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CCappedCylinderModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CCappedCylinderModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CCappedCylinderModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CCappedCylinderModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CCappedCylinderModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CCappedCylinderModelError,
	    	"CCappedCylinderModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
	...
	// Ugliness necessary to go from python to C
	    // TODO: refactor this
    if (!strcmp(par_name, "rad_cyl")) {
        self->model->rad_cyl.dispersion = dispersion;
    } else    if (!strcmp(par_name, "len_cyl")) {
        self->model->len_cyl.dispersion = dispersion;
    } else    if (!strcmp(par_name, "rad_cap")) {
        self->model->rad_cap.dispersion = dispersion;
	    ...
	    PyErr_SetString(CCappedCylinderModelError,
	    	"CCappedCylinderModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CCappedCylinderModel_methods[] = {
...
static PyTypeObject CCappedCylinderModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CCappedCylinderModel",             /*tp_name*/
    sizeof(CCappedCylinderModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CCappedCylinderModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CCappedCylinderModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CCappedCylinderModel_methods,             /* tp_methods */
    CCappedCylinderModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CCappedCylinderModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CCappedCylinderModel_new,                 /* tp_new */
};
...
void addCCappedCylinderModel(PyObject *module) {
    ...
    if (PyType_Ready(&CCappedCylinderModelType) < 0)
        return;

    Py_INCREF(&CCappedCylinderModelType);
