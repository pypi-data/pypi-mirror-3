...
class Receiver(object):
    ...
    def get_raw_data(self, request, method):
        raise Exception("Receiver subclass needs to implement get_data!")
...
class FormReceiver(Receiver):
    ...
    def get_raw_data(self, request, method):
        raise Exception("Receiver subclass does not implement get_raw_data")
...
class JSONReceiver(SerializeReceiver):
    ...
    def get_raw_data(self, request, method):
        if 'GET' in method:
            return json.loads(request.raw_get_data)
        elif 'POST' in method:
            return json.loads(request.raw_put_data)
