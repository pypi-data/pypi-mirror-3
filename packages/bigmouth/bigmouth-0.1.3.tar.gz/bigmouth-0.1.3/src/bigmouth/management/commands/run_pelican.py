...
class Command(BaseCommand):
    ...
    function and pelican main, and we resolve this by declaring that the
    pelican config options must be placed in the Django settings file and so
    '--settings' will refer to the same module regardless. 


    eg. python manage.py run_pelican \
            -c bigmouth_example/conf.py
