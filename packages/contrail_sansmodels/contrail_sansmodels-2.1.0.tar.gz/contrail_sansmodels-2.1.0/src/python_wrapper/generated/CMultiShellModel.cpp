 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/multishell.h
...
static PyMemberDef CMultiShellModel_members[] = {
    {name_params, T_OBJECT, offsetof(CMultiShellModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CMultiShellModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CMultiShellModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
 ...
 */
static PyObject * calculate_VR(CMultiShellModel *self) {
