...
# Note:
#
# This particular resource depends on the module from which
# the transaction originates, therefore the shortcut versions
#
# pmnc.transaction.state.set("key", value)
#
# should not be used because that would access the state of module transaction.py
#
# Pythomnic3k project
