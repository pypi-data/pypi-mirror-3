...
def avgcycle(data, timeco = None, timewarp = None, cclose=False):
    if (timeco == None):
    ...
    for idata in range(len(data)):
        if (iscounted[idata] == False):
            ...
            tdatacosel = datacosel(data,cocosel = tempcosel)
            ...
            dataout.append(mean(datacosel(data,cocosel = tempcosel)))
