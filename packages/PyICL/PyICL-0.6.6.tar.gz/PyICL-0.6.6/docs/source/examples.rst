...
is represented as a separate interval in the result.
    ...
    ...         end = next(date)
    ...         result += pyicl.Interval(date, min(interval.upper, end - timedelta(1)))
    ...         date = end
    ...     return result 
...
Create the grids.
	...
	first day: [2008-06-22,2008-06-23)
	new week:  [2008-06-24,2008-06-30)
	new month: [2008-07-01,2008-07-07)
	new week:  [2008-07-08,2008-07-14)
	new week:  [2008-07-15,2008-07-21)
	new week:  [2008-07-22,2008-07-28)
	new week:  [2008-07-29,2008-07-31)
	new month: [2008-08-01,2008-08-04)
	new week:  [2008-08-05,2008-08-11)
	new week:  [2008-08-12,2008-08-18)
