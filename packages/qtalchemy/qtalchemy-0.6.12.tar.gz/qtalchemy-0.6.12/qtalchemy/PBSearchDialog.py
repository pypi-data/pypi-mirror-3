...
class PBSearchDialog(PBSearchableListDialog):
    """
    This class is intended to be used principally by the PBKeyEdit to provide a graphical search dialog which 
    is a little more featureful than can be packed into a basic combo box.
    ...
    def __init__(self, ssrc, entityCls, parent=None):
        ...
        select = buttonbox.addButton("Selec&t", QtGui.QDialogButtonBox.AcceptRole)
