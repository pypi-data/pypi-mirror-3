...
from Products.slideshowfolder.tests import base
...
def test_suite():
    ...
    return unittest.TestSuite([
        ...
        ztc.ZopeDocFileSuite(
            'tests/browser_slideshowplonesite.txt', package='Products.slideshowfolder',
            test_class=base.SlideshowFolderFunctionalTestCase,
