...
#if defined(WIN32)
    _getcwd(buf, 256);
#elif defined(MAC_ENV) && !defined(__MACH__)
    getcwd(buf, 256);
#elif defined(__MACH__)
  // CT.FIX nothing for CW9.1     
...
#if defined (WIN32)
  /* ihttp://msdn.microsoft.com/en-us/library/86cebhfs(v=vs.90).aspx */
