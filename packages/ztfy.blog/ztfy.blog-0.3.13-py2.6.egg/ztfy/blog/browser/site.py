...
from ztfy.blog.browser.skin import BaseDialogSimpleEditForm, BaseDialogEditForm, BaseEditForm, BasePresentationEditForm, \
...
class SiteManagerBackInfoEditForm(BaseDialogSimpleEditForm):
