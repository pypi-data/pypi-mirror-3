...
def setup_product():
    ...
    zcml.load_config('configure.zcml', collective.atimage.transformtoolbar)
    ...
    ztc.installPackage('collective.atimage.transformtoolbar')
...
class FunctionalTestCaseWithContent(FunctionalTestCase):
    ...
    def afterSetUp(self):
        ...
        # Image file at collective/atimage/transformtoolbar/tests/samples
        pkg_home = Common.package_home({'__name__': 'collective.atimage.transformtoolbar'})
