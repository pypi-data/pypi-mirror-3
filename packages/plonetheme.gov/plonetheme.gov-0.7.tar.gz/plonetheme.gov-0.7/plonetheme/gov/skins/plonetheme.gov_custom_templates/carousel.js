...
jQuery(function($) {
	...
	}, (($.browser.safari||$.browser.webkit) ? 1500 : 500)); // The 1500 value was 1250 but changed because it was still not working fine enough this is the loading delay time to fix the DOM issue described at the top of this script
	;
