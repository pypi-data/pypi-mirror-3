 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/vesicle.h
...
CVesicleModel_init(CVesicleModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"solv_sld",Py_BuildValue("d",0.000006360000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"thickness",Py_BuildValue("d",30.000000000000));
        PyDict_SetItemString(self->params,"radius",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"background",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"shell_sld",Py_BuildValue("d",0.000000500000));
...
static PyObject * evalDistribution(CVesicleModel *self, PyObject *args){
    ...
    self->model->solv_sld = PyFloat_AsDouble( PyDict_GetItemString(self->params, "solv_sld") );
 ...
 */
static PyObject * calculate_VR(CVesicleModel *self) {
