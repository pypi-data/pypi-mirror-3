...
class django_des_crypt(DjangoSaltedHash):
    ...
    ##@classmethod
    ##def from_des_crypt(cls, hash):
    ##    "quick helper to convert from des_crypt hash"
    ##    result = u"crypt$%s$%s" % (hash[:2], hash)
    ##    cls.from_string(result) # to validate
    ##    return uh.to_hash_str(result)
