...
// lino.js --- generated Sun Jul 15 17:39:45 2012 by Lino version 1.4.4.
...
Lino.polls.Polls.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    ...
    var id1 = { "fieldLabel": "ID", "xtype": "numberfield", "selectOnFocus": true, "anchor": "-20", "name": "id" };
    var question2 = new Ext.form.TextField({ "fieldLabel": "question", "name": "question", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var pub_date3 = new Lino.DateField({ "selectOnFocus": true, "fieldLabel": "date published", "anchor": "-20", "name": "pub_date" });
    var main_1_panel4 = new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 15, "autoHeight": true, "layout": "form", "xtype": "panel", "items": id1, "labelAlign": "top" }, { "flex": 60, "autoHeight": true, "layout": "form", "xtype": "panel", "items": question2, "labelAlign": "top" }, { "flex": 24, "autoHeight": true, "layout": "form", "xtype": "panel", "items": pub_date3, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "labelWidth": 135, "border": false, "labelAlign": "top" });
    var polls_ChoicesByPoll_grid12 = new Lino.polls.ChoicesByPoll.GridPanel({ "flex": 83, "hide_top_toolbar": true, "containing_panel": this, "viewConfig": { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." }, "tools": [ Lino.show_in_own_window_button(Lino.polls.ChoicesByPoll.default_action) ], "master_panel": this });
    var main_panel13 = new Ext.Panel({ "layout": "vbox", "layoutConfig": { "align": "stretch" }, "frame": true, "bodyBorder": false, "autoScroll": true, "items": [ main_1_panel4, polls_ChoicesByPoll_grid12 ], "hideCheckBoxLabels": true, "border": false, "labelAlign": "top" });
    this.items = main_panel13;
    this.before_row_edit = function(record) {
      polls_ChoicesByPoll_grid12.on_master_changed();
    }
...
Lino.lino.Home.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var PollsList_htmlbox14 = new Lino.HtmlBoxPanel({ "ls_bbar_actions": [ { "itemId": "insert_action", "text": "New", "must_save": true, "auto_save": true, "panel_btn_handler": function(panel){Lino.show_insert(panel)} } ], "name": "PollsList", "containing_panel": this, "items": new Ext.BoxComponent({autoScroll:true}), "title": "polls", "master_panel": this, "value": "<br/>", "always_enabled": true, "bodyStyle": "overflow-x:hidden !important;", "ls_insert_handler": Lino.polls.PollsList.insert_action, "layout": "fit", "tools": [ Lino.show_in_own_window_button(Lino.polls.PollsList.default_action) ] });
    var main_panel15 = new Ext.Panel({ "autoScroll": true, "labelWidth": 54, "items": [ PollsList_htmlbox14 ], "hideCheckBoxLabels": true, "layout": "fit", "frame": false, "border": false, "labelAlign": "top" });
    this.items = main_panel15;
    this.before_row_edit = function(record) {
      PollsList_htmlbox14.refresh();
    }
...
Lino.lino.SiteConfigs.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var default_build_method22 = new Lino.ChoicesFieldElement({ "store": [ [ "appyodt", "AppyOdtBuildMethod" ], [ "appypdf", "AppyPdfBuildMethod" ], [ "appyrtf", "AppyRtfBuildMethod" ], [ "latex", "LatexBuildMethod" ], [ "pisa", "PisaBuildMethod" ], [ "rtf", "RtfBuildMethod" ] ], "fieldLabel": "Default build method", "name": "default_build_method", "selectOnFocus": true, "anchor": "-20", "value": "appyodt", "hiddenName": "default_build_methodHidden" });
    var main_panel23 = new Ext.Panel({ "autoScroll": true, "labelWidth": 189, "items": [ { "items": default_build_method22, "autoHeight": true, "layout": "form", "xtype": "panel", "labelAlign": "top" } ], "hideCheckBoxLabels": true, "layout": "fit", "frame": false, "border": false, "labelAlign": "top" });
    this.items = main_panel23;
    this.before_row_edit = function(record) {
    }
...
Lino.polls.Polls.InsertFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var question25 = new Ext.form.TextField({ "fieldLabel": "question", "name": "question", "maxLength": 200, "selectOnFocus": true, "anchor": "-20", "allowBlank": false });
    var pub_date26 = new Lino.DateField({ "selectOnFocus": true, "fieldLabel": "date published", "anchor": "-20", "name": "pub_date" });
    var main_panel27 = new Ext.Panel({ "autoHeight": true, "layout": "form", "items": [ { "autoHeight": true, "layout": "form", "xtype": "panel", "items": question25, "anchor": "-20", "labelAlign": "top" }, { "autoHeight": true, "layout": "form", "xtype": "panel", "items": pub_date26, "anchor": "-20", "labelAlign": "top" } ], "frame": true, "bodyBorder": false, "autoScroll": true, "hideCheckBoxLabels": true, "labelWidth": 135, "border": false, "labelAlign": "top" });
...
Lino.lino.Models.DetailFormPanel = Ext.extend(Lino.FormPanel,{
  ...
  initComponent : function() {
    var containing_panel = this;
    var app_disp30 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "fieldLabel": "app_label", "name": "app", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var name_disp31 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "fieldLabel": "name", "name": "name", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var docstring_disp32 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "fieldLabel": "docstring", "name": "docstring", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var rows_disp33 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "fieldLabel": "Rows", "name": "rows", "anchor": "-20", "value": "<br/>", "always_enabled": true });
    var main_1_panel34 = new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 30, "autoHeight": true, "layout": "form", "xtype": "panel", "items": app_disp30, "labelAlign": "top" }, { "flex": 30, "autoHeight": true, "layout": "form", "xtype": "panel", "items": name_disp31, "labelAlign": "top" }, { "flex": 30, "autoHeight": true, "layout": "form", "xtype": "panel", "items": docstring_disp32, "labelAlign": "top" }, { "flex": 8, "autoHeight": true, "layout": "form", "xtype": "panel", "items": rows_disp33, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "labelWidth": 90, "border": false, "labelAlign": "top" });
    var lino_FieldsByModel_grid43 = new Lino.lino.FieldsByModel.GridPanel({ "flex": 62, "hide_top_toolbar": true, "containing_panel": this, "viewConfig": { "emptyText": "No data to display." }, "tools": [ Lino.show_in_own_window_button(Lino.lino.FieldsByModel.default_action) ], "master_panel": this });
    var main_panel44 = new Ext.Panel({ "layout": "vbox", "layoutConfig": { "align": "stretch" }, "frame": true, "bodyBorder": false, "autoScroll": true, "items": [ main_1_panel34, lino_FieldsByModel_grid43 ], "hideCheckBoxLabels": true, "border": false, "labelAlign": "top" });
    this.items = main_panel44;
    this.before_row_edit = function(record) {
      lino_FieldsByModel_grid43.on_master_changed();
    }
...
Lino.lino.SiteConfigs.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  ls_bbar_actions : [ { "itemId": "update_action", "text": "Save", "auto_save": false, "panel_btn_handler": function(panel){panel.save()} }, { "itemId": "insert_action", "text": "New", "must_save": true, "auto_save": true, "panel_btn_handler": function(panel){Lino.show_insert(panel)} }, { "itemId": "do_build", "text": "Rebuild site cache", "must_save": true, "auto_save": true, "panel_btn_handler": Lino.row_action_handler('buildjs') } ],
  title : "site configs",
  gc_name : 0,
  stripeRows : true,
  ls_quick_edit : true,
  ...
  initComponent : function() {
    ...
    var id45 = { "selectOnFocus": true, "xtype": "numberfield" };
    var default_build_method46 = new Lino.ChoicesFieldElement({ "selectOnFocus": true, "store": [ [ "appyodt", "AppyOdtBuildMethod" ], [ "appypdf", "AppyPdfBuildMethod" ], [ "appyrtf", "AppyRtfBuildMethod" ], [ "latex", "LatexBuildMethod" ], [ "pisa", "PisaBuildMethod" ], [ "rtf", "RtfBuildMethod" ] ], "value": "appyodt" });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "ID", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "renderer": Lino.id_renderer, "hidden": false, "editor": id45, "dataIndex": "id" }, { "colIndex": 1, "sortable": true, "header": "Default build method", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "dataIndex": "default_build_method", "hidden": false, "editor": default_build_method46 } ];
    Lino.lino.SiteConfigs.GridPanel.superclass.initComponent.call(this);
  }
});


Lino.lino.SiteConfigs.insert_actionPanel = Ext.extend(Lino.lino.SiteConfigs.DetailFormPanel,{
...
Lino.lino.SiteConfigs.insert_action = new Lino.WindowAction({  },function(){
  ...
  return new Lino.lino.SiteConfigs.insert_actionPanel(p);
});
...
Lino.polls.Polls.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  stripeRows : true,
  ls_quick_edit : true,
  ls_store_fields : [ { "type": "int", "name": "id" }, { "name": "question" }, { "type": "date", "name": "pub_date", "dateFormat": "d.m.Y" }, { "name": "disabled_fields" }, { "name": "disabled_actions" }, { "name": "disable_editing" } ],
  pk_index : 0,
  ls_grid_configs : [  ],
  ls_id_property : "id",
  page_length : 20,
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var id50 = { "selectOnFocus": true, "xtype": "numberfield" };
    var question51 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var pub_date52 = new Lino.DateField({ "selectOnFocus": true });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "ID", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "renderer": Lino.id_renderer, "hidden": false, "editor": id50, "dataIndex": "id" }, { "colIndex": 1, "sortable": true, "header": "question", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "dataIndex": "question", "hidden": false, "editor": question51 }, { "colIndex": 2, "sortable": true, "xtype": "datecolumn", "format": "d.m.Y", "editable": true, "filter": { "type": "date", "dateFormat": "d.m.Y" }, "header": "date published", "dataIndex": "pub_date", "hidden": false, "width": Lino.chars2width(8), "editor": pub_date52 } ];
...
Lino.polls.Choices.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  ls_bbar_actions : [ { "itemId": "delete_action", "text": "Delete", "auto_save": false, "panel_btn_handler": Lino.delete_selected }, { "itemId": "vote", "text": null, "must_save": true, "auto_save": true, "panel_btn_handler": Lino.row_action_handler('vote') } ],
  title : "choices",
  gc_name : 0,
  stripeRows : true,
  ls_quick_edit : true,
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id57 = { "selectOnFocus": true, "xtype": "numberfield" };
    var poll58 = new Lino.RemoteComboFieldElement({ "selectOnFocus": true, "store": new Lino.ComplexRemoteComboStore({ "proxy": new Ext.data.HttpProxy({ "url": "/choices/polls/Choices/poll", "method": "GET" }) }), "allowBlank": false, "pageSize": 20, "emptyText": "Select a poll..." });
    var choice59 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var votes60 = { "selectOnFocus": true, "xtype": "numberfield", "value": 0, "allowBlank": false };
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "ID", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "renderer": Lino.id_renderer, "hidden": false, "editor": id57, "dataIndex": "id" }, { "colIndex": 1, "sortable": true, "header": "poll", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "renderer": Lino.fk_renderer('pollHidden','Lino.polls.PollsList.detail_action'), "hidden": false, "editor": poll58, "dataIndex": "poll" }, { "colIndex": 2, "sortable": true, "header": "choice", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "dataIndex": "choice", "hidden": false, "editor": choice59 }, { "colIndex": 3, "sortable": true, "header": "votes", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "dataIndex": "votes", "hidden": false, "editor": votes60 } ];
...
Lino.polls.PollsList.GridPanel = Ext.extend(Lino.GridPanel,{
  viewConfig : { "getRowClass": Lino.getRowClass, "emptyText": "No data to display." },
  ls_url : "/polls/PollsList",
  ls_bbar_actions : [ { "itemId": "delete_action", "text": "Delete", "auto_save": false, "panel_btn_handler": Lino.delete_selected }, { "itemId": "insert_action", "text": "New", "must_save": true, "auto_save": true, "panel_btn_handler": function(panel){Lino.show_insert(panel)} }, { "itemId": "detail_action", "text": "Detail", "auto_save": true, "panel_btn_handler": Lino.show_detail } ],
  title : "polls",
  gc_name : 0,
  stripeRows : true,
  ...
  disabled_actions_index : 4,
  initComponent : function() {
    this.ls_detail_handler = Lino.polls.PollsList.detail_action;
    this.ls_insert_handler = Lino.polls.PollsList.insert_action;
    var ww = this.containing_window;
    var id66 = { "selectOnFocus": true, "xtype": "numberfield" };
    var question67 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var pub_date68 = new Lino.DateField({ "selectOnFocus": true });
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "ID", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "renderer": Lino.id_renderer, "hidden": false, "editor": id66, "dataIndex": "id" }, { "colIndex": 1, "sortable": true, "header": "question", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "dataIndex": "question", "hidden": false, "editor": question67 }, { "colIndex": 2, "sortable": true, "xtype": "datecolumn", "format": "d.m.Y", "editable": true, "filter": { "type": "date", "dateFormat": "d.m.Y" }, "header": "date published", "dataIndex": "pub_date", "hidden": false, "width": Lino.chars2width(8), "editor": pub_date68 } ];
    Lino.polls.PollsList.GridPanel.superclass.initComponent.call(this);
  }
});


Lino.polls.PollsList.insert_actionPanel = Ext.extend(Lino.polls.Polls.InsertFormPanel,{
  empty_title: "New polls",
  hide_navigator: true,
  ls_bbar_actions: [ { "itemId": "create_action", "text": "Create", "auto_save": false, "panel_btn_handler": function(panel){panel.save()} } ],
  ls_url: "/polls/PollsList",
  ...
  initComponent : function() {
    this.ls_detail_handler = Lino.polls.PollsList.detail_action;
    this.ls_insert_handler = Lino.polls.PollsList.insert_action;
    Lino.polls.PollsList.insert_actionPanel.superclass.initComponent.call(this);
  }
});

Lino.polls.PollsList.insert_action = new Lino.WindowAction({ "draggable": true, "width": Lino.chars2width(40), "autoHeight": true, "maximizable": true, "modal": true, "maximized": false },function(){
  var p = { "is_main_window": true, "hide_top_toolbar": true };
  return new Lino.polls.PollsList.insert_actionPanel(p);
});

Lino.polls.PollsList.detail_actionPanel = Ext.extend(Lino.polls.Polls.DetailFormPanel,{
  empty_title: "Detail polls",
  ls_bbar_actions: [ { "itemId": "update_action", "text": "Save", "auto_save": false, "panel_btn_handler": function(panel){panel.save()} }, { "itemId": "delete_action", "text": "Delete", "auto_save": false, "panel_btn_handler": Lino.delete_selected }, { "itemId": "insert_action", "text": "New", "must_save": true, "auto_save": true, "panel_btn_handler": function(panel){Lino.show_insert(panel)} } ],
  ls_url: "/polls/PollsList",
  action_name: "detail",
  initComponent : function() {
    this.ls_detail_handler = Lino.polls.PollsList.detail_action;
    this.ls_insert_handler = Lino.polls.PollsList.insert_action;
    Lino.polls.PollsList.detail_actionPanel.superclass.initComponent.call(this);
  }
});

Lino.polls.PollsList.detail_action = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.polls.PollsList.detail_actionPanel(p);
});
Lino.polls.PollsList.default_action = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  return new Lino.polls.PollsList.GridPanel(p);
});
...
Lino.polls.ChoicesByPoll.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var id8 = { "selectOnFocus": true, "xtype": "numberfield" };
    var choice9 = new Ext.form.TextField({ "selectOnFocus": true, "allowBlank": false, "maxLength": 200 });
    var votes10 = { "selectOnFocus": true, "xtype": "numberfield", "value": 0, "allowBlank": false };
    this.before_row_edit = function(record) {
    };
    this.ls_columns = [ { "colIndex": 0, "sortable": true, "header": "ID", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "renderer": Lino.id_renderer, "hidden": false, "editor": id8, "dataIndex": "id" }, { "colIndex": 1, "sortable": true, "header": "choice", "editable": true, "filter": { "type": "string" }, "width": Lino.chars2width(20), "dataIndex": "choice", "hidden": false, "editor": choice9 }, { "colIndex": 2, "sortable": true, "header": "votes", "editable": true, "filter": { "type": "numeric" }, "width": Lino.chars2width(5), "dataIndex": "votes", "hidden": false, "editor": votes10 } ];
...
Lino.lino.Models.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    ...
    var ww = this.containing_window;
    var app_disp76 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var name_disp77 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var docstring_disp78 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var rows_disp79 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.FieldsByModel.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var name_disp39 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var verbose_name_disp40 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var help_text_disp41 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.Inspector.GridPanel = Ext.extend(Lino.GridPanel,{
  ...
  initComponent : function() {
    var ww = this.containing_window;
    var i_name_disp88 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var i_type_disp89 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    var i_value_disp90 = new Ext.form.DisplayField({ "disabled": true, "readOnly": true, "value": "<br/>", "always_enabled": true });
    this.before_row_edit = function(record) {
    };
...
Lino.lino.Inspector.default_action = new Lino.WindowAction({  },function(){
  var p = { "is_main_window": true };
  var inspected92 = new Ext.form.TextField({ "selectOnFocus": true, "maxLength": 100, "fieldLabel": "Inspected object", "anchor": "-20", "name": "inspected" });
  var show_callables93 = new Ext.form.Checkbox({ "boxLabel": "show callables", "hideLabel": true, "checked": false, "name": "show_callables", "selectOnFocus": true, "anchor": "-20" });
  var main_panel94 = new Ext.form.FormPanel({layout:'fit', autoHeight: true, frame: true, items:new Ext.Panel({ "autoHeight": true, "layout": "hbox", "items": [ { "flex": 66, "autoHeight": true, "layout": "form", "xtype": "panel", "items": inspected92, "labelAlign": "top" }, { "flex": 33, "autoHeight": true, "layout": "form", "xtype": "panel", "items": show_callables93, "labelAlign": "top" } ], "frame": false, "layoutConfig": { "align": "stretchmax" }, "hideCheckBoxLabels": true, "labelWidth": 153, "border": false, "labelAlign": "top" })});
  p.params_panel = main_panel94;
  p.params_panel.fields = [ inspected92, show_callables93 ];
...
Lino.lino.Home.detail_action = new Lino.WindowAction({  },function(){
  var p = { "hide_top_toolbar": true, "is_home_page": true, "is_main_window": true, "hide_window_title": true };
