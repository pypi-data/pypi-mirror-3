...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('coop_cms_articlecategory', 'slug',
                      self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=100, separator=u'-', blank=True, default='', unique=True, populate_from='name', overwrite=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleCategory.slug'
        db.delete_column('coop_cms_articlecategory', 'slug')
