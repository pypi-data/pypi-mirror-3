...
class MobileWorks:
    ...
    def local(self, port = 8000):
        self.task_url = 'http://localhost:%d/api/v2/task/' % port
        self.job_url = 'http://localhost:%d/api/v2/job/' % port
    ...
    def sandbox(self):
        task_url = 'https://sandbox.mobileworks.com/api/v2/task/'
        job_url = 'https://sandbox.mobileworks.com/api/v2/job/'
