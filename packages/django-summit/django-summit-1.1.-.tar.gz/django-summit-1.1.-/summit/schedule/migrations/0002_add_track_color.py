...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('schedule_track', 'color', self.gf('django.db.models.fields.CharField')(default='FFFFFF', max_length=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Track.color'
        db.delete_column('schedule_track', 'color')
