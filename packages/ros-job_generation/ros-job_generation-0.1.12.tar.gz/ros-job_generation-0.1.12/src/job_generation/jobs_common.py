...
def generate_email(message, env):
    ...
    write_file(env['WORKSPACE']+'/test_results/_hudson/dummy.xml', '<testsuite><testcase classname"dummy" name="Dummy test"/> </testsuite>')    
    write_file(env['WORKSPACE']+'/test_results/0/_hudson/dummy.xml', '<testsuite><testcase classname"dummy" name="Dummy test"/> </testsuite>')
