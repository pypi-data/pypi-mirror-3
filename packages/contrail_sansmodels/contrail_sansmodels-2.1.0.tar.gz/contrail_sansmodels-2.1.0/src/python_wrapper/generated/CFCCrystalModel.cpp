 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/fcc.h
...
static PyObject * CFCCrystalModelError = NULL;
...
static void
CFCCrystalModel_dealloc(CFCCrystalModel* self)
{
...
static PyObject *
CFCCrystalModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CFCCrystalModel *self;
    
    self = (CFCCrystalModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CFCCrystalModel_init(CFCCrystalModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"dnn",Py_BuildValue("d",220.000000000000));
        PyDict_SetItemString(self->params,"sldSph",Py_BuildValue("d",0.000003000000));
        PyDict_SetItemString(self->params,"d_factor",Py_BuildValue("d",0.060000000000));
        PyDict_SetItemString(self->params,"psi",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"radius",Py_BuildValue("d",40.000000000000));
        ...
        disp_dict = PyDict_New();
        self->model->psi.dispersion->accept_as_source(visitor, self->model->psi.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "psi", disp_dict);
        disp_dict = PyDict_New();
...
static PyMemberDef CFCCrystalModel_members[] = {
    {name_params, T_OBJECT, offsetof(CFCCrystalModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CFCCrystalModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CFCCrystalModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CFCCrystalModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(FCCrystalModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( FCCrystalModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CFCCrystalModelError, 
                   "CFCCrystalModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CFCCrystalModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CFCCrystalModelError, 
	    	"CFCCrystalModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CFCCrystalModelError, 
                   "CFCCrystalModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CFCCrystalModelError, 
	    		"CFCCrystalModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CFCCrystalModelError, 
                   "CFCCrystalModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CFCCrystalModelError, 
                   "CFCCrystalModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CFCCrystalModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CFCCrystalModelError, 
	    	"CFCCrystalModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CFCCrystalModelError, 
	    		"CFCCrystalModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CFCCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CFCCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CFCCrystalModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CFCCrystalModel *self) {
 ...
 */
static PyObject * calculate_VR(CFCCrystalModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CFCCrystalModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CFCCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CFCCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CFCCrystalModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CFCCrystalModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CFCCrystalModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CFCCrystalModelError,
	    	"CFCCrystalModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    } else    if (!strcmp(par_name, "psi")) {
        self->model->psi.dispersion = dispersion;
    } else    if (!strcmp(par_name, "theta")) {
        self->model->theta.dispersion = dispersion;
    } else {
	    PyErr_SetString(CFCCrystalModelError,
	    	"CFCCrystalModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CFCCrystalModel_methods[] = {
...
static PyTypeObject CFCCrystalModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CFCCrystalModel",             /*tp_name*/
    sizeof(CFCCrystalModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CFCCrystalModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CFCCrystalModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CFCCrystalModel_methods,             /* tp_methods */
    CFCCrystalModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CFCCrystalModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CFCCrystalModel_new,                 /* tp_new */
};
...
void addCFCCrystalModel(PyObject *module) {
    ...
    if (PyType_Ready(&CFCCrystalModelType) < 0)
        return;

    Py_INCREF(&CFCCrystalModelType);
    PyModule_AddObject(module, "CFCCrystalModel", (PyObject *)&CFCCrystalModelType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CFCCrystalModel.error";
    CFCCrystalModelError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CFCCrystalModelError", CFCCrystalModelError);
}
