 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/stacked_disks.h
...
CStackedDisksModel_init(CStackedDisksModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"core_sld",Py_BuildValue("d",0.000004000000));
        PyDict_SetItemString(self->params,"core_thick",Py_BuildValue("d",10.000000000000));
        PyDict_SetItemString(self->params,"layer_thick",Py_BuildValue("d",15.000000000000));
        PyDict_SetItemString(self->params,"axis_theta",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"layer_sld",Py_BuildValue("d",-0.000000400000));
        PyDict_SetItemString(self->params,"axis_phi",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"solvent_sld",Py_BuildValue("d",0.000005000000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",0.010000000000));
        PyDict_SetItemString(self->params,"radius",Py_BuildValue("d",3000.000000000000));
        PyDict_SetItemString(self->params,"background",Py_BuildValue("d",0.001000000000));
        PyDict_SetItemString(self->params,"sigma_d",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"n_stacking",Py_BuildValue("d",1.000000000000));
...
static PyMemberDef CStackedDisksModel_members[] = {
    {name_params, T_OBJECT, offsetof(CStackedDisksModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CStackedDisksModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CStackedDisksModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
 ...
 */
static PyObject * calculate_VR(CStackedDisksModel *self) {
