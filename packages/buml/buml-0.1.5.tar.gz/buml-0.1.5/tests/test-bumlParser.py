...
def testTagAttrSplit():
    ...
    s="@content='text/html; encoding=UTF-8'@next"
    print p._tagAttrSplit(s)
    assert p._tagAttrSplit(s) == ('content', 'text/html; encoding=UTF-8', "@next")
...
def testParseGenAttr():
    ...
    s="words='here even =@.# and other ;!| should work'"
    print p._parseGenAttr(s)
    assert p._parseGenAttr(s) == ('words', 'here even =@.# and other ;!| should work')
