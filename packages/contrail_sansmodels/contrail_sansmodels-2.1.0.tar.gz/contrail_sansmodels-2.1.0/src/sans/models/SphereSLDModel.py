...
from sans.models.sans_extension.c_models import CSphereSLDModel
import copy    

def create_SphereSLDModel():
    obj = SphereSLDModel()
    #CSphereSLDModel.__init__(obj) is called by SphereSLDModel constructor
    return obj

class SphereSLDModel(CSphereSLDModel, BaseComponent):
    """ 
    Class that evaluates a SphereSLDModel model. 
    This file was auto-generated from include/spheresld.h.
    ...
    def set_dispersion(self, parameter, dispersion):
        ...
        """
        return CSphereSLDModel.set_dispersion(self, parameter, dispersion.cdisp)
