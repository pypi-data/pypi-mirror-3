# $Id: initialize.py 9ddfe78f66e6 2012/03/01 18:26:03 patrick $
...
class RootFactory(object):
    ...
    __acl__ = [
        ...
        (Allow, 'group:doc_modifier', 'doc.update'),
        (Allow, 'group:doc_manager', ('doc.update', 'doc.create')),
        (Allow, 'group:usr_viewer', 'usr.read'),
        (Allow, 'group:usr_modifier', ('usr.read', 'usr.update')),
        (Allow, 'group:usr_manager', ('usr.read', 'usr.update', 'usr.create')),
        (Allow, 'group:grp_viewer', 'grp.read'),
        (Allow, 'group:grp_modifier', ('grp.read', 'grp.update')),
        (Allow, 'group:grp_manager', ('grp.read', 'grp.update', 'grp.create')),
        (Allow, 'group:stg_viewer', 'stg.read'),
        (Allow, 'group:stg_modifier', ('stg.read', 'stg.update')),
        (Allow, 'group:stg_manager', ('stg.read', 'stg.update', 'stg.create')),
        (Allow, 'group:prj_viewer', 'prj.read'),
        (Allow, 'group:prj_modifier', ('prj.read', 'prj.update')),
