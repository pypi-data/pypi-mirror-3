...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArticleSection.ordering'
        db.add_column('coop_cms_articlesection', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ArticleSection.ordering'
        db.delete_column('coop_cms_articlesection', 'ordering')
