...
class IZipFileAdapter(Interface):
    """ Marker interface for export adapter. """

    def writeObjectToZipArchive(context, zipfile, comments):
        """ Write an object to the Zip archive. """

    def readObjectFromZipArchive(zipfile):
        """ Read object data from Zip archive. """
