...
class ISliderUtil(Interface):
    ...
    def render_inline(context=None):
        """
        Render a slide in a template somewhere else(a page template or easytemplate).
        Even if the slider is set to hidden, this will 
        render it. 
        """
...
class ISliderSettings(Interface):
    ...
    odd_speed = schema.Int(
        title=_(u"label_odd_speed_title_slider_setting", default=u"Odd Slide Speed"),
        description=_(u"label_odd_speed_description_slider_setting",
            default=u"Speed at which the slide will transition for odd numbered slides(0 to use normal speed setting)."),
        default=0
    )
    ...
    odd_pause = schema.Int(
        title=_(u"label_odd_pause_title_slider_setting", default=u"Odd Slide Pause"),
        description=_(u"label_odd_pause_description_slider_setting",
            default=u"How long the slide should pause before it is automatically transitioned for odd numbered slides(0 to use normal pause setting)."),
        default=0
    )
    ...
    navigation_buttons_rendering_type = schema.Choice(
        title=_(u"label_navigation_buttons_rendering_type_title", default=u"Navigation Buttons Rendering Type"),
        description=_(u"label_navigation_buttons_rendering_type_description", 
            default=u"Only for 'Navigation Buttons' navigation type. Used to customize the rendering of navigation buttons."),
        default=u"standard",
        vocabulary=SimpleVocabulary([
            SimpleTerm(value='standard', token='standard', title='Standard'),
            SimpleTerm(value='skip_even', token='skip_even', title='Skip Even Slides'),
    ...
    resume_play = schema.Bool(
        title=_(u"label_resume_play_title_slider_settings", default=u"Resume Play"),
...
class IPageSliderSettings(ISliderSettings):
    ...
    easytemplate_enabled = schema.Bool(
        title=_(u"label_easytemplate_enabled_title_slider_setting", default=u"Easy Template Enabled?"),
	    description=_(u"label_easytemplate_enabled_description_slider_setting",
	        default=u"If collective.easytemplate is installed, this will put it through the rendering engine"),
        default=False
    )
...
class IViewSliderSettings(ISliderSettings):
    ...
    allowed_types = schema.Tuple(
        title=_(u"label_allowed_types_title_slider_setting", default=u'Available Slide Types'),
    ...
    image_scale = schema.Choice(
        title=_(u"label_image_scale_title_slider_setting", default=u"Image Scale."),
