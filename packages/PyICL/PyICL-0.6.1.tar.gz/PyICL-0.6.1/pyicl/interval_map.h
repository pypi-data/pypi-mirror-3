...
struct interval_map_exposer {
	...
	PYICL_DECLARE_FN_1(bool, contains, ::boost::icl::contains, const exposed_t, (exposed_t, (interval_t, (element_t, (segment_t, (domain_t, BOOST_PP_NIL))))))
	...
	PYICL_DECLARE_FN_1(bool, disjoint, ::boost::icl::disjoint, const exposed_t, (exposed_t, (interval_t, (element_t, (segment_t, (domain_t, BOOST_PP_NIL))))))
	PYICL_DECLARE_FN_1(bool, intersects, ::boost::icl::intersects, const exposed_t, (exposed_t, (interval_t, (element_t, (segment_t, (domain_t, BOOST_PP_NIL))))))
	PYICL_DECLARE_FN_1(exposed_t, and_, ::boost::icl::operator&, const exposed_t, (exposed_t, (interval_t, (element_t, (segment_t, (set_t, (domain_t, BOOST_PP_NIL)))))))
	PYICL_DECLARE_FN_1(exposed_t, and_equals, ::boost::icl::operator&=, exposed_t, (exposed_t, (interval_t, (element_t, (segment_t, (domain_t, BOOST_PP_NIL))))))
