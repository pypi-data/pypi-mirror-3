...
class ResultsReader_sol(results.AbstractResultsReader):
    ...
    def __call__(self, filename, res=None, soln=None, suffixes=[]):
        ...
        # determine which suffixes we will bother loading into a solution.
        extract_duals = "dual" in suffixes
        ...
        if (objno[1] >= 0) and (objno[1] <= 99):
            ...
            res.solver.termination_condition = TerminationCondition.solverError
