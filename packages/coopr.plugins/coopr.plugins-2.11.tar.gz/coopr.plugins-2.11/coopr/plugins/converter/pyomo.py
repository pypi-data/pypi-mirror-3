...
class PyomoMIPConverter(ManagedSingletonPlugin):
    ...
    def apply(self, *args, **kwds):
        ...
        generate_symbolic_labels = kwds.pop('generateSymbolicLabels',False)
        ...
        if args[1] is ProblemFormat.cpxlp:
            ...
            if instance is not None:
                (problem_filename, varmap) = instance.write(filename=problem_filename, format=ProblemFormat.cpxlp, solver_capability=capabilities, generate_symbolic_labels=generate_symbolic_labels)
