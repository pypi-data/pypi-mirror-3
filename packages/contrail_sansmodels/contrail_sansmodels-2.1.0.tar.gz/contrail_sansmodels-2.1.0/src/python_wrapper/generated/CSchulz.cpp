 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/schulz.h
...
static PyMemberDef CSchulz_members[] = {
    {name_params, T_OBJECT, offsetof(CSchulz, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CSchulz, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CSchulz, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
static PyObject *evaluateOneDim(Schulz* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( Schulz* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CSchulzError, 
                   "CSchulz.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CSchulz *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CSchulzError, 
	    	"CSchulz.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CSchulzError, 
                   "CSchulz.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CSchulzError, 
	    		"CSchulz.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CSchulzError, 
                   "CSchulz.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CSchulzError, 
                   "CSchulz.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * calculate_ER(CSchulz *self) {
 ...
 */
static PyObject * calculate_VR(CSchulz *self) {
...
static PyObject * set_dispersion(CSchulz *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CSchulzError,
	    	"CSchulz.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
 ...
 {
	    PyErr_SetString(CSchulzError,
	    	"CSchulz.set_dispersion expects a valid parameter name.");
		return NULL;
	}
