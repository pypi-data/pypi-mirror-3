...
class LiveListTest(unittest.TestCase):
    ...
    def testLists(self):
        ...
        self.assertEqual([37, 41, 44, 53, 55], got)

        self.assertEqual(37, l[0].age)
        self.assertEqual(55, l[-1].age)
        self.assertEqual(44, l[2].age)
...
class LiveListTestWithTokens(LiveListTest):
    SERVICE = Service(LiveListTest.TEST_ROOT, token="T1h3x3Ndsa4ambE9x5Q5G4famKl")
