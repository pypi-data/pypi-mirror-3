...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_DIR, 'templates', 'rblog'),
)
...
# Disqus
DISQUS_API_KEY = 'EwqxJqqdSHZHX9mAqufQEF76Qi2VV3h0SWmiohpaNCCDlMuOJ4UQL0B3fAAxHHwL'
DISQUS_WEBSITE_SHORTNAME = 'vamosavidas'

# Keys
KEY_TLA = 'G963EF5LL6YDTQ66OU5X'
KEY_BACKLINKS = '2QGT-4B01-19CG'
KEY_ANALYTICS = 'UA-285119-7'
KEY_GOOGLE_VERIFY = 'LZuIJrKKUpuLTPuHJrrPxu24hJfi1xfoRnctQ_riWIM'
KEY_GOOGLE_CSE = '000290714138536141564:jls-jsfk58w'
