#!/usr/bin/env python
#
# $Id: __init__.py 1237 2011-12-14 17:56:08Z g.rodola $
#
...
from MadeiraCloudAgent.psutil.error import Error, NoSuchProcess, AccessDenied, TimeoutExpired
from MadeiraCloudAgent.psutil._compat import property
from MadeiraCloudAgent.psutil._common import (STATUS_RUNNING, STATUS_IDLE, STATUS_SLEEPING,
...
if sys.platform.lower().startswith("linux"):
    import MadeiraCloudAgent.psutil._pslinux
    from MadeiraCloudAgent.psutil._pslinux import (phymem_buffers,
                                 cached_phymem,
                                 IOPRIO_CLASS_NONE,
                                 IOPRIO_CLASS_RT,
                                 IOPRIO_CLASS_BE,
                                 IOPRIO_CLASS_IDLE)
    _psplatform = _pslinux
    phymem_buffers = _psplatform.phymem_buffers
    cached_phymem = _psplatform.cached_phymem

elif sys.platform.lower().startswith("win32"):
    import MadeiraCloudAgent.psutil._psmswindows as _psplatform
    from MadeiraCloudAgent.psutil._psmswindows import (ABOVE_NORMAL_PRIORITY_CLASS,
    ...
    import MadeiraCloudAgent.psutil._psosx as _psplatform

elif sys.platform.lower().startswith("freebsd"):
    import MadeiraCloudAgent.psutil._psbsd as _psplatform
...
def network_io_counters(pernic=False):
    ...
    """
    from MadeiraCloudAgent.psutil._common import ntuple_net_iostat
...
def disk_io_counters(perdisk=False):
    ...
    described above as the values.
    """
    from MadeiraCloudAgent.psutil._common import ntuple_disk_iostat
