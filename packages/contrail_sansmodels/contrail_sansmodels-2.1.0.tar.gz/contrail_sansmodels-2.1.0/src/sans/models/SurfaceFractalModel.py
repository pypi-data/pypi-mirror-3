...
def create_SurfaceFractalModel():
    ...
    #CSurfaceFractalModel.__init__(obj) is called by SurfaceFractalModel constructor
    return obj

class SurfaceFractalModel(CSurfaceFractalModel, BaseComponent):
    """ 
    Class that evaluates a SurfaceFractalModel model. 
    This file was auto-generated from include/surfacefractal.h.
    ...
    def __init__(self):
        ...
        ## Model description
        self.description =""" The scattering intensity  I(x) = scale*P(x)*S(x) + background, where
    ...
    def set_dispersion(self, parameter, dispersion):
        ...
        """
        return CSurfaceFractalModel.set_dispersion(self, parameter, dispersion.cdisp)
