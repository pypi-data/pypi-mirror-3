...
class Monitoring:
    ...
    def __init__(self, available):
        ...
        :param available: Dictionary of available monitors and their settings
        """
        self.monitors = {}
        for monitor, settings in available.iteritems():
            cls = self._monitor_mapper(monitor)
            if cls is not None:
                self.monitors[monitor] = cls(settings, self.DEFAULT_INTERVAL)
