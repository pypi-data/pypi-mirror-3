...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.temp_logo'
        db.add_column('coop_cms_article', 'temp_logo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.temp_logo'
        db.delete_column('coop_cms_article', 'temp_logo')
