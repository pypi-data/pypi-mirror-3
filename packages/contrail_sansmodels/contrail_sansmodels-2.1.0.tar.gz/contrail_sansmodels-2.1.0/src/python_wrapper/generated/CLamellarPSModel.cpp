 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/lamellarPS.h
...
static PyMemberDef CLamellarPSModel_members[] = {
    {name_params, T_OBJECT, offsetof(CLamellarPSModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLamellarPSModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLamellarPSModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
static PyObject *evaluateOneDim(LamellarPSModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( LamellarPSModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CLamellarPSModelError, 
                   "CLamellarPSModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CLamellarPSModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLamellarPSModelError, 
	    	"CLamellarPSModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CLamellarPSModelError, 
                   "CLamellarPSModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CLamellarPSModelError, 
	    		"CLamellarPSModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CLamellarPSModelError, 
                   "CLamellarPSModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CLamellarPSModelError, 
 ...
 */
static PyObject * calculate_ER(CLamellarPSModel *self) {
 ...
 */
static PyObject * calculate_VR(CLamellarPSModel *self) {
...
static PyObject * set_dispersion(CLamellarPSModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CLamellarPSModelError,
	    	"CLamellarPSModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
