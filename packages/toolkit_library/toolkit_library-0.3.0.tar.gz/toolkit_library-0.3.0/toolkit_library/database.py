...
Please specify something like '?charset=utf8' explicitly.""")
    ...
    def load_data(self, data):
        ...
        #Iterable of items
        elif hasattr(data, '__iter__') and all(isinstance(item, Database.BaseModel) for item in data):
    ...
    class BaseMeta(DeclarativeMeta):
        ...
        All other model metaclasses are either direcly or indirectly derived from this class.
        """
