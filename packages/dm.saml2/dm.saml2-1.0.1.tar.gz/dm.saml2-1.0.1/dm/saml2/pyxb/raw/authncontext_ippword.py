# ../../../dm/saml2/pyxb/raw/authncontext_ippword.py
# PyXB bindings for NM:8d9accc107c86eddd6a635bf6c76538ea9811a7e
# Generated 2012-02-07 09:42:35.115509 by PyXB version 1.1.3
...
Namespace = pyxb.namespace.NamespaceForURI(u'urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword', create_if_missing=True)
...
class STD_ANON (pyxb.binding.datatypes.integer):
    ...
    _ExpandedName = None
    _Documentation = None
STD_ANON._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON, value=pyxb.binding.datatypes.integer(3L))
...
class ExtensionOnlyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ExtensionOnlyType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
...
class LengthType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_LengthType_min', pyxb.binding.datatypes.integer, required=True)
    
    min = property(__min.value, __min.set, None, None)

    
    # Attribute max uses Python identifier max
    __max = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'max'), 'max', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_LengthType_max', pyxb.binding.datatypes.integer)
...
class RestrictedLengthType (LengthType):
    ...
    # Attribute min uses Python identifier min
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_LengthType_min', STD_ANON, required=True)
...
class SharedSecretChallengeResponseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SharedSecretChallengeResponseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
    ...
    __method = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SharedSecretChallengeResponseType_method', pyxb.binding.datatypes.anyURI)
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mechanism = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mechanism'), 'mechanism', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_CTD_ANON_mechanism', STD_ANON_, required=True)
...
class SecurityAuditType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SwitchAudit uses Python identifier SwitchAudit
    __SwitchAudit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SwitchAudit'), 'SwitchAudit', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SecurityAuditType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSwitchAudit', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SecurityAuditType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
...
class ComplexAuthenticatorType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SharedSecretChallengeResponse uses Python identifier SharedSecretChallengeResponse
    __SharedSecretChallengeResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse'), 'SharedSecretChallengeResponse', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSharedSecretChallengeResponse', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}AsymmetricDecryption uses Python identifier AsymmetricDecryption
    __AsymmetricDecryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption'), 'AsymmetricDecryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAsymmetricDecryption', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ComplexAuthenticator uses Python identifier ComplexAuthenticator
    __ComplexAuthenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ComplexAuthenticator'), 'ComplexAuthenticator', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordComplexAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}DigSig uses Python identifier DigSig
    __DigSig = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DigSig'), 'DigSig', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordDigSig', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ZeroKnowledge uses Python identifier ZeroKnowledge
    __ZeroKnowledge = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge'), 'ZeroKnowledge', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordZeroKnowledge', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}AsymmetricKeyAgreement uses Python identifier AsymmetricKeyAgreement
    __AsymmetricKeyAgreement = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement'), 'AsymmetricKeyAgreement', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAsymmetricKeyAgreement', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPassword', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SharedSecretDynamicPlaintext uses Python identifier SharedSecretDynamicPlaintext
    __SharedSecretDynamicPlaintext = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext'), 'SharedSecretDynamicPlaintext', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSharedSecretDynamicPlaintext', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SubscriberLineNumber uses Python identifier SubscriberLineNumber
    __SubscriberLineNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber'), 'SubscriberLineNumber', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSubscriberLineNumber', True)

    
    SubscriberLineNumber = property(__SubscriberLineNumber.value, __SubscriberLineNumber.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PreviousSession uses Python identifier PreviousSession
    __PreviousSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession'), 'PreviousSession', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPreviousSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordRestrictedPassword', True)

    
    RestrictedPassword = property(__RestrictedPassword.value, __RestrictedPassword.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}IPAddress uses Python identifier IPAddress
    __IPAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), 'IPAddress', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordIPAddress', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ResumeSession uses Python identifier ResumeSession
    __ResumeSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession'), 'ResumeSession', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordResumeSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}UserSuffix uses Python identifier UserSuffix
    __UserSuffix = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix'), 'UserSuffix', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordUserSuffix', True)
...
class AuthenticatorTransportProtocolType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ADSL uses Python identifier ADSL
    __ADSL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ADSL'), 'ADSL', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordADSL', False)

    
    ADSL = property(__ADSL.value, __ADSL.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}IPSec uses Python identifier IPSec
    __IPSec = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPSec'), 'IPSec', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordIPSec', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}MobileNetworkNoEncryption uses Python identifier MobileNetworkNoEncryption
    __MobileNetworkNoEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkNoEncryption'), 'MobileNetworkNoEncryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordMobileNetworkNoEncryption', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}MobileNetworkRadioEncryption uses Python identifier MobileNetworkRadioEncryption
    __MobileNetworkRadioEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkRadioEncryption'), 'MobileNetworkRadioEncryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordMobileNetworkRadioEncryption', False)

    
    MobileNetworkRadioEncryption = property(__MobileNetworkRadioEncryption.value, __MobileNetworkRadioEncryption.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}HTTP uses Python identifier HTTP
    __HTTP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), 'HTTP', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordHTTP', False)

    
    HTTP = property(__HTTP.value, __HTTP.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using bare HTTP utilizing no additional security\n        protocols.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PSTN uses Python identifier PSTN
    __PSTN = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PSTN'), 'PSTN', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPSTN', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}MobileNetworkEndToEndEncryption uses Python identifier MobileNetworkEndToEndEncryption
    __MobileNetworkEndToEndEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkEndToEndEncryption'), 'MobileNetworkEndToEndEncryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordMobileNetworkEndToEndEncryption', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ISDN uses Python identifier ISDN
    __ISDN = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ISDN'), 'ISDN', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordISDN', False)

    
    ISDN = property(__ISDN.value, __ISDN.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SSL uses Python identifier SSL
    __SSL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SSL'), 'SSL', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSSL', False)

    
    SSL = property(__SSL.value, __SSL.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using a transport mechnanism protected by an SSL or TLS\n        session.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}WTLS uses Python identifier WTLS
    __WTLS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'WTLS'), 'WTLS', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordWTLS', False)
...
class PublicKeyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PublicKeyType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
    ...
    __keyValidation = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'keyValidation'), 'keyValidation', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PublicKeyType_keyValidation', pyxb.binding.datatypes.anySimpleType)
...
class KeySharingType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __sharing = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sharing'), 'sharing', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_KeySharingType_sharing', pyxb.binding.datatypes.boolean, required=True)
...
class AuthnMethodBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PrincipalAuthenticationMechanism uses Python identifier PrincipalAuthenticationMechanism
    __PrincipalAuthenticationMechanism = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PrincipalAuthenticationMechanism'), 'PrincipalAuthenticationMechanism', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPrincipalAuthenticationMechanism', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Authenticator uses Python identifier Authenticator
    __Authenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Authenticator'), 'Authenticator', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}AuthenticatorTransportProtocol uses Python identifier AuthenticatorTransportProtocol
    __AuthenticatorTransportProtocol = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AuthenticatorTransportProtocol'), 'AuthenticatorTransportProtocol', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAuthenticatorTransportProtocol', False)
...
class KeyStorageType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __medium = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'medium'), 'medium', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_KeyStorageType_medium', mediumType, required=True)
...
class ActivationLimitUsagesType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __number = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'number'), 'number', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationLimitUsagesType_number', pyxb.binding.datatypes.integer, required=True)
...
class SecretKeyProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SecretKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}KeyActivation uses Python identifier KeyActivation
    __KeyActivation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyActivation'), 'KeyActivation', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SecretKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordKeyActivation', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}KeyStorage uses Python identifier KeyStorage
    __KeyStorage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyStorage'), 'KeyStorage', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_SecretKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordKeyStorage', False)
...
class TimeSyncTokenType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __SeedLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'SeedLength'), 'SeedLength', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TimeSyncTokenType_SeedLength', pyxb.binding.datatypes.integer, required=True)
    
    SeedLength = property(__SeedLength.value, __SeedLength.set, None, None)

    
    # Attribute DeviceType uses Python identifier DeviceType
    __DeviceType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'DeviceType'), 'DeviceType', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TimeSyncTokenType_DeviceType', DeviceTypeType, required=True)
    ...
    __DeviceInHand = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'DeviceInHand'), 'DeviceInHand', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TimeSyncTokenType_DeviceInHand', booleanType, required=True)
...
class AlphabetType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __case = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'case'), 'case', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AlphabetType_case', pyxb.binding.datatypes.string)
    
    case = property(__case.value, __case.set, None, None)

    
    # Attribute excludedChars uses Python identifier excludedChars
    __excludedChars = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'excludedChars'), 'excludedChars', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AlphabetType_excludedChars', pyxb.binding.datatypes.string)
    ...
    __requiredChars = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'requiredChars'), 'requiredChars', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AlphabetType_requiredChars', pyxb.binding.datatypes.string, required=True)
...
class PrincipalAuthenticationMechanismType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Token uses Python identifier Token
    __Token = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Token'), 'Token', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordToken', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ActivationPin uses Python identifier ActivationPin
    __ActivationPin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationPin'), 'ActivationPin', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordActivationPin', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPassword', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordRestrictedPassword', False)

    
    RestrictedPassword = property(__RestrictedPassword.value, __RestrictedPassword.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Smartcard uses Python identifier Smartcard
    __Smartcard = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Smartcard'), 'Smartcard', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSmartcard', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
    ...
    __preauth = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'preauth'), 'preauth', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrincipalAuthenticationMechanismType_preauth', pyxb.binding.datatypes.integer)
...
class PasswordType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Alphabet uses Python identifier Alphabet
    __Alphabet = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Alphabet'), 'Alphabet', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAlphabet', False)

    
    Alphabet = property(__Alphabet.value, __Alphabet.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Length uses Python identifier Length
    __Length = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Length'), 'Length', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordLength', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Generation uses Python identifier Generation
    __Generation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Generation'), 'Generation', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordGeneration', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
    ...
    __ExternalVerification = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ExternalVerification'), 'ExternalVerification', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PasswordType_ExternalVerification', pyxb.binding.datatypes.anyURI)
...
class RestrictedPasswordType (PasswordType):
    ...
    # Element Extension ({urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension) inherited from {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PasswordType
    
    # Element Length uses Python identifier Length_
    __Length_ = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'Length'), 'Length_', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_RestrictedPasswordType_Length', False)

    
    Length_ = property(__Length_.value, __Length_.set, None, None)

    
    # Element Generation ({urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Generation) inherited from {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PasswordType
...
class ActivationPinType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Length uses Python identifier Length
    __Length = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Length'), 'Length', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordLength', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ActivationLimit uses Python identifier ActivationLimit
    __ActivationLimit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimit'), 'ActivationLimit', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordActivationLimit', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Generation uses Python identifier Generation
    __Generation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Generation'), 'Generation', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordGeneration', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Alphabet uses Python identifier Alphabet
    __Alphabet = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Alphabet'), 'Alphabet', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAlphabet', False)
...
class IdentificationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}GoverningAgreements uses Python identifier GoverningAgreements
    __GoverningAgreements = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreements'), 'GoverningAgreements', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordGoverningAgreements', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PhysicalVerification uses Python identifier PhysicalVerification
    __PhysicalVerification = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PhysicalVerification'), 'PhysicalVerification', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPhysicalVerification', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}WrittenConsent uses Python identifier WrittenConsent
    __WrittenConsent = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'WrittenConsent'), 'WrittenConsent', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordWrittenConsent', False)
    ...
    __nym = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'nym'), 'nym', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_IdentificationType_nym', nymType)
...
class GoverningAgreementsType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}GoverningAgreementRef uses Python identifier GoverningAgreementRef
    __GoverningAgreementRef = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreementRef'), 'GoverningAgreementRef', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_GoverningAgreementsType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordGoverningAgreementRef', True)
...
class AuthnContextDeclarationBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}OperationalProtection uses Python identifier OperationalProtection
    __OperationalProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'OperationalProtection'), 'OperationalProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordOperationalProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}AuthnMethod uses Python identifier AuthnMethod
    __AuthnMethod = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AuthnMethod'), 'AuthnMethod', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordAuthnMethod', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}TechnicalProtection uses Python identifier TechnicalProtection
    __TechnicalProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TechnicalProtection'), 'TechnicalProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordTechnicalProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Identification uses Python identifier Identification
    __Identification = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Identification'), 'Identification', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordIdentification', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}GoverningAgreements uses Python identifier GoverningAgreements
    __GoverningAgreements = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreements'), 'GoverningAgreements', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordGoverningAgreements', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
    ...
    __ID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ID'), 'ID', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthnContextDeclarationBaseType_ID', pyxb.binding.datatypes.ID)
...
class KeyActivationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ActivationPin uses Python identifier ActivationPin
    __ActivationPin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationPin'), 'ActivationPin', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_KeyActivationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordActivationPin', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_KeyActivationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
...
class AuthenticatorBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPassword', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}IPAddress uses Python identifier IPAddress
    __IPAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), 'IPAddress', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_AuthenticatorBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordIPAddress', False)
...
class TechnicalProtectionBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}PrivateKeyProtection uses Python identifier PrivateKeyProtection
    __PrivateKeyProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PrivateKeyProtection'), 'PrivateKeyProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordPrivateKeyProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SecretKeyProtection uses Python identifier SecretKeyProtection
    __SecretKeyProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SecretKeyProtection'), 'SecretKeyProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSecretKeyProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
...
class ActivationLimitType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ActivationLimitSession uses Python identifier ActivationLimitSession
    __ActivationLimitSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitSession'), 'ActivationLimitSession', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationLimitType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordActivationLimitSession', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ActivationLimitUsages uses Python identifier ActivationLimitUsages
    __ActivationLimitUsages = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitUsages'), 'ActivationLimitUsages', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationLimitType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordActivationLimitUsages', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}ActivationLimitDuration uses Python identifier ActivationLimitDuration
    __ActivationLimitDuration = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitDuration'), 'ActivationLimitDuration', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationLimitType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordActivationLimitDuration', False)
...
class GoverningAgreementRefType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __governingAgreementRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'governingAgreementRef'), 'governingAgreementRef', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_GoverningAgreementRefType_governingAgreementRef', pyxb.binding.datatypes.anyURI, required=True)
...
class OperationalProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_OperationalProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}SecurityAudit uses Python identifier SecurityAudit
    __SecurityAudit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SecurityAudit'), 'SecurityAudit', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_OperationalProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordSecurityAudit', False)

    
    SecurityAudit = property(__SecurityAudit.value, __SecurityAudit.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}DeactivationCallCenter uses Python identifier DeactivationCallCenter
    __DeactivationCallCenter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DeactivationCallCenter'), 'DeactivationCallCenter', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_OperationalProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordDeactivationCallCenter', False)
...
class TokenType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}TimeSyncToken uses Python identifier TimeSyncToken
    __TimeSyncToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeSyncToken'), 'TimeSyncToken', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TokenType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordTimeSyncToken', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_TokenType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)
...
class ActivationLimitDurationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __duration = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'duration'), 'duration', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_ActivationLimitDurationType_duration', pyxb.binding.datatypes.duration, required=True)
...
class PrivateKeyProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}KeyStorage uses Python identifier KeyStorage
    __KeyStorage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyStorage'), 'KeyStorage', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordKeyStorage', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}KeySharing uses Python identifier KeySharing
    __KeySharing = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeySharing'), 'KeySharing', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordKeySharing', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword}KeyActivation uses Python identifier KeyActivation
    __KeyActivation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyActivation'), 'KeyActivation', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolPasswordKeyActivation', False)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    __credentialLevel = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'credentialLevel'), 'credentialLevel', '__urnoasisnamestcSAML2_0acclassesInternetProtocolPassword_CTD_ANON__credentialLevel', STD_ANON_2)
...
ExtensionType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocolPassword')), min_occurs=1, max_occurs=None)
    )
