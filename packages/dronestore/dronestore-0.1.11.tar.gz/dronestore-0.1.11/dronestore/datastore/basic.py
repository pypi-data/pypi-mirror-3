...
#
# class ScopedDatastore(dronestore):
#
#   def __init__(self, stores={}):
#     '''Initialize the datastore with any provided datastores.'''
...
#     self._stores = stores
#
#   def datastore(self, key):
#     return self._stores[str(key)]
#
#   def setDatastore(self, key, value):
#     if not isinstance(value, Datastore):
#       raise TypeError("value must be of type %s" % Datastore)
#
#     self._stores[str(key)] = value
#
#
#   def get(self, key):
#     '''Return the object named by key.'''
