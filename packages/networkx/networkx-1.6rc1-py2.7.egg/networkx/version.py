...
version_info = ('networkx', 1, '6rc1', '44274d7a86b8')

# Format: a 'datetime.datetime' instance
date_info = datetime.datetime(2011, 11, 15, 14, 59, 24, 848945)

# Format: (vcs, vcs_tuple)
vcs_info = ('mercurial', ('44274d7a86b8', 'tip'))
