...
from pypq.django_backend.introspection import DatabaseIntrospection
from django.utils.safestring import SafeUnicode, SafeString

try:
    import pypq as Database
except ImportError, e:
    from django.core.exceptions import ImproperlyConfigured
    raise ImproperlyConfigured("Error loading pypq module: %s" % e)
...
pypq.datatypes.register_type(pypq.datatypes.AutoUnicode)
pypq.datatypes.register_adapter(SafeString, pypq.datatypes.Unicode.to_postgres)
pypq.datatypes.register_adapter(SafeUnicode, pypq.datatypes.Unicode.to_postgres)
