...
setup(
    ...
    i2c and SPI""",
    long_description="""The Arduino-like WiringPi library allows easy GPIO use on the Raspberry Pi. This library aims to wrap it up for use with Python, along with Serial functionality, and more.""",
