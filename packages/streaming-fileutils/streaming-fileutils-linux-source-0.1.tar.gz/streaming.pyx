...
cdef class bstream:
  ...
  def __cinit__(self, string=''):
    ...
    if isinstance(string, bytes):
      ...
      self._bytes_ = unicode(string).encode(__encoding__)
    elif isinstance(string, bstream) \
      or isinstance(string, ustream):
      self._bytes_ = string._bytes_
    elif isinstance(string, QtCore.QByteArray):
      self._bytes_ = bytes(string)
  ...
  def __add__(self, y):
    '''x.__add__(y) <==> x+y'''
    result = self._bytes_.__add__(bstream(y)._bytes_)
  ...
  def __contains__(self, y):
    ...
    result = self._bytes_.__contains__(bstream(y)._bytes_)
    return(bool(result))
    
  def __getitem__(self, i):
    '''x.__getitem__(i) <==> x[i]'''
    result = self._bytes_.__getitem__(i)
    return(bstream(result))
    
  def __getslice__(self, i, j):
    '''x.__getslice__(i, j) <==> x[i:j]'''
    result = self._bytes_.__getslice__(i, j)
    return(bstream(result))
    
  def __hash__(self):
    '''x.__hash__() <==> hash(x)'''
    result = self._bytes_.__hash__()
    return(int(result))
    
  def __int__(self):
    '''x.__int() <==> int(x)'''
    if self._unicode_.isdecimal():
      result = int(self._bytes_)
      return(int(result))
    else:
  ...
  def __len__(self):
    '''x.__len__() <==> len(x)'''
    result = self._bytes_.__len__()
    return(int(result))
    
  def __mod__(self, int y):
    '''x.__mod__(y) <==> x%y'''
    result = self._bytes_.__mod__(y)
    return(bstream(result))
    
  def __mul__(self, n):
    '''x.__mul__(n) <==> x*n'''
    result = self._bytes_.__mul__(n)
    return(bstream(result))
    
  def __richcmp__(bstream self, string, operand):
    if operand == 0: # __lt__ <==> <
      result = self._bytes_.__lt__(bstream(string)._bytes_)
    elif operand == 1: # __le__ <==> <=
      result = self._bytes_.__le__(bstream(string)._bytes_)
    elif operand == 2: # __eq__ <==> ==
      result = self._bytes_.__eq__(bstream(string)._bytes_)
    elif operand == 3: # __ne__ <==> !=
      result = self._bytes_.__ne__(bstream(string)._bytes_)
    elif operand == 4: # __gt__ <==> >
      result = self._bytes_.__gt__(bstream(string)._bytes_)
    elif operand == 5: # __ge__ <==> >=
      result = self._bytes_.__ge__(bstream(string)._bytes_)
    return(bool(result))
    
  def __repr__(self):
    '''x.__repr__() <==> repr(x)'''
    string = repr(self._bytes_)
    length = len(self._bytes_)
    cursor = self._cursor_
    return('<bstream %s, length=%d, cursor=%d>' % (string, length, cursor))
  ...
  def __sizeof__(self):
    ...
    result = self._bytes_.__sizeof__()
    return(int(result))
  ...
  cpdef bstream capitalize(self):
    ...
    result = self._bytes_.capitalize()
    return(bstream(result))
  ...
  cpdef bstream center(self, int width, fillchar=' '):
    ...
    result = self._bytes_.center(width, bstream(fillchar)._bytes_)
    return(bstream(result))
    
  cpdef list chars(self):
    '''bstream.chars() -> list
    
    Get list of all chars in the bstream.'''
    chars = self._bytes_
    result = [bstream(char) for char in chars]
    return(list(result))
  ...
  cpdef int count(self, sub, int start=0, int end=-1):
    ...
    result = self._bytes_.count(bstream(sub)._bytes_, start, end)
    return(int(result))
    
  cpdef bool endswith(self, suffix, start=0, end=-1):
    ...
    result = self._bytes_.count(bstream(suffix)._bytes_, start, end)
    return(bool(result))
  ...
  cpdef bstream expandtabs(self, int tabsize=8):
    ...
    result = self._bytes_.expandtabs(tabsize)
    return(bstream(result))
  ...
  cpdef int find(self, sub, int start=0, int end=-1):
    ...
    Return -1 on failure.'''
    result = self._bytes_.find(bstream(sub)._bytes_, start, end)
    return(int(result))
    
  def format(self, *args, **kwargs):
    '''bstream.format(*args, **kwargs) -> bstream
    
    Return a formatted version of bstream, using substitutions from args
    and kwargs. The substitutions are identified by braces ('{' and '}').'''
    result = self._bytes_.format(*args, **kwargs)
    return(bstream(result))
    
  cpdef bstream getvalue(self):
    '''bstream.getvalue() -> bstream
  ...
  cpdef int index(self, sub, int start=0, int end=-1):
    ...
    result = self._bytes_.index(bstream(sub)._bytes_, start, end)
    return(int(result))
  ...
  cpdef insert(self, string):
    ...
    cursor = self._cursor_
    string = bstream(string)._bytes_
    length = len(string)
    head = self._bytes_[:cursor]
    tail = self._bytes_[cursor:]
    result = bstream('%s%s%s' % (head, string, tail))
    self._bytes_ = result._bytes_
    self._cursor_ += length
    
  cpdef bool isalnum(self):
  ...
  cpdef bool islower(self):
    ...
    result = self._bytes_.islower()
    return(bool(result))
    
  cpdef bool isspace(self):
    ...
    result = self._bytes_.isspace()
    return(bool(result))
    
  cpdef bool istitle(self):
    ...
    result = self._bytes_.istitle()
    return(bool(result))
    
  cpdef bool isupper(self):
    '''bstream.isupper() -> bool
    
    Return True if all cased characters in bstream are uppercase and there is
    at least one cased character in bstream, False otherwise.'''
    result = self._bytes_.isupper()
    return(bool(result))
    
  def iter_chars(self):
    '''bstream.iter_chars -> iterator
    
    Return iterator of the all characters in the bstream.'''
    char = int()
    last = len(self) -1
    while char <= last:
      yield self[char]
  ...
  def iter_lines(self):
    '''bstream.iter_lines -> iterator
    
    Return iterator of the all lines in the bstream.'''
    line = int()
    if '\r\n' in self:
      lines = self.split('\r\n')
    elif '\n' in self:
  ...
  cpdef bstream join(self, iterable):
    ...
    result = self._bytes_.join(bstream(iterable)._bytes_)
    return(bstream(result))
  ...
  cpdef bstream ljust(self, int width, fillchar=' '):
    ...
    result = self._bytes_.ljust(width, bstream(fillchar)._bytes_)
    return(bstream(result))
  ...
  cpdef bstream lstrip(self, chars=' '):
    ...
    result = self._bytes_.lstrip(bstream(chars)._bytes_)
    return(bstream(result))
  ...
  cpdef list partition(self, sep):
    ...
    result = self._bytes_.partition(bstream(sep)._bytes_)
  ...
  cpdef bstream remove(self, string):
    ...
    result = self._bytes_.replace(bstream(string)._bytes_, '')
    return(bstream(result))
  ...
  cpdef bstream replace(self, old, new, int count=-1):
    ...
    old = ustream(old)._bytes_
    new = ustream(new)._bytes_
    result = self._bytes_.replace(old, new, count)
    return(bstream(result))
  ...
  cpdef int rfind(self, sub, int start=0, int end=-1):
    ...
    Return -1 on failure.'''
    result = self._bytes_.rfind(bstream(sub)._bytes_, start, end)
    return(int(result))
  ...
  cpdef int rindex(self, sub, int start=0, int end=-1):
    ...
    result = self._bytes_.rindex(bstream(sub)._bytes_, start, end)
    return(int(result))
  ...
  cpdef bstream rjust(self, int width, fillchar=' '):
    ...
    is done using the specified fill character (default is a space).'''
    result = self._bytes_.rjust(width, bstream(fillchar)._bytes_)
    return(bstream(result))
  ...
  cpdef list rpartition(self, sep):
    ...
    result = self._bytes_.rpartition(bstream(sep)._bytes_)
    result = [bstream(item) for item in result]
    return(list(result))
  ...
  cpdef list rsplit(self, sep=' ', int maxsplit=-1):
    ...
    result = self._bytes_.rsplit(bstream(sep)._bytes_, maxsplit)
    result = [bstream(item) for item in result]
    return(list(result))
  ...
  cpdef list split(self, sep=' ', int maxsplit=-1):
    ...
    result = self._bytes_.split(bstream(sep)._bytes_, maxsplit)
    result = [bstream(item) for item in result]
    return(list(result))
    
  cpdef list splitlines(self, bool keepends):
    ...
    is given and true.'''
    result = self._bytes_.splitlines(keepends)
    result = [bstream(item) for item in result]
    return(list(result))
    
  cpdef bool startswith(self, prefix, int start=0, int end=-1):
    ...
    at that position.'''
    result = self._bytes_.startswith(bstream(prefix)._bytes_, start, end)
    return(bool(result))
  ...
  cpdef bstream strip(self, chars=' '):
    ...
    instead.'''
    result = self._bytes_.strip(bstream(chars)._bytes_)
    return(bstream(result))
  ...
  cpdef bstream zfill(self, int width):
    ...
    result = self._bytes_.zfill(width)
    return(bstream(result))
...
cdef class ustream:
  ...
  QByteArray and QString.'''
  cdef readonly object _bytes_
  cdef readonly object _unicode_
  cdef readonly int _cursor_
  cdef object __weakref__
  ...
  def __init__(self, string=''):
    ...
    if isinstance(string, bytes):
      ...
      self._bytes_ = unicode(string).encode(__encoding__)
    try:
      self._unicode_ = self._bytes_.decode(__encoding__)
    except UnicodeDecodeError, error:
      errchar = self._bytes_[error.start]
      raise StreamError(2, errchar)
    
  def __add__(self, y):
    '''x.__add__(y) <==> x+y'''
    result = self._unicode_.__add__(ustream(y)._unicode_)
  ...
  def __contains__(self, y):
    '''x.__contains__(y) <==> y in x'''
    result = self._unicode_.__contains__(ustream(y)._unicode_)
    return(bool(result))
    
  def __getitem__(self, i):
    '''x.__getitem__(i) <==> x[i]'''
    result = self._unicode_.__getitem__(i)
    return(ustream(result))
    
  def __getslice__(self, i, j):
    '''x.__getslice__(i, j) <==> x[i:j]'''
    result = self._unicode_.__getslice__(i, j)
    return(ustream(result))
  ...
  def __len__(self):
    '''x.__len__() <==> len(x)'''
    result = self._unicode_.__len__()
    return(int(result))
    
  def __mod__(self, y):
    '''x.__mod__(y) <==> x%y'''
    result = self._unicode_.__mod__(y)
    return(ustream(result))
    
  def __mul__(self, n):
    '''x.__mul__(n) <==> x*n'''
    result = self._unicode_.__mul__(n)
    return(ustream(result))
    
  def __richcmp__(ustream self, string, operand):
    if operand == 0: # __lt__ <==> <
      result = self._unicode_.__lt__(ustream(string)._unicode_)
    elif operand == 1: # __le__ <==> <=
      result = self._unicode_.__le__(ustream(string)._unicode_)
    elif operand == 2: # __eq__ <==> ==
      result = self._unicode_.__eq__(ustream(string)._unicode_)
    elif operand == 3: # __ne__ <==> !=
      result = self._unicode_.__ne__(ustream(string)._unicode_)
    elif operand == 4: # __gt__ <==> >
      result = self._unicode_.__gt__(ustream(string)._unicode_)
    elif operand == 5: # __ge__ <==> >=
      result = self._unicode_.__ge__(ustream(string)._unicode_)
    return(bool(result))
    
  def __repr__(self):
    '''x.__repr__() <==> repr(x)'''
    string = repr(self._unicode_)
    length = len(self._unicode_)
    cursor = self._cursor_
    return('<ustream %s, length=%d, cursor=%d>' % (string, length, cursor))
  ...
  def __sizeof__(self):
    ...
    result = self._unicode_.__sizeof__()
    return(int(result))
  ...
  cpdef ustream capitalize(self):
    ...
    have upper case and the others lower case.'''
    result = self._unicode_.capitalize()
    return(ustream(result))
  ...
  cpdef ustream center(self, int width, fillchar=' '):
    ...
    result = self._unicode_.center(width, ustream(fillchar)._unicode_)
    return(ustream(result))
  ...
  cpdef int count(self, sub, int start=0, int end=-1):
    ...
    interpreted as in slice notation.'''
    result = self._unicode_.count(ustream(sub)._unicode_, start, end)
    return(int(result))
    
  cpdef bool endswith(self, suffix, int start=0, int end=-1):
    ...
    result = self._unicode_.count(ustream(suffix)._unicode_, start, end)
    return(bool(result))
  ...
  cpdef ustream expandtabs(self, int tabsize=8):
    ...
    If tabsize is not given, a tab size of 8 characters is assumed.'''
    result = self._unicode_.expandtabs(tabsize)
    return(ustream(result))
  ...
  cpdef int find(self, sub, int start=0, int end=-1):
    ...
    Return -1 on failure.'''
    result = self._unicode_.find(ustream(sub)._unicode_, start, end)
    return(int(result))
  ...
  def format(self, *args, **kwargs):
    ...
    and kwargs. The substitutions are identified by braces ('{' and '}').'''
    result = self._unicode_.format(*args, **kwargs)
    return(ustream(result))
  ...
  cpdef int index(self, sub, int start=0, int end=-1):
    ...
    result = self._unicode_.index(ustream(sub)._unicode_, start, end)
    return(int(result))
  ...
  cpdef insert(self, string):
    ...
    cursor = self._cursor_
    string = ustream(string)._unicode_
    length = len(string)
    head = self._unicode_[:cursor]
    tail = self._unicode_[cursor:]
    result = ustream('%s%s%s' % (head, string, tail))
    self._bytes_ = result._bytes_
    self._unicode_ = result._unicode_
    self._cursor_ += length
  ...
  cpdef bool isalpha(self):
    ...
    there is at least one character in ustream, False otherwise.'''
    result = self._unicode_.isalpha()
    return(bool(result))
    
  cpdef bool isdecimal(self):
    '''ustream.isdecimal() -> bool
    
    Return True if there are only decimal characters in ustream,
    False otherwise.'''
    result = self._unicode_.isdecimal()
    return(bool(result))
  ...
  cpdef bool islower(self):
    ...
    result = self._unicode_.islower()
    return(bool(result))
    
  cpdef bool isnumeric(self):
    '''ustream.isnumeric() -> bool
    
    Return True if there are only numeric characters in ustream,
    False otherwise.'''
    result = self._unicode_.isnumeric()
    return(bool(result))
  ...
  cpdef ustream join(self, iterable):
    ...
    result = self._unicode_.join(ustream(iterable)._unicode_)
    return(ustream(result))
  ...
  cpdef ustream ljust(self, width, fillchar=' '):
    ...
    is done using the specified fill character (default is a space).'''
    result = self._unicode_.ljust(width, ustream(fillchar)._unicode_)
    return(ustream(result))
  ...
  cpdef ustream lstrip(self, chars=' '):
    ...
    If chars is given and not None, remove characters in chars instead.'''
    result = self._unicode_.lstrip(ustream(chars)._unicode_)
    return(ustream(result))
  ...
  cpdef list partition(self, sep):
    ...
    result = self._unicode_.partition(ustream(sep)._unicode_)
  ...
  cpdef list regexfind(self, pattern):
    ...
    pattern = re.compile\
      (pattern._unicode_, re.UNICODE | re.DOTALL | re.IGNORECASE)
    groups = pattern.findall(self._unicode_)
    for group in groups:
  ...
  cpdef bool regexmatch(self, pattern):
    ...
    pattern = re.compile\
      (pattern._unicode_, re.UNICODE | re.DOTALL | re.IGNORECASE)
    result = pattern.findall(self._unicode_)
    return(bool(result))
  ...
  cpdef ustream regexreplace(self, pattern, repl):
    ...
    pattern = re.compile\
      (pattern._unicode_, re.UNICODE | re.DOTALL | re.IGNORECASE)
    result = pattern.sub(ustream(repl)._unicode_, self._unicode_)
    return(ustream(result))
  ...
  cpdef ustream remove(self, string):
    ...
    Delete all the occurrences of the string in the bstream.'''
    result = self._unicode_.replace(ustream(string)._unicode_, '')
    return(ustream(result))
  ...
  cpdef ustream replace(self, old, new, int count=-1):
    ...
    old replaced by new. If the optional argument count is
    given, only the first count occurrences are replaced.'''
    old = ustream(old)._unicode_
    new = ustream(new)._unicode_
    result = self._unicode_.replace(old, new, count)
    return(ustream(result))
  ...
  cpdef int rfind(self, sub, int start=0, int end=-1):
    ...
    Return -1 on failure.'''
    result = self._unicode_.rfind(ustream(sub)._unicode_, start, end)
    return(int(result))
  ...
  cpdef int rindex(self, sub, int start=0, int end=-1):
    ...
    result = self._unicode_.rindex(ustream(sub)._unicode_, start, end)
    return(int(result))
  ...
  cpdef ustream rjust(self, width, fillchar=' '):
    ...
    is done using the specified fill character (default is a space).'''
    result = self._unicode_.rjust(width, ustream(fillchar)._unicode_)
    return(ustream(result))
  ...
  cpdef list rpartition(self, sep):
    ...
    result = self._unicode_.rpartition(ustream(sep)._unicode_)
    result = [ustream(item) for item in result]
    return(list(result))
  ...
  cpdef list rsplit(self, sep=' ', maxsplit=-1):
    ...
    is a separator.'''
    result = self._unicode_.rsplit(ustream(sep)._unicode_, maxsplit)
    result = [ustream(item) for item in result]
    return(list(result))
  ...
  cpdef ustream rstrip(self, chars=None):
    ...
    If chars is given and not None, remove characters in chars instead.'''
    result = self._unicode_.rstrip(ustream(chars)._unicode_)
    return(ustream(result))
  ...
  cpdef list split(self, sep=' ', maxsplit=-1):
    ...
    whitespace string is a separator and empty strings are
    removed from the result.'''
    result = self._unicode_.split(ustream(sep)._unicode_, maxsplit)
    result = [ustream(item) for item in result]
    return(list(result))
  ...
  cpdef bool startswith(self, prefix, int start=0, int end=-1):
    ...
    at that position.'''
    result = self._unicode_.startswith(ustream(prefix)._unicode_, start, end)
    return(bool(result))
  ...
  cpdef ustream strip(self, chars=' '):
    ...
    removed. If chars is given and not None, remove characters in chars
    instead.'''
    result = self._unicode_.strip(ustream(chars)._unicode_)
    return(ustream(result))
  ...
  cpdef ustream swapcase(self):
    ...
    lowercase and vice versa.'''
    result = self._unicode_.swapcase()
    return(ustream(result))
  ...
  cpdef ustream zfill(self, width):
    ...
    result = self._unicode_.zfill(width)
    return(ustream(result))
...
cdef class fstream:
  ...
  def __init__(self, path, mode='rb', filter=None):
    ...
    if __system__ == 'linux':
      ...
      with codecs.open(self._lzop_exe_._unicode_, 'wb') as file:
        file.write(bstream(_LZOP_EXE_).base64_decode().zlib_decode()._bytes_)
      ...
      with codecs.open(self._gzip_exe_._unicode_, 'wb') as file:
        file.write(bstream(_GZIP_EXE_).base64_decode().zlib_decode()._bytes_)
      with codecs.open(self._bzip2_exe_._unicode_, 'wb') as file:
        file.write(bstream(_BZIP2_EXE_).base64_decode().zlib_decode()._bytes_)
      with codecs.open(self._bzip2_lib_._unicode_, 'wb') as file:
        file.write(bstream(_BZIP2_LIB_).base64_decode().zlib_decode()._bytes_)
      with codecs.open(self._xz_exe_._unicode_, 'wb') as file:
        file.write(bstream(_XZ_EXE_).base64_decode().zlib_decode()._bytes_)
      with codecs.open(self._lzop_exe_._unicode_, 'wb') as file:
        file.write(bstream(_LZOP_EXE_).base64_decode().zlib_decode()._bytes_)
    with codecs.open(self._temppath_._unicode_, 'wb') as file:
    ...
    if self.mode == 'rb' or self.mode == 'ab' \
      ...
      if not os.path.exists(self.path._unicode_):
        self._rmtemp_() # Clear temporary directory
        raise StreamError(3, self.path._unicode_)
      elif os.path.isdir(self.path._unicode_):
        self._rmtemp_() # Clear temporary directory
        raise StreamError(4, self.path._unicode_)
      try:
        if isinstance(self.filter, NoneType):
          shutil.copy(self.path._unicode_, self._temppath_._unicode_)
      ...
      with codecs.open(self.path._unicode_, 'w') as file:
        file.write('')
    if 'b' in self.mode: # open fstream in binary mode
      self._stream_ = \
        codecs.open(self._temppath_._unicode_, self.mode._unicode_)
    else: # open fstream in string mode
      self._stream_ = \
        codecs.open(self._temppath_._unicode_, self.mode._unicode_, __encoding__)
    if self.mode not in modes:
      self._rmtemp_() # Clear temporary directory
      raise StreamError(5, self.mode._unicode_)
    if not isinstance(filter, NoneType) \
      and self.filter not in filters:
        self._rmtemp_() # Clear temporary directory
        raise StreamError(6, self.filter._unicode_)
  ...
  def __repr__(self):
    '''x.__repr__() <==> repr(x)'''
    path = repr(self.path._unicode_)
    mode = repr(self.mode._bytes_)
    if isinstance(self.filter, NoneType):
      filter = 'None'
    else:
      filter = repr(self.filter._bytes_)
    if not self.closed:
      return('<opened fstream %s, mode=%s, filter=%s>' % (path, mode, filter))
    else:
      return('<closed fstream %s, mode=%s, filter=%s>' % (path, mode, filter))
      
  cpdef _rmtemp_(self):
    os.remove(self._temppath_._unicode_)
    os.remove(self._lzop_exe_._unicode_)
    if __system__ == 'windows':
      os.remove(self._gzip_exe_._unicode_)
      os.remove(self._bzip2_exe_._unicode_)
      os.remove(self._bzip2_lib_._unicode_)
      os.remove(self._xz_exe_._unicode_)
    os.rmdir(self._tempdir_._unicode_)
  ...
  cpdef close(self):
    ...
    if self.changed:
      ...
      if isinstance(self.filter, NoneType):
        shutil.copy(self._temppath_._unicode_, self.path._unicode_)
      elif self.filter == 'gzip':
        arc_exe = _screen_(self._gzip_exe_)
  ...
  def write(self, stream):
    ...
    if not self.closed:
      if 'b' in self.mode:
        self._stream_.write(bstream(stream)._bytes_)
      elif 'b' not in self.mode:
        self._stream_.write(ustream(stream)._unicode_)
      self.changed = True
    else:
  ...
  def writelines(self, sequence):
    ...
    if not self.closed:
      if 'b' in self.mode: # binary mode
        result = [bstream(item)._bytes_ for item in sequence]
      else: # string mode
        result = [ustream(item)._unicode_ for item in sequence]
...
cdef class pstream:
  ...
  def __init__(self, args):
    ...
    if isinstance(args, list):
      ...
      for arg in args:
        if arg == args[0]:
          self._command_ = \
            '%s' % arg._unicode_.encode(__console__)
        else:
          self._command_ += \
            ' %s' % arg._unicode_.encode(__console__)
    if type(args) in types:
      self._command_ = \
        ustream(args)._unicode_.encode(__console__)
    
  def __repr__(self):
    '''x.__repr__() <==> repr(x)'''
    return('<pstream %s>' % repr(self._command_))
  ...
  def execute(self, exception=True, stdin=''):
    ...
    if stdin != '':
      stdout, stderr = process.communicate(bstream(stdin)._bytes_)
    else:
