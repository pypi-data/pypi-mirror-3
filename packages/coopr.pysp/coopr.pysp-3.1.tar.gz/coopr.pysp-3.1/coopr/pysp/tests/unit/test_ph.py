...
class TestPHParallel(unittest.TestCase):
    ...
    def test_linearized_sizes3_cplex_with_phpyro(self):
        ...
        os.system(argstring)        
        self.cleanup()
        self.assertFileEqualsBaseline(this_test_file_directory+"sizes3_linearized_cplex_with_phpyro.out",this_test_file_directory+"sizes3_linearized_cplex_with_phpyro.baseline", filter=filter_pyro)        
