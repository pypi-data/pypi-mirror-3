...
from jsb3.lib.persist import Persist, PlugPersist
from jsb3.utils.url import geturl2, striphtml, useragent
from jsb3.utils.exception import handle_exception
from jsb3.utils.generic import strippedtxt, fromenc, toenc, jsonstring, getwho, getnick
from jsb3.utils.rsslist import rsslist
from jsb3.utils.lazydict import LazyDict
from jsb3.utils.statdict import StatDict
from jsb3.utils.timeutils import strtotime
from jsb3.lib.commands import cmnds
from jsb3.lib.examples import examples
from jsb3.utils.dol import Dol
from jsb3.utils.pdod import Pdod
from jsb3.utils.pdol import Pdol
from jsb3.lib.users import users
from jsb3.utils.id import getrssid
from jsb3.lib.tasks import taskmanager
from jsb3.lib.callbacks import callbacks
from jsb3.lib.fleet import getfleet
from jsb3.lib.threadloop import TimedLoop
from jsb3.lib.threads import start_new_thread
from jsb3.lib.errors import NoSuchBotType, FeedAlreadyExists, NameNotSet
from jsb3.lib.datadir import getdatadir
from jsb3.lib.channelbase import ChannelBase
from jsb3.imports import getfeedparser, getjson

## google imports

try: import waveapi ; from google.appengine.api.memcache import get, set, delete
except ImportError: from jsb3.lib.cache import get, set, delete

## tinyurl import

try: from jsb3.plugs.extra.tinyurl import get_tinyurl
except ImportError:
    def get_tinyurl(url):
        return [url, ]
...
sleeptime=15*60, running=0):
        if name:
            filebase = getdatadir() + os.sep + 'plugs' + os.sep + 'jsb3plugins.rss' + os.sep + name
    ...
    def fetchdata(self, data=None):
        ...
        name = self.data.name
        from jsb3.utils.url import enabled
