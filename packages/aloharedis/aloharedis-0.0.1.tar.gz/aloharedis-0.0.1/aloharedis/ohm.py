...
__all__ = [
    ...
    'Attr', 'NumberAttr', 'IntAttr', 'FloatAttr',
    'TimestampAttr', 'SerialAttr', 'BooleanAttr',
    'StringAttr', 'UnicodeAttr', 'Hash', 'Manager'
]
...
from .serials import SerialsManager, Serial
...
class SerialAttr(IntAttr):
    def __init__(self, field, default=None, as_key=False):
