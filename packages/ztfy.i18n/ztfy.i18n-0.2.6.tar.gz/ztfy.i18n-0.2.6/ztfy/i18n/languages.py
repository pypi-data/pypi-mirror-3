...
class BaseLanguagesVocabulary(SimpleVocabulary):
    ...
    def __init__(self, *args, **kw):
        ...
        terms = sorted([SimpleTerm(v, t, translate(t, context=request)) for v, t in _base_languages])
        super(BaseLanguagesVocabulary, self).__init__(sorted(terms, key=lambda x: x.title))
...
class LanguagesVocabulary(SimpleVocabulary):
    ...
    def __init__(self, *args, **kw):
        request = queryRequest()
        terms = sorted([SimpleTerm(v, t, translate(t, context=request)) for v, t in _languages])
        super(LanguagesVocabulary, self).__init__(sorted(terms, key=lambda x: x.title))
