...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('demo_cms_article', 'title', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Article.title'
        db.alter_column('demo_cms_article', 'title', self.gf('html_field.db.models.fields.HTMLField')())
