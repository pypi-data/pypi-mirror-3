 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/refl_adv.h
...
static PyObject * CReflAdvModelError = NULL;
...
static void
CReflAdvModel_dealloc(CReflAdvModel* self)
{
...
static PyObject *
CReflAdvModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CReflAdvModel *self;
    
    self = (CReflAdvModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CReflAdvModel_init(CReflAdvModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"sld_bottom0",Py_BuildValue("d",0.000002070000));
        ...
        PyDict_SetItemString(self->params,"npts_inter",Py_BuildValue("d",21.000000000000));
        ...
        PyDict_SetItemString(self->params,"sld_medium",Py_BuildValue("d",0.000001000000));
...
static PyMemberDef CReflAdvModel_members[] = {
    {name_params, T_OBJECT, offsetof(CReflAdvModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CReflAdvModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CReflAdvModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CReflAdvModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(ReflAdvModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( ReflAdvModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CReflAdvModelError, 
                   "CReflAdvModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CReflAdvModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->sld_bottom0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_bottom0") );
    ...
    self->model->sld_medium = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_medium") );
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CReflAdvModelError, 
	    	"CReflAdvModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CReflAdvModelError, 
                   "CReflAdvModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CReflAdvModelError, 
	    		"CReflAdvModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CReflAdvModelError, 
                   "CReflAdvModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CReflAdvModelError, 
                   "CReflAdvModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CReflAdvModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CReflAdvModelError, 
	    	"CReflAdvModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CReflAdvModelError, 
	    		"CReflAdvModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CReflAdvModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CReflAdvModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CReflAdvModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CReflAdvModel *self) {
 ...
 */
static PyObject * calculate_VR(CReflAdvModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CReflAdvModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CReflAdvModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CReflAdvModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CReflAdvModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CReflAdvModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CReflAdvModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CReflAdvModelError,
	    	"CReflAdvModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "thick_inter0")) {
	    ...
	    PyErr_SetString(CReflAdvModelError,
	    	"CReflAdvModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CReflAdvModel_methods[] = {
...
static PyTypeObject CReflAdvModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CReflAdvModel",             /*tp_name*/
    sizeof(CReflAdvModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CReflAdvModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CReflAdvModel_methods,             /* tp_methods */
    CReflAdvModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CReflAdvModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CReflAdvModel_new,                 /* tp_new */
};
...
void addCReflAdvModel(PyObject *module) {
    ...
    if (PyType_Ready(&CReflAdvModelType) < 0)
        return;

    Py_INCREF(&CReflAdvModelType);
