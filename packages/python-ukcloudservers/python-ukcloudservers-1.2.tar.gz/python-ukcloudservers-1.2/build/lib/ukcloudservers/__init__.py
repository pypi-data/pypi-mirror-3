...
from ukcloudservers.backup_schedules import (BackupSchedule, BackupScheduleManager, 
...
from ukcloudservers.client import CloudServersClient
from ukcloudservers.exceptions import (CloudServersException, BadRequest, Unauthorized,
    Forbidden, NotFound, OverLimit)
from ukcloudservers.flavors import FlavorManager, Flavor
from ukcloudservers.images import ImageManager, Image
from ukcloudservers.ipgroups import IPGroupManager, IPGroup
from ukcloudservers.servers import ServerManager, Server, REBOOT_HARD, REBOOT_SOFT
...
class CloudServers(object):
    ...
    def authenticate(self):
        ...
        Returns on success; raises :exc:`ukcloudservers.Unauthorized` if the
