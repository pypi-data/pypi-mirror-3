...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_fileraudioplugin', (
        ...
        db.send_create_signal('cmsplugin_filer_audio', ['FilerAudioPlugin'])


    def backwards(self, orm):
        # Deleting model 'FilerAudioPlugin'
        db.delete_table('cmsplugin_fileraudioplugin')
    ...
    models = {
        ...
        'cmsplugin_filer_audio.fileraudioplugin': {
            'Meta': {'object_name': 'FilerAudioPlugin', 'db_table': "'cmsplugin_fileraudioplugin'", '_ormbases': ['cms.CMSPlugin']},
