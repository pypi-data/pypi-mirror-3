# $Id: storage.py 23bf3c561736 2012/05/30 19:32:09 patrick $
...
class StorageView(object):
    ...
    def view(self):
        ...
        members = DBSession.query(
            ...
            .filter(StorageUser.perm != None).order_by(User.name)
    ...
    def _settings_form(self, storage=None):
        ...
        if storage is None:
            schema.add(SchemaNode(String(), name='storage_id', validator=All(
