 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/lamellar.h
...
static PyMemberDef CLamellarModel_members[] = {
    {name_params, T_OBJECT, offsetof(CLamellarModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLamellarModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLamellarModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
static PyObject *evaluateOneDim(LamellarModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( LamellarModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CLamellarModelError, 
                   "CLamellarModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CLamellarModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLamellarModelError, 
	    	"CLamellarModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CLamellarModelError, 
                   "CLamellarModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CLamellarModelError, 
	    		"CLamellarModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CLamellarModelError, 
                   "CLamellarModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CLamellarModelError, 
 ...
 */
static PyObject * calculate_ER(CLamellarModel *self) {
 ...
 */
static PyObject * calculate_VR(CLamellarModel *self) {
