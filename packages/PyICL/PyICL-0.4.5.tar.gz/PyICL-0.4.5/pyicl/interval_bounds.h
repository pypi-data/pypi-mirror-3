...
#ifndef PYICL_INTERVAL_BOUNDS_HPP_JORE_110217
#define PYICL_INTERVAL_BOUNDS_HPP_JORE_110217
...
struct interval_bounds_exposer {
	...
	expose( char const * name, char const * docstring ) {
		...
		_class.def( "right_open", &icl::interval_bounds::open ).staticmethod( "right_open" );
		_class.def( "left_open", &icl::interval_bounds::open ).staticmethod( "left_open" );
		_class.def( "closed", &icl::interval_bounds::open ).staticmethod( "closed" );
	}
};

} // namespace pyicl

#endif //PYICL_INTERVAL_BOUNDS_HPP_JORE_110217
