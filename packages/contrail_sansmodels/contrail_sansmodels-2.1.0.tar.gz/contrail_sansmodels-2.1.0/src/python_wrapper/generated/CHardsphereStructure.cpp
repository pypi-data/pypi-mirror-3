 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/Hardsphere.h
...
static PyObject *evaluateOneDim(HardsphereStructure* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( HardsphereStructure* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CHardsphereStructureError, 
                   "CHardsphereStructure.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CHardsphereStructure *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CHardsphereStructureError, 
	    	"CHardsphereStructure.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CHardsphereStructureError, 
                   "CHardsphereStructure.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CHardsphereStructureError, 
	    		"CHardsphereStructure.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CHardsphereStructureError, 
                   "CHardsphereStructure.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CHardsphereStructureError, 
 ...
 */
static PyObject * calculate_VR(CHardsphereStructure *self) {
