...
model.Make.declare_suffix("Rc")
model.Make.declare_suffix("Lrc")
model.Make.declare_suffix("Urc")

# tons inventoried
model.Inv = Var(model.PROD, model.TWOPLUSWEEKS, domain=NonNegativeReals)
model.Inv.declare_suffix("Rc")
model.Inv.declare_suffix("Lrc")
model.Inv.declare_suffix("Urc")
...
model.Sell.declare_suffix("Rc")
model.Sell.declare_suffix("Lrc")
model.Sell.declare_suffix("Urc")
