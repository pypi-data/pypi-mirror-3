# Name:      lokai/lk_worker/tests/scripts/test_update_node.py
# Purpose:   Test update a node through the update controller
...
class TestObject(unittest.TestCase):
    ...
    def test_t100(self):
        ...
        query_set = {'detail___node_edit___nde_name': 'New Node Name',
        ...
        self.assertEqual(target_idx, nde_idx)
