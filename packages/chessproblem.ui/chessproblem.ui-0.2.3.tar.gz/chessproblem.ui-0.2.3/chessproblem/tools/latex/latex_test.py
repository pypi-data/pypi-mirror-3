...
from chessproblem.tools.latex import latex, dialines_template, DialinesTemplate, LatexCompilerException
...
class LatexCompilerTest(unittest.TestCase):
    ...
    def test_dialines_template(self):
        dialines_template(ChessproblemDocument([]), self.template_filename, self.include_filename, self.compiled_filename, self.dir)
