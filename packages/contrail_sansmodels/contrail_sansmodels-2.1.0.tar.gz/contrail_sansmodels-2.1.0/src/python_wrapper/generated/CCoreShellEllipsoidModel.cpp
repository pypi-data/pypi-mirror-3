 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/spheroid.h
...
CCoreShellEllipsoidModel_init(CCoreShellEllipsoidModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"polar_shell",Py_BuildValue("d",30.000000000000));
        PyDict_SetItemString(self->params,"sld_solvent",Py_BuildValue("d",0.000006300000));
        PyDict_SetItemString(self->params,"equat_shell",Py_BuildValue("d",250.000000000000));
        ...
        PyDict_SetItemString(self->params,"equat_core",Py_BuildValue("d",200.000000000000));
        PyDict_SetItemString(self->params,"polar_core",Py_BuildValue("d",20.000000000000));
...
static PyMemberDef CCoreShellEllipsoidModel_members[] = {
    {name_params, T_OBJECT, offsetof(CCoreShellEllipsoidModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CCoreShellEllipsoidModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CCoreShellEllipsoidModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
 ...
 */
static PyObject * calculate_VR(CCoreShellEllipsoidModel *self) {
