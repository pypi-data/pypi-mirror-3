 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/massfractal.h
...
static PyObject * CMassFractalModelError = NULL;
...
static void
CMassFractalModel_dealloc(CMassFractalModel* self)
{
...
static PyObject *
CMassFractalModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CMassFractalModel *self;
    
    self = (CMassFractalModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CMassFractalModel_init(CMassFractalModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new MassFractalModel();
        
        // Initialize parameter dictionary
        PyDict_SetItemString(self->params,"co_length",Py_BuildValue("d",100.000000000000));
        ...
        PyDict_SetItemString(self->params,"mass_dim",Py_BuildValue("d",1.900000000000));
...
static PyMemberDef CMassFractalModel_members[] = {
    {name_params, T_OBJECT, offsetof(CMassFractalModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CMassFractalModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CMassFractalModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CMassFractalModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(MassFractalModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( MassFractalModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CMassFractalModelError, 
                   "CMassFractalModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CMassFractalModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CMassFractalModelError, 
	    	"CMassFractalModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CMassFractalModelError, 
                   "CMassFractalModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CMassFractalModelError, 
	    		"CMassFractalModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CMassFractalModelError, 
                   "CMassFractalModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CMassFractalModelError, 
                   "CMassFractalModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CMassFractalModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CMassFractalModelError, 
	    	"CMassFractalModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CMassFractalModelError, 
	    		"CMassFractalModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CMassFractalModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CMassFractalModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CMassFractalModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CMassFractalModel *self) {
 ...
 */
static PyObject * calculate_VR(CMassFractalModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CMassFractalModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CMassFractalModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CMassFractalModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CMassFractalModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CMassFractalModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CMassFractalModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CMassFractalModelError,
	    	"CMassFractalModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
 ...
 {
	    PyErr_SetString(CMassFractalModelError,
	    	"CMassFractalModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CMassFractalModel_methods[] = {
...
static PyTypeObject CMassFractalModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CMassFractalModel",             /*tp_name*/
    sizeof(CMassFractalModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CMassFractalModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CMassFractalModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CMassFractalModel_methods,             /* tp_methods */
    CMassFractalModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CMassFractalModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CMassFractalModel_new,                 /* tp_new */
};
...
void addCMassFractalModel(PyObject *module) {
    ...
    if (PyType_Ready(&CMassFractalModelType) < 0)
        return;

    Py_INCREF(&CMassFractalModelType);
    PyModule_AddObject(module, "CMassFractalModel", (PyObject *)&CMassFractalModelType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CMassFractalModel.error";
    CMassFractalModelError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CMassFractalModelError", CMassFractalModelError);
}
