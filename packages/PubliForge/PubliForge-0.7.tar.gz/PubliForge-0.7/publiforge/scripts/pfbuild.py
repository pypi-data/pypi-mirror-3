#!/usr/bin/env python
# $Id: pfbuild.py bc8a61990a23 2012/07/19 17:01:32 patrick $
...
def main():
    ...
    parser.add_option(
        '--list-variables', dest='list_variables',
        help='list variable values', default=False, action='store_true')
    parser.add_option(
        '--show-variables', dest='show_variables', default=False,
    ...
    parser.add_option(
        '--processor_root', dest='processor_root', help='processor path')
    parser.add_option(
        '--storage_root', dest='storage_root', help='storage path')
...
class BuildLauncher(object):
    ...
    def _read_settings(self, build_file, build_tree):
        ...
        if not 'processor.list' in settings:
