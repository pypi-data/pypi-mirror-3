...
import tickets
import tickets.crypto.diffiehellman
...
setup(
    ...
    description = ("pyTickets are light-weight symmetrically signed data"
                   ...
                   " compression of their contents. Now includes an *alpha*"
                   " DiffieHellman implementation. Do not trust it yet :-)"
    ),
    license = "GPL",
    keywords = "ticket tickets encrypt secure sign signed ignature hash hashed",
    url = "http://tripleaes.com/wp/pytickets",
    packages=[
        'tickets',
        'tickets.web',
        'tickets.crypto',
    ...
    long_description=tickets.__doc__ + tickets.crypto.diffiehellman.__doc__,
    classifiers=[
