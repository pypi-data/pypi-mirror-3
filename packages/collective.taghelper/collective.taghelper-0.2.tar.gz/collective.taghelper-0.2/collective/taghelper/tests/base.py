...
def setup_product():
    ...
    import collective.taghelper
    zcml.load_config('configure.zcml', collective.taghelper)
    ...
    ztc.installPackage('collective.taghelper')
...
setup_product()
ptc.setupPloneSite(products=['collective.taghelper'])
