...
DOMAIN_PTS = [float(i) for i in (range(-5,0)+range(1,5))]
...
def define_model(**kwds):
    ...
    model.x1 = Var() # domain variable
    model.x2 = Var() # domain variable    
    model.x3 = Var() # domain variable
    model.x4 = Var() # domain variable
    model.x5 = Var() # domain variable
    model.x6 = Var() # domain variable
    model.x7 = Var() # domain variable
