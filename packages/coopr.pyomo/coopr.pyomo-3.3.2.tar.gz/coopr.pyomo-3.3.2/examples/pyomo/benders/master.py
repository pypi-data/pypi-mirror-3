...
model.Make1.declare_suffix("Rc")
model.Make1.declare_suffix("Lrc")
model.Make1.declare_suffix("Urc")

model.Inv1 = Var(model.PROD, within=NonNegativeReals)
model.Inv1.declare_suffix("Rc")
model.Inv1.declare_suffix("Lrc")
model.Inv1.declare_suffix("Urc")

def sell_bounds(model, p):
    return (0, model.market[p, 1])
model.Sell1 = Var(model.PROD, within=NonNegativeReals, bounds=sell_bounds)
model.Sell1.declare_suffix("Rc")
model.Sell1.declare_suffix("Lrc")
model.Sell1.declare_suffix("Urc")

model.Min_Stage2_Profit = Var(within=NonNegativeReals)
model.Min_Stage2_Profit.declare_suffix("Rc")
model.Min_Stage2_Profit.declare_suffix("Lrc")
model.Min_Stage2_Profit.declare_suffix("Urc")
