...
:WARNING: THIS FILE WAS GENERATED BY WRAPPERGENERATOR.PY
         DO NOT MODIFY THIS FILE, MODIFY include/core_shell_bicelle.h
...
def create_CoreShellBicelleModel():
    ...
    #CCoreShellBicelleModel.__init__(obj) is called by CoreShellBicelleModel constructor
    return obj

class CoreShellBicelleModel(CCoreShellBicelleModel, BaseComponent):
    """ 
    Class that evaluates a CoreShellBicelleModel model. 
    This file was auto-generated from include/core_shell_bicelle.h.
    ...
    def __init__(self):
		...
		*cos(alpha/2)]*J1(q(R+T)sin(alpha))
        ...
        ## fittable parameters
        self.fixed=['axis_phi.width', 'axis_theta.width', 'length.width', 'radius.width', 'rim_thick.width', 'face_thick.width']
    ...
    def set_dispersion(self, parameter, dispersion):
        ...
        """
        return CCoreShellBicelleModel.set_dispersion(self, parameter, dispersion.cdisp)
