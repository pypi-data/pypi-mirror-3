...
setup(
    ...
    packages = ["pyDatalog"],
    version = "0.2.1",
    description = "pyDatalog embeds logic programming in python using SLG algorithm with memoization",
...
Datalog is a non-Turing complete subset of prolog that is best at simulating intelligent behavior (e.g. in games), 
