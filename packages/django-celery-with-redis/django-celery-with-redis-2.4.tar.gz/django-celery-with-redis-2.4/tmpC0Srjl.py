...
setup(name='django-celery-with-redis',
      version='2.4',
      description='''Bundle that installs the dependencies for Django-Celery and Redis''',
      ...
      license='''BSD''',
      zip_safe=False,
      install_requires=['django-celery>=2.4,<3', 'redis>=2.4.4'],
      classifiers=[
