...
setup(
    ...
    package_data = {
        "pystatic":
        [
            "pystatic/project/*.html",
            "pystatic/project/*.css",
            "pystatic/project/*.js",
            "pystatic/project/*.yaml",
            "pystatic/project/*.png",
            "pystatic/project/*.eot",
            "pystatic/project/*.svg",
            "pystatic/project/*.ttf",
            "pystatic/project/*.woff",
        ]
    },
    version = "0.1.12",
