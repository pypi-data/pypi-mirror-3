 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/lamellarPS_HG.h
...
CLamellarPSHGModel_init(CLamellarPSHGModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model->deltaT.dispersion->accept_as_source(visitor, self->model->deltaT.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "deltaT", disp_dict);
        disp_dict = PyDict_New();
...
static PyMemberDef CLamellarPSHGModel_members[] = {
    {name_params, T_OBJECT, offsetof(CLamellarPSHGModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLamellarPSHGModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLamellarPSHGModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
 ...
 */
static PyObject * calculate_VR(CLamellarPSHGModel *self) {
...
static PyObject * set_dispersion(CLamellarPSHGModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CLamellarPSHGModelError,
	    	"CLamellarPSHGModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
