 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/refl.h
...
static PyObject * CReflModelError = NULL;
...
static void
CReflModel_dealloc(CReflModel* self)
{
...
static PyObject *
CReflModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CReflModel *self;
    
    self = (CReflModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CReflModel_init(CReflModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"thick_inter1",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"sld_bottom0",Py_BuildValue("d",0.000002070000));
        PyDict_SetItemString(self->params,"thick_inter3",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"thick_inter4",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"thick_inter5",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"thick_inter6",Py_BuildValue("d",1.000000000000));
        ...
        PyDict_SetItemString(self->params,"thick_inter2",Py_BuildValue("d",1.000000000000));
...
static PyMemberDef CReflModel_members[] = {
    {name_params, T_OBJECT, offsetof(CReflModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CReflModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CReflModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CReflModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(ReflModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( ReflModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CReflModelError, 
                   "CReflModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CReflModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CReflModelError, 
	    	"CReflModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CReflModelError, 
                   "CReflModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CReflModelError, 
	    		"CReflModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CReflModelError, 
                   "CReflModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CReflModelError, 
                   "CReflModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CReflModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CReflModelError, 
	    	"CReflModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CReflModelError, 
	    		"CReflModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CReflModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CReflModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CReflModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CReflModel *self) {
 ...
 */
static PyObject * calculate_VR(CReflModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CReflModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CReflModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CReflModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CReflModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CReflModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CReflModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CReflModelError,
	    	"CReflModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "thick_inter0")) {
	    ...
	    PyErr_SetString(CReflModelError,
	    	"CReflModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CReflModel_methods[] = {
...
static PyTypeObject CReflModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CReflModel",             /*tp_name*/
    sizeof(CReflModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CReflModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CReflModel_methods,             /* tp_methods */
    CReflModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CReflModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CReflModel_new,                 /* tp_new */
};
...
void addCReflModel(PyObject *module) {
    ...
    if (PyType_Ready(&CReflModelType) < 0)
        return;

    Py_INCREF(&CReflModelType);
