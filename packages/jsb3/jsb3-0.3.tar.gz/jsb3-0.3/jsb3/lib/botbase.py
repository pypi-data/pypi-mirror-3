...
from jsb3.utils.generic import splittxt, toenc, fromenc, waitforqueue, strippedtxt, waitevents, stripcolor
...
from jsb3.lib.threads import threaded
from jsb3.utils.locking import lock_object, release_object
from jsb3.utils.url import decode_html_entities
from jsb3.lib.users import getusers

try: import wave
except ImportError:
    from jsb3.imports import gettornado
    tornado = gettornado()
...
class BotBase(LazyDict):
    ...
    def put(self, event, direct=False):
        ...
        if direct: self.doevent(event)
            ...
            from jsb3.drivers.gae.tasks import start_botevent
