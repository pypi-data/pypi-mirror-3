...
def _():
    ...
    # this is memoized !
    ok(X1, N, X2) <= (X1 in range(8)) & (X2 in range(8)) & (X1!=X2) & (X1!= X2+N) & (X1!=X2-N)
    
    queens1(X0,X1) <= queens0(X0) & ok(X1,1,X0)

    queens2(X0,X1,X2) <= queens1(X0,X1) & ok(X0,2,X2) & queens1(X1,X2)

    queens3(X0,X1,X2,X3) <= queens2(X0,X1,X2) & ok(X0,3,X3) & queens2(X1,X2,X3)

    queens4(X0,X1,X2,X3,X4) <= queens3(X0,X1,X2,X3) & ok(X0,4,X4) & queens3(X1,X2,X3,X4)

    queens5(X0,X1,X2,X3,X4,X5) <= queens4(X0,X1,X2,X3,X4) & ok(X0,5,X5) & queens4(X1,X2,X3,X4,X5)

    queens6(X0,X1,X2,X3,X4,X5,X6) <= queens5(X0,X1,X2,X3,X4,X5) & ok(X0,6,X6) & queens5(X1,X2,X3,X4,X5,X6)
    # counting is 0-based, so this is actually the 8-queens solution
    queens7(X0,X1,X2,X3,X4,X5,X6,X7) <= queens6(X0,X1,X2,X3,X4,X5,X6) & ok(X0,7,X7) & queens6(X1,X2,X3,X4,X5,X6,X7)
