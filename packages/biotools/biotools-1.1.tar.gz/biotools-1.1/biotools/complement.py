...
def complement(s):
  '''complement( sequence )
  Creates the complement of a sequence, which can then be reversed 
  by using seq[::-1], if it needs to be reversed. This function 
  accepts either Sequences or strings.'''
