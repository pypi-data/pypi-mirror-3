 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/spheresld.h
...
static PyObject * CSphereSLDModelError = NULL;
...
static void
CSphereSLDModel_dealloc(CSphereSLDModel* self)
{
...
static PyObject *
CSphereSLDModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CSphereSLDModel *self;
    
    self = (CSphereSLDModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CSphereSLDModel_init(CSphereSLDModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"thick_flat1",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"thick_flat6",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"thick_flat7",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"thick_flat4",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"thick_flat5",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"thick_inter0",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter1",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter2",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter3",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"sld_core0",Py_BuildValue("d",0.000002070000));
        PyDict_SetItemString(self->params,"thick_inter5",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter6",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter7",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter8",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"thick_inter9",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"rad_core0",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"npts_inter",Py_BuildValue("d",35.000000000000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"thick_inter10",Py_BuildValue("d",50.000000000000));
        ...
        PyDict_SetItemString(self->params,"sld_solv",Py_BuildValue("d",0.000001000000));
        ...
        PyDict_SetItemString(self->params,"func_inter2",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"func_inter3",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"thick_flat10",Py_BuildValue("d",100.000000000000));
        PyDict_SetItemString(self->params,"func_inter5",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"func_inter6",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"func_inter7",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"sld_flat4",Py_BuildValue("d",0.000003500000));
        PyDict_SetItemString(self->params,"sld_flat5",Py_BuildValue("d",0.000004000000));
        PyDict_SetItemString(self->params,"sld_flat6",Py_BuildValue("d",0.000003500000));
        PyDict_SetItemString(self->params,"sld_flat7",Py_BuildValue("d",0.000004000000));
        ...
        PyDict_SetItemString(self->params,"nu_inter10",Py_BuildValue("d",2.500000000000));
        ...
        PyDict_SetItemString(self->params,"nu_inter8",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter5",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter4",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter7",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter6",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter1",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter0",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter3",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"nu_inter2",Py_BuildValue("d",2.500000000000));
        PyDict_SetItemString(self->params,"thick_inter4",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"nu_inter9",Py_BuildValue("d",2.500000000000));
...
static PyMemberDef CSphereSLDModel_members[] = {
    {name_params, T_OBJECT, offsetof(CSphereSLDModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CSphereSLDModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CSphereSLDModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CSphereSLDModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(SphereSLDModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( SphereSLDModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CSphereSLDModelError, 
                   "CSphereSLDModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CSphereSLDModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->thick_flat6 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_flat6") );
    self->model->thick_flat7 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_flat7") );
    self->model->thick_flat4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_flat4") );
    self->model->thick_flat5 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_flat5") );
    self->model->thick_inter0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter0") );
    self->model->thick_inter1 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter1") );
    self->model->thick_inter2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter2") );
    self->model->thick_inter3 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter3") );
    self->model->sld_core0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_core0") );
    self->model->thick_inter5 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter5") );
    self->model->thick_inter6 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter6") );
    ...
    self->model->npts_inter = PyFloat_AsDouble( PyDict_GetItemString(self->params, "npts_inter") );
    ...
    self->model->func_inter2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "func_inter2") );
    self->model->func_inter3 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "func_inter3") );
    self->model->thick_flat10 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_flat10") );
    self->model->func_inter5 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "func_inter5") );
    self->model->func_inter6 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "func_inter6") );
    self->model->func_inter7 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "func_inter7") );
    self->model->sld_flat4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_flat4") );
    self->model->sld_flat5 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_flat5") );
    self->model->sld_flat6 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_flat6") );
    self->model->sld_flat7 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_flat7") );
    ...
    self->model->nu_inter10 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter10") );
    ...
    self->model->nu_inter8 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter8") );
    self->model->nu_inter5 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter5") );
    self->model->nu_inter4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter4") );
    self->model->nu_inter7 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter7") );
    self->model->nu_inter6 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter6") );
    self->model->nu_inter1 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter1") );
    self->model->nu_inter0 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter0") );
    self->model->nu_inter3 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter3") );
    self->model->nu_inter2 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter2") );
    self->model->thick_inter4 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_inter4") );
    self->model->nu_inter9 = PyFloat_AsDouble( PyDict_GetItemString(self->params, "nu_inter9") );
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CSphereSLDModelError, 
	    	"CSphereSLDModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CSphereSLDModelError, 
                   "CSphereSLDModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CSphereSLDModelError, 
	    		"CSphereSLDModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CSphereSLDModelError, 
                   "CSphereSLDModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CSphereSLDModelError, 
                   "CSphereSLDModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CSphereSLDModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CSphereSLDModelError, 
	    	"CSphereSLDModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CSphereSLDModelError, 
	    		"CSphereSLDModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CSphereSLDModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CSphereSLDModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CSphereSLDModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CSphereSLDModel *self) {
 ...
 */
static PyObject * calculate_VR(CSphereSLDModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CSphereSLDModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CSphereSLDModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CSphereSLDModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CSphereSLDModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CSphereSLDModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CSphereSLDModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CSphereSLDModelError,
	    	"CSphereSLDModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "rad_core0")) {
	    ...
	    PyErr_SetString(CSphereSLDModelError,
	    	"CSphereSLDModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CSphereSLDModel_methods[] = {
...
static PyTypeObject CSphereSLDModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CSphereSLDModel",             /*tp_name*/
    sizeof(CSphereSLDModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CSphereSLDModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CSphereSLDModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CSphereSLDModel_methods,             /* tp_methods */
    CSphereSLDModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CSphereSLDModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CSphereSLDModel_new,                 /* tp_new */
};
...
void addCSphereSLDModel(PyObject *module) {
    ...
    if (PyType_Ready(&CSphereSLDModelType) < 0)
        return;

    Py_INCREF(&CSphereSLDModelType);
