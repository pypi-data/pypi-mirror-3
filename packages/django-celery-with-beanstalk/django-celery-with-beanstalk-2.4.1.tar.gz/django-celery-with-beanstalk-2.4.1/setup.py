...
setup(name='django-celery-with-beanstalk',
      version='2.4.1',
      description='''Bundle installing the dependencies for Django-Celery and Beanstalk''',
      ...
      license='''BSD''',
      zip_safe=False,
      install_requires=['django-celery>=2.4,<3.0', 'beanstalkc'],
      classifiers=[
