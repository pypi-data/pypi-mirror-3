...
class Nonlinearity():
   ...
   # ===========================================================================
   def default_exp_f_all( self, A, h, B = None ):
      if( B is None ):
         B = A
      # ========================================================================
      term_spm = np.abs(A)**2
      convolution = ifft( fft(self.h_R) * fft(term_spm) )
   ...
   # ===========================================================================
   def default_exp_f_with_ss( self, A, h, B = None ):
      if( B is None ):
         B = A
      # ========================================================================
      term_spm = np.abs(A)**2
   ...
   # ===========================================================================
   def default_exp_f_with_rs( self, A, h, B = None ):
      if( B is None ):
         B = A
      # ========================================================================
      term_spm = np.abs(A)**2
   ...
   # ===========================================================================
   def default_exp_f_with_ss_and_rs( self, A, h, B = None ):
      if( B is None ):
         B = A
      # ========================================================================
      term_spm = np.abs(A)**2
   ...
   # ===========================================================================
   def default_exp_f( self, A, h, B = None ):
      if( B is None ):
         B = A
      # ========================================================================
   ...
   def wdm_f_with_ss( self, As, z ):
      self.wdm_f( As, z )
   def wdm_exp_f_with_ss( self, As, h, Bs = None ):
      self.wdm_exp_f( As, h, Bs )
   # ===========================================================================
   def wdm_f_with_rs( self, As, z ):
      self.wdm_f( As, z )
   def wdm_exp_f_with_rs( self, As, h, Bs = None ):
      self.wdm_exp_f( As, h, Bs )
   # ===========================================================================
   def wdm_f_with_ss_and_rs( self, As, z ):
      self.wdm_f( As, z )
   def wdm_exp_f_with_ss_and_rs( self, As, h, Bs = None ):
      self.wdm_exp_f( As, h, Bs )
   # ===========================================================================
   def wdm_f( self, As, z ):
      return np.asarray( [ \
   ...
   # ===========================================================================
   def wdm_exp_f( self, As, h, Bs = None ):
      if( Bs is None ):
         Bs = As
      # ========================================================================
