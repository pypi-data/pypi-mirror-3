...
.. class:: handle(**parameters)
   ...
   All of the `parameters` have reasonable defaults -- to authenticate the
   user running the program interactively. Other uses will require either
   supplying values in the constructor call or populating them afterwards
