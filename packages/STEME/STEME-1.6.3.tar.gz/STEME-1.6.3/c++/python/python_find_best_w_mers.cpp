...
typedef find_best_w_mers< DEFAULT_FIND_WMER_STORAGE, EXPOSED_STEME_SPEC > find_best_w_mers_t;
typedef data< EXPOSED_STEME_SPEC > data_t;
typedef model< EXPOSED_STEME_SPEC > model_t;
...
//    evaluations_vec_class.def( py::indexing::container_suite< w_mer_evaluation::vec >() );
    ...
    expose_find_best_w_mers< find_best_w_mers< store_using_multi_index, EXPOSED_STEME_SPEC > >( "FindBestWMersMultiIndex" );
    expose_find_best_w_mers< find_best_w_mers< store_in_set           , EXPOSED_STEME_SPEC > >( "FindBestWMersSet" );
    expose_find_best_w_mers< find_best_w_mers< store_in_sorted_vector , EXPOSED_STEME_SPEC > >( "FindBestWMersSortedVec" );
