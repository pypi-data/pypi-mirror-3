The :program:`ukcloudservers` shell utility
=========================================

.. program:: ukcloudservers
.. highlight:: bash

The :program:`ukcloudservers` shell utility interacts with Rackspace Cloud servers
...
You'll need to provide :program:`ukcloudservers` with your Rackspace username and
...
From there, all shell commands take the form::
    ...
    ukcloudservers <command> [arguments...]

Run :program:`ukcloudservers help` to get a full list of all possible commands,
and run :program:`ukcloudservers help <command>` to get detailed help for that
command.