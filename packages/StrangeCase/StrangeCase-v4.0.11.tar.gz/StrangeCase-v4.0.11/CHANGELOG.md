...
* Opened up the #strangecase chat room on irc.freenode.com
* moved url and iterable "detection" into configuration.  *However*, there **is**
  still a `url` method on `Node`, which attaches the parent's url.
