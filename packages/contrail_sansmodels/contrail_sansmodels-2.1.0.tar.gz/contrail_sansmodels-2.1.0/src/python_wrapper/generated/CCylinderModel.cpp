 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/cylinder.h
...
static PyMemberDef CCylinderModel_members[] = {
    {name_params, T_OBJECT, offsetof(CCylinderModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CCylinderModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CCylinderModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CCylinderModelError, 
                   "CCylinderModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CCylinderModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CCylinderModelError, 
	    	"CCylinderModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CCylinderModelError, 
	    		"CCylinderModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CCylinderModelError, 
                   "CCylinderModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CCylinderModelError, 
 ...
 */
static PyObject * calculate_VR(CCylinderModel *self) {
