#!/usr/bin/env python
"""
TEST_STDLIB_IO_PERSISTENT_NOPOLL.PY -- test script for sub-package STDLIB of package PLIB
...
from stdlib_io_testlib import PersistentTest
from stdlib_io_testlib_persistent import ReadWriteTestMixin, TerminatorTestMixin
