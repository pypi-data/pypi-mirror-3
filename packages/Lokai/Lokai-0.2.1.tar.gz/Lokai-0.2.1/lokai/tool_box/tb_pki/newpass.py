# Name:      lokai/tool_box/tb_pki/newpass.py
...
"""
    Command line program to generate a password string in a way that
    can be handled in command line scripts.

    make_password is also callable.
...
if __name__ == "__main__":
    if len(sys.argv) <> 2:
        ...
        try:
            ...
            print "Given length must be a number"
            out_len = 0
        if out_len > 0:
