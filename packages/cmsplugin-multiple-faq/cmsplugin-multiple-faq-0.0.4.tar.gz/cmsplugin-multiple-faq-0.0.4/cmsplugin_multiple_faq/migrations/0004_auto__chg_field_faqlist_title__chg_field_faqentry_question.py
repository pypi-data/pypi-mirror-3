...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FAQList.title'
        db.alter_column('cmsplugin_multiple_faq_faqlist', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'FAQEntry.question'
        db.alter_column('cmsplugin_multiple_faq_faqentry', 'question', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'FAQList.title'
        db.alter_column('cmsplugin_multiple_faq_faqlist', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'FAQEntry.question'
        db.alter_column('cmsplugin_multiple_faq_faqentry', 'question', self.gf('django.db.models.fields.CharField')(max_length=128))
