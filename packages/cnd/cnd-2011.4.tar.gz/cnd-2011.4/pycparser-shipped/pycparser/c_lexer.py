...
class CLexer(object):
    ...
    ##
    keywords = (
        'AUTO', '_BOOL', '_COMPLEX', 'BREAK', 'CASE', 'CHAR', 'CONST', 'CONTINUE',
        'DEFAULT', 'DO', 'DOUBLE', 'ELSE', 'ENUM', 'EXTERN',
        'FLOAT', 'FOR', 'GOTO', 'IF', 'INLINE', 'INT', 'LONG', 'REGISTER',
        'RESTRICT', 'RETURN', 'SHORT', 'SIGNED', 'SIZEOF', 'STATIC', 'STRUCT',
        'SWITCH', 'TYPEDEF', 'UNION', 'UNSIGNED', 'VOID',
        'VOLATILE', 'WHILE', '__ATTRIBUTE__', '__ASM__', '__ASM', '__TYPEOF__',
        '__REAL__', '__IMAG__', '__BUILTIN_TYPES_COMPATIBLE_P', '__CONST', '__RESTRICT',
    ...
    floating_constant = '(((('+fractional_constant+')'+exponent_part+'?)|([0-9]+'+exponent_part+'))i?[FfLl]?)'
