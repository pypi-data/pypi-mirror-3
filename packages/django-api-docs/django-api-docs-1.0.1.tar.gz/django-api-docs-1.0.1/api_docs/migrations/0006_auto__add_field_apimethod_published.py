...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'APIMethod.published'
        db.add_column('api_docs_apimethod', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'APIMethod.published'
        db.delete_column('api_docs_apimethod', 'published')
