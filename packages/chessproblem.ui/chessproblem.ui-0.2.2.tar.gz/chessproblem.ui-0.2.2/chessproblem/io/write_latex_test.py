...
class WriteLatexTest(unittest.TestCase):
    ...
    def test_writePosition(self):
        ...
        problem = model.Chessproblem()
        problem.board.fields[7][0] = model.Piece(model.PIECE_COLOR_BLACK, model.PIECE_TYPE_KING)
        problem.board.fields[7][2] = model.Piece(model.PIECE_COLOR_WHITE, model.PIECE_TYPE_KING)
        problem.board.fields[6][0] = model.Piece(model.PIECE_COLOR_BLACK, model.PIECE_TYPE_PAWN)
        problem.board.fields[5][1] = model.Piece(model.PIECE_COLOR_WHITE, model.PIECE_TYPE_PAWN)
        problem.board.fields[4][4] = model.Piece(model.PIECE_COLOR_NEUTRAL, model.PIECE_TYPE_KNIGHT, model.PIECE_ROTATION_LEFT)
        problem.board.fields[0][0] = model.Piece(model.PIECE_COLOR_BLACK, model.PIECE_TYPE_CIRCLE)
        problem.board.fields[1][1] = model.Piece(model.PIECE_COLOR_NEUTRAL, model.PIECE_TYPE_EQUIHOPPER)
        problems = [problem]
