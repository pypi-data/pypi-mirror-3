...
class Video(base.ATCTContent):
    ...
    def post_validate(self, REQUEST=None, errors=None):
        ...
        webm_file = REQUEST.get('webm_video.ogg_file', None)
        ...
        if youtube_url and any_set((webm_file, h264_file, ogg_file, webm_url, h264_url, ogg_url)):
            error_message = _(u"You cannot set a Youtube URL combined with any other video source")
            errors['youtube_url'] = error_message
        elif not youtube_url:
            if not any_set((webm_file, h264_file, ogg_file, webm_url, h264_url, ogg_url)):
