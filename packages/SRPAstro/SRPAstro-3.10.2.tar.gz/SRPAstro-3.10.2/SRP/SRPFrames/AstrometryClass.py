...
class Astrometry:
    def __init__ (self, fitsfile, center=None, pixcenter=None, point=None, pixsize=None, rotangle=None, framesize=None, maxres=3.0):
            ...
            if point != None:
                ...
                try:
                    self.RA = self.FitsFrame.Header[FitsConstants.RA]
                    self.DEC = self.FitsFrame.Header[FitsConstants.DEC]
                except KeyError:
                    self.RA = 0.
                    self.DEC = 0.
            # Pixel reference
            ...
            if center != None:
                ...
                try:
                    self.CRVAL1 = self.FitsFrame.Header[FitsConstants.CRVAL1]
                    self.CRVAL2 = self.FitsFrame.Header[FitsConstants.CRVAL2]
                except KeyError:
                    self.CRVAL1 = self.RA
