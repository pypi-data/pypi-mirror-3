...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Summit.etherpad'
        db.add_column('schedule_summit', 'etherpad', self.gf('django.db.models.fields.URLField')(default='http://pad.ubuntu.com/', max_length=75), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Summit.etherpad'
        db.delete_column('schedule_summit', 'etherpad')
