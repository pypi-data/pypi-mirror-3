...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SummitSprint'
        db.create_table('schedule_summitsprint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('summit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Summit'])),
            ('import_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('schedule', ['SummitSprint'])


    def backwards(self, orm):
        
        # Deleting model 'SummitSprint'
        db.delete_table('schedule_summitsprint')
