...
def wcsinit(*args):
  """wcsinit(hstring) -> struct WorldCoor"""
  return _wcs.wcsinit(*args)

def wcsxinit(*args):
  """
    wcsxinit(cra, cdec, secpix, xrpix, yrpix, nxpix, nypix, rotate, 
        equinox, epoch, proj) -> struct WorldCoor
    """
  return _wcs.wcsxinit(*args)

def wcskinit(*args):
  """
    wcskinit(nxpix, nypix, ctype1, ctype2, crpix1, crpix2, crval1, 
        crval2, cd, cdelt1, cdelt2, crota, equinox, 
        epoch) -> struct WorldCoor
    """
