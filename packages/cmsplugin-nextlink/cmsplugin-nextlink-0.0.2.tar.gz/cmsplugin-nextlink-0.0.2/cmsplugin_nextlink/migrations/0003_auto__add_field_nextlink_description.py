...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NextLink.description'
        db.add_column('cmsplugin_nextlink', 'description', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NextLink.description'
        db.delete_column('cmsplugin_nextlink', 'description')
    ...
    models = {
        ...
        'cmsplugin_nextlink.nextlink': {
            ...
            'link_expired': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(3011, 11, 5, 13, 19, 45, 522034)', 'blank': 'True'}),
