...
#
# Created: Tue Apr  3 11:10:16 2012
...
class Ui_ProcessListWidget(object):
    def setupUi(self, ProcessListWidget):
        ...
        self.chkShowIdle = QtGui.QCheckBox(ProcessListWidget)
        self.chkShowIdle.setObjectName(_fromUtf8("chkShowIdle"))
        self.horizontalLayout.addWidget(self.chkShowIdle)
    ...
    def retranslateUi(self, ProcessListWidget):
        ...
        self.chkShowIdle.setText(QtGui.QApplication.translate("ProcessListWidget", "Show idle connections", None, QtGui.QApplication.UnicodeUTF8))
