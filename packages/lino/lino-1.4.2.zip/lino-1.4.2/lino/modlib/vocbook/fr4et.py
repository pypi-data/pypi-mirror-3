...
le jus de rôti [žu də ro'ti] : praeliha mahl
""")
...
le consommé [kO~som'mee] : rammuleem
...
Vocabulary.parse_words(Nom,u"""
la sauce [soos] : kaste
le beurre manié [bÖÖr man'jee]: või-jahu-segu
le roux [ru] : rasvaga praetud jahu

le mirepoix [mirəpu'a] : praetud kuubikud (sibul, porgand, seller)
la brunoise [brünu'aaz] : juur- või puuvili kuubikud (2mm)
la julienne [jül'jänn] : juurvilja lõikamise viis lamellideks

la sauce paysanne [pei'zan] : talupoja kaste
la sauce jardinière [žardin'jäär] : aedniku kaste
la sauce macédoine [masedu'ann] : juurviljasalat
la sauce Sabayon [saba'jO~] : Sabayon-kaste
#la sauce demi-glace [dəmi'glass] : - 
""")
