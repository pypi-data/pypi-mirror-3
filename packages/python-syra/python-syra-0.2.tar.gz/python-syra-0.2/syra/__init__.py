...
class API(object):
    ...
    def domain_list(self):
        ...
        for domain in request.APIResponse.DomainList:
            yield self._domain_list_item(domain)
    ...
    def _domain_list_item(self, o):
        try:
            expiry_date = parse(o.Expiry[0]).date()
        except (AttributeError, TypeError):
            expiry_date = o.Expiry[0]
        return (o.DomainName[0], o.Status[0], expiry_date)
