...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="PPlus Network Node Adder (pplus-%s)" % version)

    parser.add_argument('-n, --nfs-mount-point', dest='nfs_mount',
                        action='store',
                        required=True, type=check_nfs,
                        help='NFS mount point with format remote_host:remote_dir. '
