...
def setup_product():
    ...
    import GrailTact.GrailTact
    zcml.load_config('configure.zcml', GrailTact.GrailTact)
    ...
    ztc.installPackage('GrailTact.GrailTact')
...
setup_product()
ptc.setupPloneSite(products=['GrailTact.GrailTact'])
