...
#        misc.setLocalIdentity(lid)
    ...
    lid.version = _RevisionNumber.strip() + ' ' + repo + ' ' + lid.version
    misc.setLocalIdentity(lid)
...
'''
Please download msxml3.msi from http://download.cnet.com/Microsoft-XML-Parser-MSXML-3-0-Service-Pack-7-SP7/3000-7241_4-10731613.html, place it in /home/veselin/.cache/winetricks/msxml3, then re-run this script.
'''
