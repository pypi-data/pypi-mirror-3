...
class ThemeTab(Tab, framework.TabFriendlyCompoundElement):
    def __init__(self, app, onClose=None, onRestart=None):
        ...
        self.staticText = [
            ...
            TextElement(self.app, 'theme contents:', font,
                    ScaledLocation(960, 390, 'topright'), colours.headingColour)
        ]
    ...
    def populateList(self):
        ...
        for themeName in themeList:
            ...
            for contentType in self.contentTypes.keys():
        ...
        items = [(v['filename'], n) for n, v in self.themeInfo.iteritems()]
        items.sort()
    ...
    def updateSidebar(self, listID):
        ...
        if themeInfo['content'] is None:
            ...
            count = 0
            for k, v in themeInfo['content'].iteritems():
                suffix = ""
                if v != 1:
                    suffix = "s"
