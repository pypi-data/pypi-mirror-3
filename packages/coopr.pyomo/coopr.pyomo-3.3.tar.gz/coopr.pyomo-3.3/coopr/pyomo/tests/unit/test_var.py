...
class MiscVarTests(pyutilib.th.TestCase):
    ...
    def test_getattr1(self):
        ...
        #except AttributeError:
            #pass
        model.a.declare_suffix("suffix")
        model.a.declare_suffix("foo",default=False)
        #try:
            #
        ...
        self.assertEqual(instance.a.get_suffix_value("suffix"),None)
        instance.a.set_suffix_value("suffix",True)
        self.assertEqual(instance.a.get_suffix_value("suffix"),True)
        self.assertEqual(instance.a.get_suffix_value("foo"),False)
    ...
    def test_getattr2(self):
        ...
        try:
            ...
            pass
        instance = model.create()
        self.assertEqual(instance.a[1].get_suffix_value("suffix"),None)
        instance.a[1].set_suffix_value("suffix", True)
        self.assertEqual(instance.a[1].get_suffix_value("suffix"),True)
        self.assertEqual(instance.a[3].get_suffix_value("foo"),False)
