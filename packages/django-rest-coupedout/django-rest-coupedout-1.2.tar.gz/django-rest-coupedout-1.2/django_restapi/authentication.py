...
def djangouser_auth(username, password, request):
    """
...
class HttpBasicAuthentication(object):
    ...
    """    
    def __init__(self, authfunc=djangouser_auth, realm=_('Restricted Access'), anonymous=True):
        """
        authfunc:
    ...
    def is_authenticated(self, request):
        ...
        return self.authfunc(username=username, password=password,request=request)
