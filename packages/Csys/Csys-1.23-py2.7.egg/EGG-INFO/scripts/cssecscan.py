#!/home/bill/.virtualenvs/mezz/bin/python

# $Header: /vol/cscvs/python-Csys/cssecscan.py,v 1.2 2011/10/05 23:03:51 csoftmgr Exp $
# $Date: 2011/10/05 23:03:51 $
...
$Id: cssecscan.py,v 1.2 2011/10/05 23:03:51 csoftmgr Exp $
'''
...
def getConfig(fname): #{
	...
	for line in fh: #{
		line = commentPattern.sub('', line.rstrip())
		if line: #{
			...
			#}
				...
				R = linePattern.match(line)
				if R: #{{
					dbconfig[R.group(1)] = R.group(1)
				#}
				else: #{
					dbconfig[line] = None
				#}}
