...
static PyObject * CFlexCylEllipXModelError = NULL;
...
static void
CFlexCylEllipXModel_dealloc(CFlexCylEllipXModel* self)
{
...
static PyObject *
CFlexCylEllipXModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CFlexCylEllipXModel *self;
    
    self = (CFlexCylEllipXModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CFlexCylEllipXModel_init(CFlexCylEllipXModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        disp_dict = PyDict_New();
        self->model->axis_ratio.dispersion->accept_as_source(visitor, self->model->axis_ratio.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "axis_ratio", disp_dict);
...
static PyMemberDef CFlexCylEllipXModel_members[] = {
    {name_params, T_OBJECT, offsetof(CFlexCylEllipXModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CFlexCylEllipXModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CFlexCylEllipXModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CFlexCylEllipXModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(FlexCylEllipXModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( FlexCylEllipXModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CFlexCylEllipXModelError, 
                   "CFlexCylEllipXModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 */
static PyObject * calculate_ER(CFlexCylEllipXModel *self) {
 ...
 */
static PyObject * calculate_VR(CFlexCylEllipXModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CFlexCylEllipXModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CFlexCylEllipXModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CFlexCylEllipXModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CFlexCylEllipXModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CFlexCylEllipXModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CFlexCylEllipXModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CFlexCylEllipXModelError,
	    	"CFlexCylEllipXModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    } else    if (!strcmp(par_name, "axis_ratio")) {
        self->model->axis_ratio.dispersion = dispersion;
    } else {
	    PyErr_SetString(CFlexCylEllipXModelError,
	    	"CFlexCylEllipXModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CFlexCylEllipXModel_methods[] = {
...
static PyTypeObject CFlexCylEllipXModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CFlexCylEllipXModel",             /*tp_name*/
    sizeof(CFlexCylEllipXModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CFlexCylEllipXModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CFlexCylEllipXModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CFlexCylEllipXModel_methods,             /* tp_methods */
    CFlexCylEllipXModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CFlexCylEllipXModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CFlexCylEllipXModel_new,                 /* tp_new */
};
...
void addCFlexCylEllipXModel(PyObject *module) {
    ...
    if (PyType_Ready(&CFlexCylEllipXModelType) < 0)
        return;

    Py_INCREF(&CFlexCylEllipXModelType);
