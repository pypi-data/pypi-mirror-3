...
from jsb3.utils.generic import toenc, fromenc
from jsb3.utils.generic import getrandomnick, strippedtxt
from jsb3.utils.generic import fix_format, splittxt, uniqlist
from jsb3.utils.locking import lockdec, lock_object, release_object
from jsb3.lib.botbase import BotBase
from jsb3.lib.threads import start_new_thread, threaded
from jsb3.utils.pdod import Pdod
from jsb3.lib.channelbase import ChannelBase
from jsb3.lib.morphs import inputmorphs, outputmorphs
...
class Irc(BotBase):
    ...
    def logon(self):
        ...
        username = self.cfg.username or "jsb3"
        realname = self.cfg.realname or "jsonbot3"
        time.sleep(1)
