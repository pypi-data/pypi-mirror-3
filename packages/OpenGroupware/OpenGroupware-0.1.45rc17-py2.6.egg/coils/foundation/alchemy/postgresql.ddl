...
ALTER TABLE public.message OWNER TO "OGo";
...
ALTER TABLE public.process OWNER TO "OGo";
...
ALTER TABLE public.route OWNER TO "OGo";
...
ALTER TABLE public.collection OWNER TO "OGo";
...
ALTER TABLE public.collection_assignment OWNER TO "OGo";
...
CREATE TABLE LOCK (
   token CHARACTER(36) PRIMARY KEY,
   object_id INTEGER NOT NULL,
   owner_id INTEGER NOT NULL,
   expires BIGINT,
   granted BIGINT,
