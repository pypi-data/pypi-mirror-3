 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/polygausscoil.h
...
static PyObject * CPoly_GaussCoilError = NULL;
...
static void
CPoly_GaussCoil_dealloc(CPoly_GaussCoil* self)
{
...
static PyObject *
CPoly_GaussCoil_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CPoly_GaussCoil *self;
    
    self = (CPoly_GaussCoil *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CPoly_GaussCoil_init(CPoly_GaussCoil *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model->rg.dispersion->accept_as_source(visitor, self->model->rg.dispersion, disp_dict);
        PyDict_SetItemString(self->dispersion, "rg", disp_dict);
...
static PyMemberDef CPoly_GaussCoil_members[] = {
    {name_params, T_OBJECT, offsetof(CPoly_GaussCoil, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CPoly_GaussCoil, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CPoly_GaussCoil, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CPoly_GaussCoil_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(Poly_GaussCoil* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( Poly_GaussCoil* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CPoly_GaussCoilError, 
                   "CPoly_GaussCoil.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 */
static PyObject * run(CPoly_GaussCoil *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CPoly_GaussCoilError, 
	    	"CPoly_GaussCoil.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CPoly_GaussCoilError, 
	    		"CPoly_GaussCoil.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CPoly_GaussCoil_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CPoly_GaussCoil_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CPoly_GaussCoil_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CPoly_GaussCoil *self) {
 ...
 */
static PyObject * calculate_VR(CPoly_GaussCoil *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CPoly_GaussCoil *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CPoly_GaussCoil_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CPoly_GaussCoil_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CPoly_GaussCoil_readDouble(pars);		
...
static PyObject * set_dispersion(CPoly_GaussCoil *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CPoly_GaussCoilError,
	    	"CPoly_GaussCoil.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
	...
	// Ugliness necessary to go from python to C
	    // TODO: refactor this
    if (!strcmp(par_name, "rg")) {
        self->model->rg.dispersion = dispersion;
    } else {
	    PyErr_SetString(CPoly_GaussCoilError,
	    	"CPoly_GaussCoil.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CPoly_GaussCoil_methods[] = {
...
static PyTypeObject CPoly_GaussCoilType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CPoly_GaussCoil",             /*tp_name*/
    sizeof(CPoly_GaussCoil),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CPoly_GaussCoil_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CPoly_GaussCoil objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CPoly_GaussCoil_methods,             /* tp_methods */
    CPoly_GaussCoil_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CPoly_GaussCoil_init,      /* tp_init */
    0,                         /* tp_alloc */
    CPoly_GaussCoil_new,                 /* tp_new */
};
...
void addCPoly_GaussCoil(PyObject *module) {
    ...
    if (PyType_Ready(&CPoly_GaussCoilType) < 0)
        return;

    Py_INCREF(&CPoly_GaussCoilType);
