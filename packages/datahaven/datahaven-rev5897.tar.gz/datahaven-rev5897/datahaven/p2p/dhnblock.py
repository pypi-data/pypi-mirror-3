...
##        d.addErrback(fail)
    ...
    def Valid(self):
        ...
        if ConIdentity is None:
            dhnio.Dprint(2, "dhnblock.Valid could not get Identity so returning False")
            return(False)
...
##        LastBlock=False
##        Data="This is a short test block"
##        testblock=dhnblock(CreatorID, BackupID, BlockNumber, SessionKey, SessionKeyType, LastBlock, Data)
##        if (testblock.Valid()):
##            dhnio.Dprint(7, "testblock is Valid")
##        else:
##            dhnio.Dprint(7, "testblock is NOT Valid")
##            raise Exception("testblock NOT valid")
##        ser = testblock.Serialize()
##        testblock2 = Unserialize(ser)
##        if (testblock2.Valid()):
##            dhnio.Dprint(7, "testblock2 is Valid")
##        else:
##            dhnio.Dprint(7, "testblock2 is NOT Valid")
##            raise Exception("testblock2 NOT valid")
