...
class AutoAPI(object):
    ...
    def __call__(self, cls):
        ...
        methods =  [ "delete" ]
        if hasattr(self.api_class, "__methods__"):
            methods.extend(self.api_class.__methods__)
...
def CreateNewClass(ClientClass, APIClass, autoload):
    ...
    @param autoload This sets whether, on instantiation, an object pulls
