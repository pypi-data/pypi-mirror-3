...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Summit.hashtag'
        db.add_column('schedule_summit', 'hashtag', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Summit.hashtag'
        db.delete_column('schedule_summit', 'hashtag')
