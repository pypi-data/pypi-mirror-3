...
def generate_email(message, env):
    print message
    text_xml = '<testsuite name="dummy" tests="0" errors="0" failures="0" skip="0"/>'
    ...
    write_file(env['WORKSPACE']+'/test_results/_hudson/dummy.xml', test_xml)    
    write_file(env['WORKSPACE']+'/test_results/0/_hudson/dummy.xml', test_xml)
