...
def plugme(app_config, options):
    ...
    if not app_config.use_toscawidgets:
        app_config.use_toscawidgets = True

    if getattr(app_config, 'prefer_toscawidgets2', False):
        raise Exception("Smallpress can't work with prefer_toscawidgets2 option, please change it to use_toscatiwdgets2 = True")
