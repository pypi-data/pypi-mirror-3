...
This chapter describes how to use and configure *everyapp.bootstrap*.  It
starts with some basic usage instructions and then goes on to provide full
details on each of the three main components.
