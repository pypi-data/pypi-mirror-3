...
map_plot( x, y, z, labels["t"], labels["P_t"], labels["z"],
          "lanczos", True, "5-16c_map.png", 100 )
# ==============================================================================
waterfall_plot( x, y, z, labels["t"], labels["z"], labels["P_t"],
                True, 0.2, "5-16c_waterfall.png", 100, (0.0, 1.2) )
# ==============================================================================
animated_plot( x, y, z, labels["t"], labels["P_t"], "$z = {0:7.3f} \, km$", 
               (x[0], x[-1]), (0.0, 1.2), fps = stepper.traces / 10,
               frame_prefix = "c_", filename = "5-16c_animation.avi" )
# ==============================================================================
