# -*- coding: utf-8 -*-
#------------------------------------------------------------------------------
# file: $Id: context.py 37 2012-07-21 16:32:26Z griff1n $
...
class Context(object):
  ...
  def Adapter(self, **kw):
    ...
    The Adapter "constructor" (since this is really just a method of a
    Context instance) supports the following parameters:
  ...
  def RemoteAdapter(self, **kw):
    ...
    The RemoteAdapter "constructor" (since this is really just a
    method of a Context instance) supports the following parameters:
...
#------------------------------------------------------------------------------
# end of $Id: context.py 37 2012-07-21 16:32:26Z griff1n $
#------------------------------------------------------------------------------
