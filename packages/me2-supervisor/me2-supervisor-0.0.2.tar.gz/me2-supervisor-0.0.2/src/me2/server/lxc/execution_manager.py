...
from me2.server.execution_manager import ExecutionManagerBase
...
class LxcExecutionManager(ExecutionManagerBase):
    ...
    def __init__(self, *args, **kw):
        ...
        self._lxc_config = Template(text = resource_manager.resource_string(__name__, "data/templates/lxc_config.mak"))
