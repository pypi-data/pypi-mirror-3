...
class SerializeResponder(object):
    ...
    """
    def __init__(self, format, mimetype=None, paginate_by=None, allow_empty=False,html_error=False):
        """
        format:
    ...
    def render(self, object_list, relations=(), extras=()):
        """
        ...
        response = serializers.serialize(self.format, object_list, relations=relations, extras=extras)
    ...
    @csrf_exempt
    def element(self, request, elem, relations=(), extras=()):
        """
        Renders single model objects to HttpResponse.
        """
        return HttpResponse(self.render([elem], relations=relations, extras=extras), self.mimetype)
    ...
    def list(self, request, queryset, relations=(), extras=(), page=None):
        """
        ...
        return HttpResponse(self.render(object_list, relations=relations, extras=extras), self.mimetype)
    
class JSONResponder(SerializeResponder):
    """
    JSON data format class.
    """
    def __init__(self, paginate_by=None, allow_empty=False,html_error=False):
        SerializeResponder.__init__(self, 'json', 'application/json',
                    paginate_by=paginate_by, allow_empty=allow_empty, html_error=html_error)
...
class XMLResponder(SerializeResponder):
    ...
    def __init__(self, paginate_by=None, allow_empty=False, html_error=False):
        SerializeResponder.__init__(self, 'xml', 'application/xml',
                    paginate_by=paginate_by, allow_empty=allow_empty, html_error=False)
