...
class image(mixins.catalog,
    ...
    def __init__(self, *arguments, **keywords):
        OFS.Image.Image.__init__.im_func(self, *arguments, **keywords)

    def manage_afterAdd(self, item, container):
        OFS.Image.Image.manage_afterAdd.im_func(self, item, container)
        image.inheritedAttribute('manage_afterAdd')(self, item, container)

    def manage_afterClone(self, item, container):
        OFS.Image.Image.manage_afterClone.im_func(self, item, container)
        image.inheritedAttribute('manage_afterClone')(self, item, container)

    def manage_beforeDelete(self, item, container):
        OFS.Image.Image.manage_beforeDelete.im_func(self, item, container)
