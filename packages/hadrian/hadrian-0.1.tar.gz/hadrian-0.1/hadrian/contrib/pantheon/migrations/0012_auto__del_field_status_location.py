...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Status.location'
        db.delete_column('blog_status', 'location_id')


    def backwards(self, orm):
        
        # Adding field 'Status.location'
        db.add_column('blog_status', 'location', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['newsfeed.Location']), keep_default=False)
