...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Archive', fields ['date']
        db.create_index(u'archive', ['date'])


    def backwards(self, orm):
        
        # Removing index on 'Archive', fields ['date']
        db.delete_index(u'archive', ['date'])

        # Removing index on 'Message', fields ['date']
        db.delete_index('messages', ['date'])
