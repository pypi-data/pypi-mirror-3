#!/usr/bin/env python
"""SymPySlices is a python block code editor / shell and namespace browser application."""
...
__cvsid__ = "$Id: SymPySlices.py 36607 2005-12-30 23:02:03Z RD $" # Hmmm...
...
class App(wx.App):
    ...
    def OnInit(self):
        import os
        import wx
        from wx_py import sympycrustslices
        import wx_py as py
        ...
        self.frame = sympycrustslices.CrustSlicesFrame(config=self.config, dataDir=confDir,
...
pycrust script that wxPython installs:
    ...
    from wx_py.PySlices import main
    main()
'''
