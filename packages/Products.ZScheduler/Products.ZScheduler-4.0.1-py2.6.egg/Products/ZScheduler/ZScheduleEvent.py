...
class ZScheduleEvent ( LogSupport ):
    ...
    def active(self):
        ...
        active status flag
        """
        return self.Control_Panel.ZScheduler.isScheduled(self)
    ...
    def manage_beforeDelete(self, item, container):
        ...
        """
        self.Control_Panel.ZScheduler.unschedule(self)
    ...
    def manage_schedule(self, REQUEST=None):
	    ...
	    self.Control_Panel.ZScheduler.unschedule(self)
            ...
            pass
        self.Control_Panel.ZScheduler.schedule(self)
        if REQUEST:
            REQUEST.set('management_view', 'Schedule')
            return self.manage_scheduleForm(self, REQUEST)
    ...
    def manage_invokeEvent(self, *args, **kw):
        ...
        self.Control_Panel.ZScheduler.log(self, 'executed...', output)
        return output
