...
web build:
 - http://mootools.net/core/282b5dd69ca2c0225fe9846aaeeac287

packager build:
 - packager build Core/Element.Delegation Core/Element.Dimensions Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request.HTML Core/DOMReady
...
};var f=(h?function(l,k){l.style.opacity=k;}:(e?function(l,k){var n=l.style;if(!l.currentStyle||!l.currentStyle.hasLayout){n.zoom=1;}if(k==null){k="";}else{k="alpha(opacity="+(k*100).limit(0,100).round()+")";
...
// MooTools: the javascript framework.
// Load this file's selection again by visiting: http://mootools.net/more/d4dd0d0d41782d171c42da354e720feb 
// Or build this file again with packager using: packager build More/Array.Extras More/Hash.Extras More/Fx.Slide More/Drag.Move
/*
---
copyrights:
  - [MooTools](http://mootools.net)
...
},cleanValues:function(a){return new Hash(Object.cleanValues(this,a));},run:function(){Object.run(arguments);}});Fx.Slide=new Class({Extends:Fx,options:{mode:"vertical",wrapper:false,hideOverflow:true,resetHeight:false},initialize:function(b,a){b=this.element=this.subject=document.id(b);
