...
def addCleanOptions(optionManager):
    ...
    optionManager.add_option('-r','--ration',
                             action="store", dest="ratio",
                             metavar="<TAGNAME",
                             type="float",
                             default=1,
                             help="minimum ratio between count to be considered as an error")
...
if __name__ == '__main__':
    ...
    optionParser = getOptionManager([addCleanOptions,addInOutputOption])
