# $Id: users.py 32ee5db7eea3 2012/08/13 11:15:17 Patrick $
...
class User(Base):
    ...
    def setup_environment(self, request):
        ...
        * ``home``: home page content
        ...
        # Language
        langs = request.registry.settings.get('languages').split()
    ...
    def load(cls, settings, user_elt, error_if_exists=True):
        ...
        record = {
            ...
            'password':
            user_elt.findtext('password') is not None
