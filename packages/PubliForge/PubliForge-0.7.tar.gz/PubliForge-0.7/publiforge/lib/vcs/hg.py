# $Id: hg.py c0062fcc9f82 2012/07/22 19:34:51 patrick $
...
class VcsMercurial(Vcs):
    ...
    def clone(self, handler=None):
        ...
        except (Abort, RepoError, HTTPError, URLError, OSError), error:
    ...
    def log(self, path, filename, limit=1):
        ...
        try:
            commands.log(
                my_ui, repo, filename, limit=str(limit),
