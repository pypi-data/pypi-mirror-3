...
class TestTextImport(unittest.TestCase):
    ...
    def test_tableY(self):
        ...
        self.assertEqual(instance.Y.sparse_extract_values(), {'A1':3.3,'A2':3.4,'A3':3.5})
    ...
    def test_tableXW_1(self):
        ...
        self.assertEqual(instance.A.data(), set(['A1','A2','A3','A4']))
        self.assertEqual(instance.X.sparse_extract_values(), {'A1':3.3,'A2':3.4,'A3':3.5})
        self.assertEqual(instance.W.sparse_extract_values(), {'A1':4.3,'A2':4.4,'A3':4.5})
    ...
    def test_tableXW_4(self):
        ...
        self.assertEqual(instance.R.sparse_extract_values(), {'A1':3.3,'A2':3.4,'A3':3.5})
        self.assertEqual(instance.S.sparse_extract_values(), {'A1':4.3,'A2':4.4,'A3':4.5})
        os.remove(currdir+'importXW.dat')
    ...
    def test_tableT(self):
        ...
        self.assertEqual(instance.T.sparse_extract_values(), {('A2', 'I1'): 2.3, ('A1', 'I2'): 1.4, ('A1', 'I3'): 1.5, ('A1', 'I4'): 1.6, ('A1', 'I1'): 1.3, ('A3', 'I4'): 3.6, ('A2', 'I4'): 2.6, ('A3', 'I1'): 3.3, ('A2', 'I3'): 2.5, ('A3', 'I2'): 3.4, ('A2', 'I2'): 2.4, ('A3', 'I3'): 3.5})
    ...
    def test_tableU(self):
        ...
        self.assertEqual(instance.U.sparse_extract_values(), {('I2', 'A1'): 1.4, ('I3', 'A1'): 1.5, ('I3', 'A2'): 2.5, ('I4', 'A1'): 1.6, ('I3', 'A3'): 3.5, ('I1', 'A2'): 2.3, ('I4', 'A3'): 3.6, ('I1', 'A3'): 3.3, ('I4', 'A2'): 2.6, ('I2', 'A3'): 3.4, ('I1', 'A1'): 1.3, ('I2', 'A2'): 2.4})
    ...
    def test_tableS(self):
        ...
        self.assertEqual(instance.A.data(), set(['A1','A2','A3','A4']))
        self.assertEqual(instance.S.sparse_extract_values(), {'A1':3.3,'A3':3.5})
    ...
    def test_tablePO(self):
        ...
        self.assertEqual(instance.P.sparse_extract_values(), {('A3', 'B3'): 4.5, ('A1', 'B1'): 4.3, ('A2', 'B2'): 4.4} )
        self.assertEqual(instance.O.sparse_extract_values(), {('A3', 'B3'): 5.5, ('A1', 'B1'): 5.3, ('A2', 'B2'): 5.4})
...
class TestCsvImport(unittest.TestCase):
    ...
    def test_tablePO(self):
        ...
        self.assertEqual(instance.J.data(), set([('A3', 'B3'), ('A1', 'B1'), ('A2', 'B2')]) )
        self.assertEqual(
            instance.P.sparse_extract_values(),
            {('A3', 'B3'): 4.5, ('A1', 'B1'): 4.3, ('A2', 'B2'): 4.4} )
        self.assertEqual(
            instance.O.sparse_extract_values(),
