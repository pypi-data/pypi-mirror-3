...
def setup_product():
    ...
    import xhostplus.textzoom
    zcml.load_config('configure.zcml', xhostplus.textzoom)
    ...
    ztc.installPackage('xhostplus.textzoom')
...
setup_product()
ptc.setupPloneSite(products=['xhostplus.textzoom'])
