...
VERSION = 0.1
__all__ = [
            "main", "VERSION", "Error", "FileList", "Sed", "console", "Env", "Require", "Yak", "VirtualEnv", "System", "FileSystem",
            "combine", "sh", "minify", "jslint", "jsdoc", "patch", "prompt", "deepcopy", "stats", "pack", "unpack", "hsizeof"
         ]
