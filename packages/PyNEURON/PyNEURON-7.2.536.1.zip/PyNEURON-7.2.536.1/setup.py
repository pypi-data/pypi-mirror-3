...
setup(name="PyNEURON",
      version="7.2.536.1", # NEURON 7.2 revision 536
      packages=["neuron", "neuron.tests", "neuron.neuroml"],
      package_dir={"neuron": "python/neuron"},
      data_files=[(sys.prefix + "/neuronhome/bin", ["Win32/hoc.pyd", "Win32/nrniv.dll"]),
                  (sys.prefix + "/neuronhome/lib/hoc", glob.glob("home/hoc/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/celbild", glob.glob("home/hoc/celbild/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/chanbild", glob.glob("home/hoc/chanbild/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/import3d", glob.glob("home/hoc/import3d/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/lincir", glob.glob("home/hoc/lincir/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/mulfit", glob.glob("home/hoc/mulfit/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/mview", glob.glob("home/hoc/mview/*.hoc")),
                  (sys.prefix + "/neuronhome/lib/hoc/netbild", glob.glob("home/hoc/netbild/*.hoc")),
                  ],
