...
def setupPortalContent(portal):
    ...
    if fpage.title == 'Welcome to Plone':
        fpage.setTitle(fptitle)
        fpage.setDescription(fpdesc)
...
def defaultSettings(portal):
    ...
    site.allowed_content_types = ('Topic', 'School', 'Division', 'Folder', 'Document', 'Link', 'File', 'Image', 'CoursesTopic', 'Feedback')
