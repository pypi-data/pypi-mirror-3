#!/csoft/bin/python
# $Header: /vol/cscvs/python-Csys/Netparams.py,v 1.9 2011/10/05 22:41:05 csoftmgr Exp $
# $Date: 2011/10/05 22:41:05 $
# @(#) $Id: Netparams.py,v 1.9 2011/10/05 22:41:05 csoftmgr Exp $
#
