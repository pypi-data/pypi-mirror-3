# ../../../dm/saml2/pyxb/raw/authncontext_ip.py
# PyXB bindings for NM:0bdad18ff7673be7916ca9e092f0fd0d363e24f2
# Generated 2012-02-07 09:42:35.115302 by PyXB version 1.1.3
# Namespace urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol
...
Namespace = pyxb.namespace.NamespaceForURI(u'urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol', create_if_missing=True)
...
STD_ANON_.secondary = STD_ANON_._CF_enumeration.addEnumeration(unicode_value=u'secondary', tag=u'secondary')
...
class ExtensionOnlyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ExtensionOnlyType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
...
class TimeSyncTokenType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __DeviceType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'DeviceType'), 'DeviceType', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TimeSyncTokenType_DeviceType', DeviceTypeType, required=True)
    
    DeviceType = property(__DeviceType.value, __DeviceType.set, None, None)

    
    # Attribute SeedLength uses Python identifier SeedLength
    __SeedLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'SeedLength'), 'SeedLength', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TimeSyncTokenType_SeedLength', pyxb.binding.datatypes.integer, required=True)
    ...
    __DeviceInHand = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'DeviceInHand'), 'DeviceInHand', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TimeSyncTokenType_DeviceInHand', booleanType, required=True)
...
class PrincipalAuthenticationMechanismType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Smartcard uses Python identifier Smartcard
    __Smartcard = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Smartcard'), 'Smartcard', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolSmartcard', False)

    
    Smartcard = property(__Smartcard.value, __Smartcard.set, None, u'\n        This element indicates that a smartcard is used to\n        identity the Principal.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Token uses Python identifier Token
    __Token = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Token'), 'Token', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolToken', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolPassword', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ActivationPin uses Python identifier ActivationPin
    __ActivationPin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationPin'), 'ActivationPin', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolActivationPin', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acclassesInternetProtocolRestrictedPassword', False)
    ...
    __preauth = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'preauth'), 'preauth', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrincipalAuthenticationMechanismType_preauth', pyxb.binding.datatypes.integer)
...
class PublicKeyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PublicKeyType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
    ...
    __keyValidation = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'keyValidation'), 'keyValidation', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PublicKeyType_keyValidation', pyxb.binding.datatypes.anySimpleType)
...
class AuthenticatorTransportProtocolType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ISDN uses Python identifier ISDN
    __ISDN = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ISDN'), 'ISDN', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolISDN', False)

    
    ISDN = property(__ISDN.value, __ISDN.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SSL uses Python identifier SSL
    __SSL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SSL'), 'SSL', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolSSL', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}WTLS uses Python identifier WTLS
    __WTLS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'WTLS'), 'WTLS', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolWTLS', False)

    
    WTLS = property(__WTLS.value, __WTLS.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using a transport mechanism protected by a WTLS session.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ADSL uses Python identifier ADSL
    __ADSL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ADSL'), 'ADSL', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolADSL', False)

    
    ADSL = property(__ADSL.value, __ADSL.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}HTTP uses Python identifier HTTP
    __HTTP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), 'HTTP', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolHTTP', False)

    
    HTTP = property(__HTTP.value, __HTTP.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using bare HTTP utilizing no additional security\n        protocols.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}MobileNetworkNoEncryption uses Python identifier MobileNetworkNoEncryption
    __MobileNetworkNoEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkNoEncryption'), 'MobileNetworkNoEncryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolMobileNetworkNoEncryption', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}MobileNetworkEndToEndEncryption uses Python identifier MobileNetworkEndToEndEncryption
    __MobileNetworkEndToEndEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkEndToEndEncryption'), 'MobileNetworkEndToEndEncryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolMobileNetworkEndToEndEncryption', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}IPSec uses Python identifier IPSec
    __IPSec = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPSec'), 'IPSec', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolIPSec', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}MobileNetworkRadioEncryption uses Python identifier MobileNetworkRadioEncryption
    __MobileNetworkRadioEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkRadioEncryption'), 'MobileNetworkRadioEncryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolMobileNetworkRadioEncryption', False)

    
    MobileNetworkRadioEncryption = property(__MobileNetworkRadioEncryption.value, __MobileNetworkRadioEncryption.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PSTN uses Python identifier PSTN
    __PSTN = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PSTN'), 'PSTN', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acclassesInternetProtocolPSTN', False)
...
class ActivationLimitType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ActivationLimitUsages uses Python identifier ActivationLimitUsages
    __ActivationLimitUsages = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitUsages'), 'ActivationLimitUsages', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationLimitType_urnoasisnamestcSAML2_0acclassesInternetProtocolActivationLimitUsages', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ActivationLimitSession uses Python identifier ActivationLimitSession
    __ActivationLimitSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitSession'), 'ActivationLimitSession', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationLimitType_urnoasisnamestcSAML2_0acclassesInternetProtocolActivationLimitSession', False)

    
    ActivationLimitSession = property(__ActivationLimitSession.value, __ActivationLimitSession.set, None, u'\n        This element indicates that the Key Activation Limit is\n        the session.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ActivationLimitDuration uses Python identifier ActivationLimitDuration
    __ActivationLimitDuration = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitDuration'), 'ActivationLimitDuration', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationLimitType_urnoasisnamestcSAML2_0acclassesInternetProtocolActivationLimitDuration', False)
...
class PasswordType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Alphabet uses Python identifier Alphabet
    __Alphabet = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Alphabet'), 'Alphabet', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolAlphabet', False)

    
    Alphabet = property(__Alphabet.value, __Alphabet.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Length uses Python identifier Length
    __Length = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Length'), 'Length', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolLength', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Generation uses Python identifier Generation
    __Generation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Generation'), 'Generation', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolGeneration', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PasswordType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
    ...
    __ExternalVerification = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ExternalVerification'), 'ExternalVerification', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PasswordType_ExternalVerification', pyxb.binding.datatypes.anyURI)
...
class RestrictedPasswordType (PasswordType):
    ...
    # Element Extension ({urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension) inherited from {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PasswordType
    
    # Element Length uses Python identifier Length_
    __Length_ = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(None, u'Length'), 'Length_', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_RestrictedPasswordType_Length', False)

    
    Length_ = property(__Length_.value, __Length_.set, None, None)

    
    # Element Generation ({urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Generation) inherited from {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PasswordType
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mechanism = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mechanism'), 'mechanism', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_CTD_ANON_mechanism', STD_ANON, required=True)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    __credentialLevel = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'credentialLevel'), 'credentialLevel', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_CTD_ANON__credentialLevel', STD_ANON_)
...
class TokenType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}TimeSyncToken uses Python identifier TimeSyncToken
    __TimeSyncToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeSyncToken'), 'TimeSyncToken', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TokenType_urnoasisnamestcSAML2_0acclassesInternetProtocolTimeSyncToken', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TokenType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
...
class KeyActivationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ActivationPin uses Python identifier ActivationPin
    __ActivationPin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationPin'), 'ActivationPin', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_KeyActivationType_urnoasisnamestcSAML2_0acclassesInternetProtocolActivationPin', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_KeyActivationType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
...
class ActivationLimitUsagesType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __number = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'number'), 'number', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationLimitUsagesType_number', pyxb.binding.datatypes.integer, required=True)
...
class AuthnContextDeclarationBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}TechnicalProtection uses Python identifier TechnicalProtection
    __TechnicalProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TechnicalProtection'), 'TechnicalProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolTechnicalProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}GoverningAgreements uses Python identifier GoverningAgreements
    __GoverningAgreements = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreements'), 'GoverningAgreements', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolGoverningAgreements', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}AuthnMethod uses Python identifier AuthnMethod
    __AuthnMethod = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AuthnMethod'), 'AuthnMethod', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolAuthnMethod', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}OperationalProtection uses Python identifier OperationalProtection
    __OperationalProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'OperationalProtection'), 'OperationalProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolOperationalProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Identification uses Python identifier Identification
    __Identification = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Identification'), 'Identification', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolIdentification', False)
    ...
    __ID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ID'), 'ID', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnContextDeclarationBaseType_ID', pyxb.binding.datatypes.ID)
...
class ComplexAuthenticatorType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolRestrictedPassword', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}UserSuffix uses Python identifier UserSuffix
    __UserSuffix = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix'), 'UserSuffix', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolUserSuffix', True)

    
    UserSuffix = property(__UserSuffix.value, __UserSuffix.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ZeroKnowledge uses Python identifier ZeroKnowledge
    __ZeroKnowledge = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge'), 'ZeroKnowledge', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolZeroKnowledge', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}IPAddress uses Python identifier IPAddress
    __IPAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), 'IPAddress', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolIPAddress', True)

    
    IPAddress = property(__IPAddress.value, __IPAddress.set, None, u'\n        This element indicates that the Principal has been\n        authenticated through connection from a particular IP address.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}AsymmetricDecryption uses Python identifier AsymmetricDecryption
    __AsymmetricDecryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption'), 'AsymmetricDecryption', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolAsymmetricDecryption', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ResumeSession uses Python identifier ResumeSession
    __ResumeSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession'), 'ResumeSession', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolResumeSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}DigSig uses Python identifier DigSig
    __DigSig = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DigSig'), 'DigSig', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolDigSig', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ComplexAuthenticator uses Python identifier ComplexAuthenticator
    __ComplexAuthenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ComplexAuthenticator'), 'ComplexAuthenticator', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolComplexAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SharedSecretChallengeResponse uses Python identifier SharedSecretChallengeResponse
    __SharedSecretChallengeResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse'), 'SharedSecretChallengeResponse', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolSharedSecretChallengeResponse', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}AsymmetricKeyAgreement uses Python identifier AsymmetricKeyAgreement
    __AsymmetricKeyAgreement = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement'), 'AsymmetricKeyAgreement', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolAsymmetricKeyAgreement', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPassword', True)

    
    Password = property(__Password.value, __Password.set, None, u'\n        This element indicates that a password (or passphrase)\n        has been used to\n        authenticate the Principal to a remote system.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SharedSecretDynamicPlaintext uses Python identifier SharedSecretDynamicPlaintext
    __SharedSecretDynamicPlaintext = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext'), 'SharedSecretDynamicPlaintext', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolSharedSecretDynamicPlaintext', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SubscriberLineNumber uses Python identifier SubscriberLineNumber
    __SubscriberLineNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber'), 'SubscriberLineNumber', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolSubscriberLineNumber', True)

    
    SubscriberLineNumber = property(__SubscriberLineNumber.value, __SubscriberLineNumber.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PreviousSession uses Python identifier PreviousSession
    __PreviousSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession'), 'PreviousSession', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acclassesInternetProtocolPreviousSession', True)
...
class LengthType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_LengthType_min', pyxb.binding.datatypes.integer, required=True)
    
    min = property(__min.value, __min.set, None, None)

    
    # Attribute max uses Python identifier max
    __max = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'max'), 'max', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_LengthType_max', pyxb.binding.datatypes.integer)
...
class GoverningAgreementsType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}GoverningAgreementRef uses Python identifier GoverningAgreementRef
    __GoverningAgreementRef = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreementRef'), 'GoverningAgreementRef', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_GoverningAgreementsType_urnoasisnamestcSAML2_0acclassesInternetProtocolGoverningAgreementRef', True)
...
class TechnicalProtectionBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PrivateKeyProtection uses Python identifier PrivateKeyProtection
    __PrivateKeyProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PrivateKeyProtection'), 'PrivateKeyProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPrivateKeyProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SecretKeyProtection uses Python identifier SecretKeyProtection
    __SecretKeyProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SecretKeyProtection'), 'SecretKeyProtection', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolSecretKeyProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
...
class ActivationLimitDurationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __duration = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'duration'), 'duration', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationLimitDurationType_duration', pyxb.binding.datatypes.duration, required=True)
...
class AlphabetType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __requiredChars = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'requiredChars'), 'requiredChars', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AlphabetType_requiredChars', pyxb.binding.datatypes.string, required=True)
    
    requiredChars = property(__requiredChars.value, __requiredChars.set, None, None)

    
    # Attribute case uses Python identifier case
    __case = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'case'), 'case', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AlphabetType_case', pyxb.binding.datatypes.string)
    
    case = property(__case.value, __case.set, None, None)

    
    # Attribute excludedChars uses Python identifier excludedChars
    __excludedChars = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'excludedChars'), 'excludedChars', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AlphabetType_excludedChars', pyxb.binding.datatypes.string)
...
class GoverningAgreementRefType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __governingAgreementRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'governingAgreementRef'), 'governingAgreementRef', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_GoverningAgreementRefType_governingAgreementRef', pyxb.binding.datatypes.anyURI, required=True)
...
class SharedSecretChallengeResponseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SharedSecretChallengeResponseType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
    ...
    __method = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SharedSecretChallengeResponseType_method', pyxb.binding.datatypes.anyURI)
...
class SecretKeyProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SecretKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}KeyActivation uses Python identifier KeyActivation
    __KeyActivation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyActivation'), 'KeyActivation', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SecretKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolKeyActivation', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}KeyStorage uses Python identifier KeyStorage
    __KeyStorage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyStorage'), 'KeyStorage', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SecretKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolKeyStorage', False)
...
class OperationalProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_OperationalProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}DeactivationCallCenter uses Python identifier DeactivationCallCenter
    __DeactivationCallCenter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DeactivationCallCenter'), 'DeactivationCallCenter', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_OperationalProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolDeactivationCallCenter', False)

    
    DeactivationCallCenter = property(__DeactivationCallCenter.value, __DeactivationCallCenter.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SecurityAudit uses Python identifier SecurityAudit
    __SecurityAudit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SecurityAudit'), 'SecurityAudit', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_OperationalProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolSecurityAudit', False)
...
class ActivationPinType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Length uses Python identifier Length
    __Length = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Length'), 'Length', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolLength', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}ActivationLimit uses Python identifier ActivationLimit
    __ActivationLimit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimit'), 'ActivationLimit', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolActivationLimit', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Generation uses Python identifier Generation
    __Generation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Generation'), 'Generation', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolGeneration', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Alphabet uses Python identifier Alphabet
    __Alphabet = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Alphabet'), 'Alphabet', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_ActivationPinType_urnoasisnamestcSAML2_0acclassesInternetProtocolAlphabet', False)
...
class SecurityAuditType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}SwitchAudit uses Python identifier SwitchAudit
    __SwitchAudit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SwitchAudit'), 'SwitchAudit', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SecurityAuditType_urnoasisnamestcSAML2_0acclassesInternetProtocolSwitchAudit', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_SecurityAuditType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)
...
class AuthenticatorBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}IPAddress uses Python identifier IPAddress
    __IPAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), 'IPAddress', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthenticatorBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolIPAddress', False)
...
class AuthnMethodBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PrincipalAuthenticationMechanism uses Python identifier PrincipalAuthenticationMechanism
    __PrincipalAuthenticationMechanism = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PrincipalAuthenticationMechanism'), 'PrincipalAuthenticationMechanism', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolPrincipalAuthenticationMechanism', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Authenticator uses Python identifier Authenticator
    __Authenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Authenticator'), 'Authenticator', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}AuthenticatorTransportProtocol uses Python identifier AuthenticatorTransportProtocol
    __AuthenticatorTransportProtocol = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AuthenticatorTransportProtocol'), 'AuthenticatorTransportProtocol', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_AuthnMethodBaseType_urnoasisnamestcSAML2_0acclassesInternetProtocolAuthenticatorTransportProtocol', False)
...
class KeyStorageType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __medium = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'medium'), 'medium', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_KeyStorageType_medium', mediumType, required=True)
...
class KeySharingType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __sharing = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sharing'), 'sharing', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_KeySharingType_sharing', pyxb.binding.datatypes.boolean, required=True)
...
class IdentificationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}GoverningAgreements uses Python identifier GoverningAgreements
    __GoverningAgreements = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreements'), 'GoverningAgreements', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolGoverningAgreements', False)

    
    GoverningAgreements = property(__GoverningAgreements.value, __GoverningAgreements.set, None, u'\n        Provides a mechanism for linking to external (likely\n        human readable) documents in which additional business agreements,\n        (e.g. liability constraints, obligations, etc) can be placed.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}PhysicalVerification uses Python identifier PhysicalVerification
    __PhysicalVerification = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PhysicalVerification'), 'PhysicalVerification', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolPhysicalVerification', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}WrittenConsent uses Python identifier WrittenConsent
    __WrittenConsent = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'WrittenConsent'), 'WrittenConsent', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_IdentificationType_urnoasisnamestcSAML2_0acclassesInternetProtocolWrittenConsent', False)
    ...
    __nym = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'nym'), 'nym', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_IdentificationType_nym', nymType)
...
class PrivateKeyProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}KeyActivation uses Python identifier KeyActivation
    __KeyActivation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyActivation'), 'KeyActivation', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolKeyActivation', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}KeySharing uses Python identifier KeySharing
    __KeySharing = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeySharing'), 'KeySharing', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolKeySharing', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol}KeyStorage uses Python identifier KeyStorage
    __KeyStorage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyStorage'), 'KeyStorage', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acclassesInternetProtocolKeyStorage', False)
...
class RestrictedLengthType (LengthType):
    ...
    # Attribute min uses Python identifier min
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0acclassesInternetProtocol_LengthType_min', STD_ANON_2, required=True)
...
ExtensionType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'urn:oasis:names:tc:SAML:2.0:ac:classes:InternetProtocol')), min_occurs=1, max_occurs=None)
    )
