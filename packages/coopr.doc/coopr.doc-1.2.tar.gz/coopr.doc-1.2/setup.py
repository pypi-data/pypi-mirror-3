...
"""
Script to generate the installer for coopr.doc.
"""
...
setup(name='coopr.doc',
      version='1.2',
      maintainer='William E. Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.doc',
      license = 'BSD',
      platforms = ["any"],
      description = "Coopr's online books and documentation",
