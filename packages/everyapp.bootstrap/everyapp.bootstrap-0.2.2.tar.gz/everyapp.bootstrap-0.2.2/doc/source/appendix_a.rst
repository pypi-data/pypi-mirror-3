...
.. index::
   single: full licence text
   single: GNU General Public Licence
   single: GPL
   single: licence; full text
   single: licence; GPL
.. _full-licence:
...
Below is the full text of the copyright licence for this project, it's source
code and it's documentation.
