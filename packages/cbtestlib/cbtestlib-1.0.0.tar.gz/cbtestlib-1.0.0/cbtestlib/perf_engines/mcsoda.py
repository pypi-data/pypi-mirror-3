...
from cbtestlib import crc32
from cbtestlib import mc_bin_client

from cbtestlib.membase.api.exception import QueryViewException

from cbtestlib.memcacheConstants import REQ_MAGIC_BYTE, RES_MAGIC_BYTE
from cbtestlib.memcacheConstants import ERR_NOT_MY_VBUCKET, ERR_ENOMEM, ERR_EBUSY, ERR_ETMPFAIL
from cbtestlib.memcacheConstants import REQ_PKT_FMT, RES_PKT_FMT, MIN_RECV_PACKET
from cbtestlib.memcacheConstants import SET_PKT_FMT, CMD_GET, CMD_SET, CMD_DELETE
from cbtestlib.memcacheConstants import CMD_ADD, CMD_REPLACE, CMD_PREPEND, CMD_APPEND # "ARPA"
