...
def storedata(fulldata, moviename, moviepath, databasepath = common.databasepath):
	"""
	...
	moviepath	-- The path of the movie file.
	databasepath	-- The location of the database. Default = home directory.
...
def main(args):
	...
	Create a directory called /home/dante/Documents/The Shawshank Redemption data
	Create an Sqlite database in /home/dante/Documents/
	Create a logging file in /home/dante/Documents/

	Retrieve data about the movie.
	Process the data.
	Store the data thus:
	/home/dante/Documents/The Shawshank Redemption data/metadata/The Shawshank Redemption data.json
	Format the movie data and write it to the text file
	/home/dante/Documents/The Shawshank Redemption data/The Shawshank Redemption info.txt
	Enter the data of the movie into the previously created Sqlite database.

	Since --posters is an argument, the IMDB and RT posters of the movie will 
	be downloaded. The RT posters of movies similar to this one will
	downloaded as well.
	
	Since -t is an argument, the trailer of the movie will be downloaded.
...
version=common.version)
	...
	storedata(fulldata, moviename, outpath, databasepath=databasepath)
