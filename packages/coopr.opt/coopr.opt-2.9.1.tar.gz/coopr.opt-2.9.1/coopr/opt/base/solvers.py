...
class OptSolver(Plugin):
    ...
    def __init__(self, **kwds):
        ...
        # when communicating with a solver, use symbolic (model-oriented) names - such as
        # "my_favorite_variable[1,2,3]", instead of "v1". useful for debugging.
        self.generateSymbolicLabels = True
    ...
    def _presolve(self, *args, **kwds):
        ...
        for key in kwds:
            ...
            elif key == "generateSymbolicLabels":
                self.generateSymbolicLabels = bool(kwds[key])
            elif key == "suffixes":
                val = kwds[key]
        ...
        #print "format", self._problem_format
        #print "valid", self._valid_problem_formats
        ...
        #print "HERE", self._problem_files
        #print "HERE", self._problem_format
        #print "HERE", self._symbol_map
    ...
    def _convert_problem(self, args, problem_format, valid_problem_formats):
        ...
        return convert_problem(args, 
                               ...
                               self.has_capability,
                               generateSymbolicLabels=self.generateSymbolicLabels)
