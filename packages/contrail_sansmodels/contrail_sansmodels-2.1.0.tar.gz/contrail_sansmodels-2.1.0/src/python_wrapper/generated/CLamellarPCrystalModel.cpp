 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/lamellarPC.h
...
static PyObject * CLamellarPCrystalModelError = NULL;
...
static void
CLamellarPCrystalModel_dealloc(CLamellarPCrystalModel* self)
{
...
static PyObject *
CLamellarPCrystalModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CLamellarPCrystalModel *self;
    
    self = (CLamellarPCrystalModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CLamellarPCrystalModel_init(CLamellarPCrystalModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new LamellarPCrystalModel();
        
        // Initialize parameter dictionary
        PyDict_SetItemString(self->params,"Nlayers",Py_BuildValue("d",20.000000000000));
        PyDict_SetItemString(self->params,"spacing",Py_BuildValue("d",250.000000000000));
        PyDict_SetItemString(self->params,"sld_solvent",Py_BuildValue("d",0.000006340000));
        PyDict_SetItemString(self->params,"thickness",Py_BuildValue("d",33.000000000000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"pd_spacing",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"background",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"sld_layer",Py_BuildValue("d",0.000001000000));
...
static PyMemberDef CLamellarPCrystalModel_members[] = {
    {name_params, T_OBJECT, offsetof(CLamellarPCrystalModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLamellarPCrystalModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLamellarPCrystalModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CLamellarPCrystalModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(LamellarPCrystalModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( LamellarPCrystalModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CLamellarPCrystalModelError, 
                   "CLamellarPCrystalModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CLamellarPCrystalModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->pd_spacing = PyFloat_AsDouble( PyDict_GetItemString(self->params, "pd_spacing") );
    self->model->background = PyFloat_AsDouble( PyDict_GetItemString(self->params, "background") );
    self->model->sld_layer = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_layer") );
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLamellarPCrystalModelError, 
	    	"CLamellarPCrystalModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CLamellarPCrystalModelError, 
                   "CLamellarPCrystalModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CLamellarPCrystalModelError, 
	    		"CLamellarPCrystalModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CLamellarPCrystalModelError, 
                   "CLamellarPCrystalModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CLamellarPCrystalModelError, 
                   "CLamellarPCrystalModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CLamellarPCrystalModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLamellarPCrystalModelError, 
	    	"CLamellarPCrystalModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CLamellarPCrystalModelError, 
	    		"CLamellarPCrystalModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CLamellarPCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CLamellarPCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CLamellarPCrystalModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CLamellarPCrystalModel *self) {
 ...
 */
static PyObject * calculate_VR(CLamellarPCrystalModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CLamellarPCrystalModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CLamellarPCrystalModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CLamellarPCrystalModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CLamellarPCrystalModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CLamellarPCrystalModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CLamellarPCrystalModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CLamellarPCrystalModelError,
	    	"CLamellarPCrystalModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "thickness")) {
	    ...
	    PyErr_SetString(CLamellarPCrystalModelError,
	    	"CLamellarPCrystalModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CLamellarPCrystalModel_methods[] = {
...
static PyTypeObject CLamellarPCrystalModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CLamellarPCrystalModel",             /*tp_name*/
    sizeof(CLamellarPCrystalModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CLamellarPCrystalModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CLamellarPCrystalModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CLamellarPCrystalModel_methods,             /* tp_methods */
    CLamellarPCrystalModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CLamellarPCrystalModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CLamellarPCrystalModel_new,                 /* tp_new */
};
...
void addCLamellarPCrystalModel(PyObject *module) {
    ...
    if (PyType_Ready(&CLamellarPCrystalModelType) < 0)
        return;

    Py_INCREF(&CLamellarPCrystalModelType);
