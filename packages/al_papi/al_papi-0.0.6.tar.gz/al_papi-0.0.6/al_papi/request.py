...
class Request(object):
  ...
  def post(params = {}, priority = False):
    path = "/keywords/priority.json" if priority == True else "/keywords.json"
    return al_papi.AlHttp.post(params, priority, "/keywords.json")

  @staticmethod
  def priority_post(params = {}, priority = False):
    return al_papi.AlHttp.priority_post(params, "/keywords/priority.json")

  @staticmethod
  def get(params = {}):
    return al_papi.AlHttp.get(params, "/keywords/get.json")
