...
"""
Script to generate the installer for coopr.data.pyomo.
"""
...
setup(name='coopr.data.pyomo',
      version='1.2.1',
      maintainer='William E. Hart',
      maintainer_email='wehart@sandia.gov',
      url = 'https://software.sandia.gov/svn/public/coopr/coopr.data.pyomo',
      license = 'BSD',
      platforms = ["any"],
      description = 'Coopr data project:  Pyomo test models',
