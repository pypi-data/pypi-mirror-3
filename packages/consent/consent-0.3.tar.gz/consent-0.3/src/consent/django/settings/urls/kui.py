...
urlpatterns = patterns('consent.django.apps.kui.views',
    ...
    (r'^sites/(?P<siteId>(\d+))/assemblies/create/(?P<returnPath>(.*))$', 'assembly.create'),
    ...
    (r'^sites/(?P<siteId>(\d+))/proposals/create/(?P<returnPath>(.*))$', 'proposal.create'),
    ...
    (r'^sites/(?P<siteId>(\d+))/assemblies/(?P<assemblyId>(\d+))/consensuses/create/(?P<returnPath>(.*))$', 'consensus.create'),
