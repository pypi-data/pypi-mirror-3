...
class CParser(PLYParser):    
    ...
    def p_asm_1(self, p):
        """ asm : __ASM__ LPAREN argument_expression_list RPAREN
        """
        p[0] = c_ast.Asm(p[3], None, None, None, coord=self._coord(p.lineno(1)))

    def p_asm_2(self, p):
        """ asm : __ASM__ LPAREN argument_expression_list COLON argument_expression_list RPAREN
        """
        p[0] = c_ast.Asm(p[3], p[5], None, None, coord=self._coord(p.lineno(1)))

    def p_asm_3(self, p):
        """ asm : __ASM__ LPAREN argument_expression_list COLON argument_expression_list COLON argument_expression_list RPAREN
        """
        p[0] = c_ast.Asm(p[3], p[5], p[7], None, coord=self._coord(p.lineno(1)))

    def p_asm_4(self, p):
        """ asm : __ASM__ LPAREN argument_expression_list COLON argument_expression_list COLON argument_expression_list COLON argument_expression_list RPAREN
        """
        p[0] = c_ast.Asm(p[3], p[5], p[7], p[9], coord=self._coord(p.lineno(1)))
