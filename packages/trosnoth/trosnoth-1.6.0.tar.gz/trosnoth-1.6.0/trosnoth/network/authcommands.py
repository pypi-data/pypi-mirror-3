...
class GetRegisteredIdentities(amp.Command):
    '''
    Requests a list of email addresses which are associated with this user on
    the server.
    '''
    arguments = []
    response = [('identities', amp.ListOf(amp.Unicode()))]
    errors = {
        NotAuthenticated: 'NO_AUTH',
    }

class SetRegisteredIdentities(amp.Command):
    '''
    Sets the list of email addresses which are associated with this user on the
    server.
    '''
    arguments = [('identities', amp.ListOf(amp.Unicode()))]
    response = []
    errors = {
        NotAuthenticated: 'NO_AUTH',
    }
...
class GetSupportedSettings(amp.Command):
    ...
    Possible values are 'password', 'identities'
    '''
    arguments = []
    response = [
