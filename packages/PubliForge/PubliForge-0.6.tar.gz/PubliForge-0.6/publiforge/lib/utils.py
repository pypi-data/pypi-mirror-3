# $Id: utils.py 34ecf5b4306a 2012/05/18 18:00:08 patrick $
# -*- coding: utf-8 -*-
...
MIME_TYPES = ('css', 'csv', 'epub+zip', 'folder', 'font-woff', 'html', 'jpeg',
    'mpeg', 'msword', 'ogg', 'pdf', 'plain', 'png', 'postscript', 'relaxng',
...
# =============================================================================
def export_file_set(root_elt, record, file_type, with_comment=True):
