...
def bind():
    ...
    _re_amp = _loads("cre\n_compile\np1\n(S'&(?!([A-Za-z]+|#[0-9]+);)'\np2\nI0\ntRp3\n.")
    _attrs_142086480 = _loads('(dp1\n.')
    _attrs_189834704 = _loads('(dp1\n.')
    _attrs_174852816 = _loads('(dp1\nVhref\np2\nV${view/previous_url}\np3\nsVclass\np4\nVbutton-medium floatBefore back\np5\ns.')
    _init_stream = _loads('cchameleon.core.generation\ninitialize_stream\np1\n.')
    _attrs_174853328 = _loads('(dp1\nVid\np2\nVstep-5\np3\ns.')
    _attrs_174850768 = _loads('(dp1\nVclass\np2\nVcomplete\np3\nsVid\np4\nVstep-1\np5\ns.')
    _attrs_174865040 = _loads('(dp1\nVhref\np2\nV${webhelpers/country_url}/account-settings\np3\ns.')
    _attrs_189833616 = _loads('(dp1\n.')
    _attrs_174851472 = _loads('(dp1\n.')
    _attrs_174852496 = _loads('(dp1\nVhref\np2\nV${survey_url}/identification\np3\ns.')
    _attrs_174852304 = _loads('(dp1\nVclass\np2\nVactive current\np3\nsVid\np4\nVstep-3\np5\ns.')
    _attrs_174851344 = _loads('(dp1\n.')
    _attrs_174862864 = _loads('(dp1\nVhref\np2\nV${webhelpers/survey_url}/status\np3\ns.')
    _attrs_189834512 = _loads('(dp1\n.')
    _attrs_174853776 = _loads('(dp1\nVid\np2\nVnavigation\np3\ns.')
    _attrs_189834128 = _loads('(dp1\n.')
    _attrs_174853200 = _loads('(dp1\nVclass\np2\nVgallery\np3\ns.')
    _attrs_189834192 = _loads('(dp1\n.')
    _attrs_189909264 = _loads('(dp1\nVhref\np2\nV${survey_url}/report\np3\ns.')
    _attrs_189836688 = _loads('(dp1\nVhref\np2\nV${webhelpers/help_url}#evaluation\np3\ns.')
    _attrs_189908432 = _loads('(dp1\nVhref\np2\nV${survey_url}/actionplan\np3\ns.')
    _init_default = _loads('cchameleon.core.generation\ninitialize_default\np1\n.')
    _attrs_174853968 = _loads('(dp1\nVid\np2\nVsteps\np3\ns.')
    _init_tal = _loads('cchameleon.core.generation\ninitialize_tal\np1\n.')
    _marker = _loads("ccopy_reg\n_reconstructor\np1\n(cchameleon.core.i18n\nStringMarker\np2\nc__builtin__\nstr\np3\nS''\ntRp4\n.")
    _attrs_189833296 = _loads('(dp1\nVhref\np2\nV${webhelpers/country_url}/logout\np3\ns.')
    _attrs_174854096 = _loads('(dp1\nVsrc\np2\nV${thumb/url}\np3\nsVheight\np4\nV${thumb/height}\np5\nsVwidth\np6\nV${thumb/width}\np7\nsValt\np8\nV\nsVclass\np9\nVfloatBefore\np10\ns.')
    _attrs_174850896 = _loads('(dp1\nVhref\np2\nV${survey_url}/evaluation\np3\ns.')
    _attrs_174851728 = _loads('(dp1\nVclass\np2\nVcomplete\np3\nsVid\np4\nVstep-2\np5\ns.')
    _attrs_174851600 = _loads('(dp1\nVid\np2\nVstep-4\np3\ns.')
    _attrs_174853264 = _loads('(dp1\nVhref\np2\nV${survey_url}/start\np3\ns.')
    _attrs_189837072 = _loads('(dp1\nVhref\np2\nV${webhelpers/session_overview_url}\np3\ns.')
    _attrs_142088528 = _loads('(dp1\nVclass\np2\nVevaluation ${webhelpers/extra_css}\np3\ns.')
    _init_scope = _loads('cchameleon.core.utils\necontext\np1\n.')
    _attrs_142088464 = _loads('(dp1\nVxmlns\np2\nVhttp://www.w3.org/1999/xhtml\np3\ns.')
    _attrs_142088400 = _loads('(dp1\n.')
    _lookup_tile = _loads('cplonetheme.nuplone.tiles.tales\n_lookup_tile\np1\n.')
    _attrs_174853648 = _loads('(dp1\nVhref\np2\nV${large/url|nothing}\np3\nsVrel\np4\nVfancybox\np5\nsVtitle\np6\nV${module/caption|nothing}\np7\ns.')
    _attrs_174850960 = _loads('(dp1\nVclass\np2\nVbuttonBar\np3\ns.')
    _attrs_174850832 = _loads('(dp1\nVhref\np2\nV${view/next_url}\np3\nsVclass\np4\nVbutton-medium floatAfter\np5\ns.')
    ...
    def render(econtext, rcontext=None):
        ...
        attrs = _attrs_142088464
        _write(u'<html xmlns="http://www.w3.org/1999/xhtml">\n  ')
        attrs = _attrs_142088400
        _write(u'<head>\n    ')
        attrs = _attrs_142086480
        ...
        attrs = _attrs_142088528
        'join(u\'evaluation \', value("_path(webhelpers, request, True, \'extra_css\')"))'
        _write(u'<body')
        _tmp1 = ('%s%s' % ('evaluation ', _path(webhelpers, econtext['request'], True, 'extra_css'), ))
        if (_tmp1 is _default):
            _tmp1 = u'evaluation ${webhelpers/extra_css}'
        ...
        if (_tmp is not None):
            ...
            _write(_tmp)
        _write(u'</p>\n    ')
        attrs = _attrs_174850960
        _write(u'<p class="buttonBar">\n      ')
        attrs = _attrs_174852816
        ...
        attrs = _attrs_174853968
        _write(u'<ol id="steps">\n      ')
        attrs = _attrs_174850768
        _write(u'<li class="complete" id="step-1">\n        ')
        attrs = _attrs_174853264
        ...
        if _tmp1:
            ...
            if _tmp1:
                ...
                _write(u'Preparation')
        _write(u'\n        </a>\n      </li>\n      ')
        attrs = _attrs_174851728
        _write(u'<li class="complete" id="step-2">\n        ')
        attrs = _attrs_174852496
        ...
        if _tmp1:
            ...
            if _tmp1:
                ...
                _write(u'Identification')
        _write(u'\n        </a>\n      </li>\n      ')
        attrs = _attrs_174852304
        _write(u'<li class="active current" id="step-3">\n        ')
        attrs = _attrs_174850896
        ...
        _write(u'\n      ')
        _write(u'</li>\n      ')
        attrs = _attrs_174851600
        _write(u'<li id="step-4">\n        ')
        attrs = _attrs_189908432
        ...
        if _tmp1:
            ...
            if _tmp1:
                ...
                _write(u'Action Plan')
        _write(u'\n        </a>\n      </li>\n      ')
        attrs = _attrs_174853328
        _write(u'<li id="step-5">\n        ')
        attrs = _attrs_189909264
        ...
        _write(u'\n      ')
        attrs = _attrs_189834512
        _write(u'<li>')
        attrs = _attrs_189833296
        ...
        if _tmp1:
            ...
            _write(u'Logout')
        _write(u'</a></li>\n      ')
        attrs = _attrs_189834128
        _write(u'<li>')
        attrs = _attrs_189837072
        ...
        if _tmp1:
            ...
            _write(u'Sessions')
        _write(u'</a></li>\n      ')
        attrs = _attrs_189834192
        _write(u'<li>')
        attrs = _attrs_189836688
        'join(value("_path(webhelpers, request, True, \'help_url\')"), u\'#evaluation\')'
        _write(u'<a')
        _tmp1 = ('%s%s' % (_path(webhelpers, econtext['request'], True, 'help_url'), '#evaluation', ))
        if (_tmp1 is _default):
            _tmp1 = u'${webhelpers/help_url}#evaluation'
        if ((_tmp1 is not None) and (_tmp1 is not False)):
            if (_tmp1.__class__ not in (str, unicode, int, float, )):
                _tmp1 = unicode(_translate(_tmp1, domain=_domain, mapping=None, target_language=target_language, default=None))
            else:
        ...
        if _tmp1:
            ...
            _write(u'Help')
        _write(u'</a></li>\n      ')
        attrs = _attrs_189834704
        _write(u'<li>')
        attrs = _attrs_174862864
        ...
        if _tmp1:
            ...
            _write(u'Status')
        _write(u'</a></li>\n      ')
        attrs = _attrs_189833616
        _write(u'<li>')
        attrs = _attrs_174865040
...
__filename__ = '/home/jc/dev/oira/src/osha.oira/src/osha/oira/templates/module_evaluation.pt'
