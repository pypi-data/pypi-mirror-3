...
# unused libusb1 functions, and why:

# libusb_get_active_config_descriptor   : superseeded by getConfiguration + 

# libusb_handle_events_timeout_completed: might be added
# libusb_handle_events_completed        : likewise

# libusb_has_capability                 : no obvious use so far
# libusb_error_name                     : likewise
# libusb_get_config_descriptor_by_value : likewise
# libusb_control_transfer_get_setup     : likewise
# libusb_set_iso_packet_lengths         : likewise
# libusb_strerror                       : likewise (and might become
#                                         unavailable upstream anyway)

# libusb_ref_device                     : no use
# libusb_get_device                     : likewise

# libusb_open_device_with_vid_pid       : superseeded by python implementation
#                                         (required for proper refcounting)

# libusb_get_iso_packet_buffer          : superseeded by
#                                         get_iso_packet_buffer_list
# libusb_get_iso_packet_buffer_simple   : likewise
