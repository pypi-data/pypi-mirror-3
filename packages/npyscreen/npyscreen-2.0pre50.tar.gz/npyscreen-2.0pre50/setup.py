...
<A HREF=http://code.google.com/p/npyscreen>http://code.google.com/p/npyscreen</A>.

This version enables basic mouse support.  Note that the Apple terminal does not handle mouse events correctly.
"""
)
