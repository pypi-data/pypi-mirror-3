...
def setup_product():
    ...
    import xhostplus.intropage
    zcml.load_config('configure.zcml', xhostplus.intropage)
    ...
    ztc.installPackage('xhostplus.intropage')
...
setup_product()
ptc.setupPloneSite(products=['xhostplus.intropage'])
