...
class SolgemaEnvironmentActionsSubMenuItem(BrowserSubMenuItem):
    ...
    title = _sbd(u'label_solgemaenvironmentactions_menu', default=u'Environment')
    description = _sbd(u'title_solgemaenvironmentactions_menu', default=u'Solgema Environment Actions for the current content item')
