...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.private_key'
        db.add_column('schedule_meeting', 'private_key', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.private_key'
        db.delete_column('schedule_meeting', 'private_key')
    ...
    models = {
        ...
        'schedule.meeting': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('summit.schedule.fields.NameField', [], {'max_length': '100', 'blank': 'True'}),
