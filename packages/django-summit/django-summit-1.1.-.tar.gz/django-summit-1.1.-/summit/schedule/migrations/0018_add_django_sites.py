...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sites on 'Summit'
        db.create_table('schedule_summit_sites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('summit', models.ForeignKey(orm['schedule.summit'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('schedule_summit_sites', ['summit_id', 'site_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sites on 'Summit'
        db.delete_table('schedule_summit_sites')
