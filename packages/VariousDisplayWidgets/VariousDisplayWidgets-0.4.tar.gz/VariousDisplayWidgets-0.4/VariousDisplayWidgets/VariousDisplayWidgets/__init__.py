...
from VariousDisplayWidgets.VariousDisplayWidgets import config
...
VariousDisplayWidgetsMessageFactory = MessageFactory('VariousDisplayWidgets.VariousDisplayWidgets')
