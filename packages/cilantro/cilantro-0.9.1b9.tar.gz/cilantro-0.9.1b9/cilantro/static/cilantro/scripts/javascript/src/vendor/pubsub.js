...
define(function() {
  ...
  PubSub = (function() {
    ...
    PubSub.prototype.subscribe = function(topic, handler, context, migrate) {
      ...
      if (migrate) this._migrate(publisher, subscriber, migrate);
      return subscriber;
    };
    ...
    PubSub.prototype.unsubscribe = function(subscriber, complete) {
      ...
      if (!subscriber instanceof Subscriber) {
        if (!(subscriber = this.subscribers[subscriber])) return;
      }
      if (complete) {
