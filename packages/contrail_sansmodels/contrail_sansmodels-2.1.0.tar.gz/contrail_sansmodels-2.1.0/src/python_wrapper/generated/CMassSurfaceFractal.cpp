 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/masssurfacefractal.h
...
static PyObject * CMassSurfaceFractalError = NULL;
...
static void
CMassSurfaceFractal_dealloc(CMassSurfaceFractal* self)
{
...
static PyObject *
CMassSurfaceFractal_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CMassSurfaceFractal *self;
    
    self = (CMassSurfaceFractal *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CMassSurfaceFractal_init(CMassSurfaceFractal *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new MassSurfaceFractal();
        
        // Initialize parameter dictionary
        PyDict_SetItemString(self->params,"cluster_rg",Py_BuildValue("d",86.700000000000));
        PyDict_SetItemString(self->params,"scale",Py_BuildValue("d",1.000000000000));
        PyDict_SetItemString(self->params,"mass_dim",Py_BuildValue("d",1.800000000000));
        PyDict_SetItemString(self->params,"surface_dim",Py_BuildValue("d",2.300000000000));
        PyDict_SetItemString(self->params,"background",Py_BuildValue("d",0.000000000000));
        PyDict_SetItemString(self->params,"primary_rg",Py_BuildValue("d",4000.000000000000));
...
static PyMemberDef CMassSurfaceFractal_members[] = {
    {name_params, T_OBJECT, offsetof(CMassSurfaceFractal, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CMassSurfaceFractal, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CMassSurfaceFractal, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CMassSurfaceFractal_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(MassSurfaceFractal* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( MassSurfaceFractal* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CMassSurfaceFractalError, 
                   "CMassSurfaceFractal.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CMassSurfaceFractal *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->cluster_rg = PyFloat_AsDouble( PyDict_GetItemString(self->params, "cluster_rg") );
    self->model->scale = PyFloat_AsDouble( PyDict_GetItemString(self->params, "scale") );
    self->model->mass_dim = PyFloat_AsDouble( PyDict_GetItemString(self->params, "mass_dim") );
    self->model->surface_dim = PyFloat_AsDouble( PyDict_GetItemString(self->params, "surface_dim") );
    self->model->background = PyFloat_AsDouble( PyDict_GetItemString(self->params, "background") );
    self->model->primary_rg = PyFloat_AsDouble( PyDict_GetItemString(self->params, "primary_rg") );

	
	// Get input and determine whether we have to supply a 1D or 2D return value.
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CMassSurfaceFractalError, 
	    	"CMassSurfaceFractal.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CMassSurfaceFractalError, 
                   "CMassSurfaceFractal.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CMassSurfaceFractalError, 
	    		"CMassSurfaceFractal.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CMassSurfaceFractalError, 
                   "CMassSurfaceFractal.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CMassSurfaceFractalError, 
                   "CMassSurfaceFractal.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CMassSurfaceFractal *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CMassSurfaceFractalError, 
	    	"CMassSurfaceFractal.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CMassSurfaceFractalError, 
	    		"CMassSurfaceFractal.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CMassSurfaceFractal_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CMassSurfaceFractal_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CMassSurfaceFractal_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CMassSurfaceFractal *self) {
 ...
 */
static PyObject * calculate_VR(CMassSurfaceFractal *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CMassSurfaceFractal *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CMassSurfaceFractal_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CMassSurfaceFractal_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CMassSurfaceFractal_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CMassSurfaceFractal *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CMassSurfaceFractal *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CMassSurfaceFractalError,
	    	"CMassSurfaceFractal.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
 ...
 {
	    PyErr_SetString(CMassSurfaceFractalError,
	    	"CMassSurfaceFractal.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CMassSurfaceFractal_methods[] = {
...
static PyTypeObject CMassSurfaceFractalType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CMassSurfaceFractal",             /*tp_name*/
    sizeof(CMassSurfaceFractal),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CMassSurfaceFractal_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CMassSurfaceFractal objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CMassSurfaceFractal_methods,             /* tp_methods */
    CMassSurfaceFractal_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CMassSurfaceFractal_init,      /* tp_init */
    0,                         /* tp_alloc */
    CMassSurfaceFractal_new,                 /* tp_new */
};
...
void addCMassSurfaceFractal(PyObject *module) {
    ...
    if (PyType_Ready(&CMassSurfaceFractalType) < 0)
        return;

    Py_INCREF(&CMassSurfaceFractalType);
    PyModule_AddObject(module, "CMassSurfaceFractal", (PyObject *)&CMassSurfaceFractalType);
    
    d = PyModule_GetDict(module);
    static char error_name[] = "CMassSurfaceFractal.error";
    CMassSurfaceFractalError = PyErr_NewException(error_name, NULL, NULL);
    PyDict_SetItemString(d, "CMassSurfaceFractalError", CMassSurfaceFractalError);
}
