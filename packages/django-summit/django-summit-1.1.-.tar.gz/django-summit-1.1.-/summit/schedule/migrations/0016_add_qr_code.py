...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Summit.qr'
        db.add_column('schedule_summit', 'qr', self.gf('django.db.models.fields.URLField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Summit.qr'
        db.delete_column('schedule_summit', 'qr')
