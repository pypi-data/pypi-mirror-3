...
class Newer(object):
    ...
    :param source_iter: A set of source files
    :type  source_iter: container
    :param target_iter: A set of target files
    :type  target_iter: container
    :return: True if the newest file in source_iter is younger than the
             oldest file in target_iter
    :rtype:  boolean
    ...
    def best(file_iterator, newer=True):
        ...
        :param newer: Default: True. Determines if the selector is for the
