...
import panacea
from panacea.statements import process_mutators, MUTATORS
from panacea import options
from panacea.properties import Property
...
class EntityDescriptor(object):
    ...
    def __init__(self, entity):
        ...
        complete_defaults.update({
            'metadata': panacea.metadata,
            'session': panacea.session,
            'collection': panacea.entities
        })
    ...
    def setup_options(self):
        ...
        '''
        panacea.metadatas.add(self.metadata)
...
#                    if ret != EXT_CONTINUE:
        ...
        for name, method in all_methods:
            for event in getattr(method, '_panacea_events', []):
...
# See also http://panacea.ematia.de/trac/changeset/262
