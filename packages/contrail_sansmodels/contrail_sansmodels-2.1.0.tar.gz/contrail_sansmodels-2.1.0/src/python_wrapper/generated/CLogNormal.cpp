 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/logNormal.h
...
static PyObject * CLogNormalError = NULL;
...
static void
CLogNormal_dealloc(CLogNormal* self)
{
...
static PyObject *
CLogNormal_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CLogNormal *self;
    
    self = (CLogNormal *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CLogNormal_init(CLogNormal *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
...
static PyMemberDef CLogNormal_members[] = {
    {name_params, T_OBJECT, offsetof(CLogNormal, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CLogNormal, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CLogNormal, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CLogNormal_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(LogNormal* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( LogNormal* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CLogNormalError, 
                   "CLogNormal.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CLogNormal *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLogNormalError, 
	    	"CLogNormal.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CLogNormalError, 
                   "CLogNormal.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CLogNormalError, 
	    		"CLogNormal.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CLogNormalError, 
                   "CLogNormal.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CLogNormalError, 
 ...
 */
static PyObject * run(CLogNormal *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CLogNormalError, 
	    	"CLogNormal.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CLogNormalError, 
	    		"CLogNormal.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CLogNormal_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CLogNormal_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CLogNormal_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CLogNormal *self) {
 ...
 */
static PyObject * calculate_VR(CLogNormal *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CLogNormal *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CLogNormal_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CLogNormal_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CLogNormal_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CLogNormal *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CLogNormal *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CLogNormalError,
	    	"CLogNormal.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
 ...
 {
	    PyErr_SetString(CLogNormalError,
	    	"CLogNormal.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CLogNormal_methods[] = {
...
static PyTypeObject CLogNormalType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CLogNormal",             /*tp_name*/
    sizeof(CLogNormal),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CLogNormal_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CLogNormal_methods,             /* tp_methods */
    CLogNormal_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CLogNormal_init,      /* tp_init */
    0,                         /* tp_alloc */
    CLogNormal_new,                 /* tp_new */
};
...
void addCLogNormal(PyObject *module) {
    ...
    if (PyType_Ready(&CLogNormalType) < 0)
        return;

    Py_INCREF(&CLogNormalType);
