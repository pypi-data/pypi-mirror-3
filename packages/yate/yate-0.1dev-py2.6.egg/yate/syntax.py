...
config = {
  'php' : {
    ...
    'file_patterns' : ['*.php'],
    'style_bits' : 7,
    'keywords'   : "class function public protected private require_once dirname error_reporting ini_set include echo true false __FILE__ __DIR__ __CLASS__ chdir die",
    'keyword_index' : 4,
    'styles'   : {
