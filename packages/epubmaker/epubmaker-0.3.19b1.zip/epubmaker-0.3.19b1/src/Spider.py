        ...
        while self.queue:
            ...
            for (url, attr) in parser.iterlinks ():
                ...
                if tag == NS.xhtml.a:
                    ...
                    continue
                if tag == NS.xhtml.img:
                    # The coverpage is an image with either 
                    #  - an id of 'coverpage' or
                    #  - an url containing 'cover' or 'title'
                    if ('cover' in url or 'title' in url or attribs.get ('id', '') == 'coverpage'):
                        attribs['rel'] = 'coverpage'
