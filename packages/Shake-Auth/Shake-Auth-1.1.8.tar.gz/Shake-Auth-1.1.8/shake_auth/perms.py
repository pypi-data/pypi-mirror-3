...
2.  If the corresponding view function is decorated with
    `ext.perms.protected` the CSFR token will be automatically
...
def protected(perm=None, group=None, test=None, sign_in_url=None, csrf=None):
    ...
    test
    :   A function that takes the request and has to returns True or False.
