...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'APIMethod.display_url'
        db.add_column('api_docs_apimethod', 'display_url', self.gf('django.db.models.fields.CharField')(default='', max_length=300), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'APIMethod.display_url'
        db.delete_column('api_docs_apimethod', 'display_url')
