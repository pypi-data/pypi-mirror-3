...
import cProfile, operator, sys, time
...
def rep_bench(func, n, initfunc=None, MAXREPS=10, MAXTIME=60.0, profile=False, profresults="pyutil-benchutil.prof", UNITS_PER_SECOND=1):
    ...
    if len(tls) == 0:
        raise BadMeasure("Couldn't get any measurements within time limits or number-of-attempts limits. Maybe something is wrong with your clock? The most recent failure was: %s" % (bme,))
