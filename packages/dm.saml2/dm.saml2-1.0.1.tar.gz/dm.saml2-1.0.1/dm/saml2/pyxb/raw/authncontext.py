# ../../../dm/saml2/pyxb/raw/authncontext.py
# PyXB bindings for NM:1ec3b375313a629c2fd762e6ebb0af1abc609dd7
# Generated 2012-02-07 09:42:35.115033 by PyXB version 1.1.3
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('20120207094232:ebdb6df2')

# Import bindings for namespaces imported into schema
import pyxb.binding.datatypes

Namespace = pyxb.namespace.NamespaceForURI(u'urn:oasis:names:tc:SAML:2.0:ac', create_if_missing=True)
...
STD_ANON.principalchosen = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'principalchosen', tag=u'principalchosen')
STD_ANON.automatic = STD_ANON._CF_enumeration.addEnumeration(unicode_value=u'automatic', tag=u'automatic')
...
class STD_ANON_ (pyxb.binding.datatypes.integer):
    ...
    _ExpandedName = None
    _Documentation = None
STD_ANON_._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(value_datatype=STD_ANON_, value=pyxb.binding.datatypes.integer(3L))
...
STD_ANON_2.primary = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'primary', tag=u'primary')
STD_ANON_2.secondary = STD_ANON_2._CF_enumeration.addEnumeration(unicode_value=u'secondary', tag=u'secondary')
...
class ExtensionOnlyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_ExtensionOnlyType_urnoasisnamestcSAML2_0acExtension', True)
...
class ActivationLimitType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ActivationLimitSession uses Python identifier ActivationLimitSession
    __ActivationLimitSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitSession'), 'ActivationLimitSession', '__urnoasisnamestcSAML2_0ac_ActivationLimitType_urnoasisnamestcSAML2_0acActivationLimitSession', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ActivationLimitUsages uses Python identifier ActivationLimitUsages
    __ActivationLimitUsages = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitUsages'), 'ActivationLimitUsages', '__urnoasisnamestcSAML2_0ac_ActivationLimitType_urnoasisnamestcSAML2_0acActivationLimitUsages', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ActivationLimitDuration uses Python identifier ActivationLimitDuration
    __ActivationLimitDuration = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimitDuration'), 'ActivationLimitDuration', '__urnoasisnamestcSAML2_0ac_ActivationLimitType_urnoasisnamestcSAML2_0acActivationLimitDuration', False)
...
class PasswordType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Length uses Python identifier Length
    __Length = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Length'), 'Length', '__urnoasisnamestcSAML2_0ac_PasswordType_urnoasisnamestcSAML2_0acLength', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_PasswordType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Generation uses Python identifier Generation
    __Generation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Generation'), 'Generation', '__urnoasisnamestcSAML2_0ac_PasswordType_urnoasisnamestcSAML2_0acGeneration', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Alphabet uses Python identifier Alphabet
    __Alphabet = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Alphabet'), 'Alphabet', '__urnoasisnamestcSAML2_0ac_PasswordType_urnoasisnamestcSAML2_0acAlphabet', False)
    ...
    __ExternalVerification = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ExternalVerification'), 'ExternalVerification', '__urnoasisnamestcSAML2_0ac_PasswordType_ExternalVerification', pyxb.binding.datatypes.anyURI)
...
class RestrictedPasswordType (PasswordType):
    ...
    # Element Length ({urn:oasis:names:tc:SAML:2.0:ac}Length) inherited from {urn:oasis:names:tc:SAML:2.0:ac}PasswordType
    
    # Element Extension ({urn:oasis:names:tc:SAML:2.0:ac}Extension) inherited from {urn:oasis:names:tc:SAML:2.0:ac}PasswordType
    
    # Element Generation ({urn:oasis:names:tc:SAML:2.0:ac}Generation) inherited from {urn:oasis:names:tc:SAML:2.0:ac}PasswordType
...
class ActivationPinType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Alphabet uses Python identifier Alphabet
    __Alphabet = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Alphabet'), 'Alphabet', '__urnoasisnamestcSAML2_0ac_ActivationPinType_urnoasisnamestcSAML2_0acAlphabet', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Length uses Python identifier Length
    __Length = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Length'), 'Length', '__urnoasisnamestcSAML2_0ac_ActivationPinType_urnoasisnamestcSAML2_0acLength', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Generation uses Python identifier Generation
    __Generation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Generation'), 'Generation', '__urnoasisnamestcSAML2_0ac_ActivationPinType_urnoasisnamestcSAML2_0acGeneration', False)

    
    Generation = property(__Generation.value, __Generation.set, None, u'\n        Indicates whether the password was chosen by the\n        Principal or auto-supplied by the Authentication Authority.\n        principalchosen - the Principal is allowed to choose\n        the value of the password. This is true even if\n        the initial password is chosen at random by the UA or\n        the IdP and the Principal is then free to change\n        the password.\n        automatic - the password is chosen by the UA or the\n        IdP to be cryptographically strong in some sense,\n        or to satisfy certain password rules, and that the\n        Principal is not free to change it or to choose a new password.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ActivationLimit uses Python identifier ActivationLimit
    __ActivationLimit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationLimit'), 'ActivationLimit', '__urnoasisnamestcSAML2_0ac_ActivationPinType_urnoasisnamestcSAML2_0acActivationLimit', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_ActivationPinType_urnoasisnamestcSAML2_0acExtension', True)
...
class AlphabetType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __case = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'case'), 'case', '__urnoasisnamestcSAML2_0ac_AlphabetType_case', pyxb.binding.datatypes.string)
    
    case = property(__case.value, __case.set, None, None)

    
    # Attribute requiredChars uses Python identifier requiredChars
    __requiredChars = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'requiredChars'), 'requiredChars', '__urnoasisnamestcSAML2_0ac_AlphabetType_requiredChars', pyxb.binding.datatypes.string, required=True)
    ...
    __excludedChars = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'excludedChars'), 'excludedChars', '__urnoasisnamestcSAML2_0ac_AlphabetType_excludedChars', pyxb.binding.datatypes.string)
...
class GoverningAgreementsType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}GoverningAgreementRef uses Python identifier GoverningAgreementRef
    __GoverningAgreementRef = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreementRef'), 'GoverningAgreementRef', '__urnoasisnamestcSAML2_0ac_GoverningAgreementsType_urnoasisnamestcSAML2_0acGoverningAgreementRef', True)
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mechanism = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mechanism'), 'mechanism', '__urnoasisnamestcSAML2_0ac_CTD_ANON_mechanism', STD_ANON, required=True)
...
class ActivationLimitUsagesType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __number = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'number'), 'number', '__urnoasisnamestcSAML2_0ac_ActivationLimitUsagesType_number', pyxb.binding.datatypes.integer, required=True)
...
class PrincipalAuthenticationMechanismType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Token uses Python identifier Token
    __Token = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Token'), 'Token', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acToken', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Smartcard uses Python identifier Smartcard
    __Smartcard = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Smartcard'), 'Smartcard', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acSmartcard', False)

    
    Smartcard = property(__Smartcard.value, __Smartcard.set, None, u'\n        This element indicates that a smartcard is used to\n        identity the Principal.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acRestrictedPassword', False)

    
    RestrictedPassword = property(__RestrictedPassword.value, __RestrictedPassword.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acPassword', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ActivationPin uses Python identifier ActivationPin
    __ActivationPin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationPin'), 'ActivationPin', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acActivationPin', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_urnoasisnamestcSAML2_0acExtension', True)
    ...
    __preauth = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'preauth'), 'preauth', '__urnoasisnamestcSAML2_0ac_PrincipalAuthenticationMechanismType_preauth', pyxb.binding.datatypes.integer)
...
class SharedSecretChallengeResponseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_SharedSecretChallengeResponseType_urnoasisnamestcSAML2_0acExtension', True)
    ...
    __method = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'method'), 'method', '__urnoasisnamestcSAML2_0ac_SharedSecretChallengeResponseType_method', pyxb.binding.datatypes.anyURI)
...
class IdentificationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}GoverningAgreements uses Python identifier GoverningAgreements
    __GoverningAgreements = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreements'), 'GoverningAgreements', '__urnoasisnamestcSAML2_0ac_IdentificationType_urnoasisnamestcSAML2_0acGoverningAgreements', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_IdentificationType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}WrittenConsent uses Python identifier WrittenConsent
    __WrittenConsent = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'WrittenConsent'), 'WrittenConsent', '__urnoasisnamestcSAML2_0ac_IdentificationType_urnoasisnamestcSAML2_0acWrittenConsent', False)

    
    WrittenConsent = property(__WrittenConsent.value, __WrittenConsent.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}PhysicalVerification uses Python identifier PhysicalVerification
    __PhysicalVerification = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PhysicalVerification'), 'PhysicalVerification', '__urnoasisnamestcSAML2_0ac_IdentificationType_urnoasisnamestcSAML2_0acPhysicalVerification', False)
    ...
    __nym = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'nym'), 'nym', '__urnoasisnamestcSAML2_0ac_IdentificationType_nym', nymType)
...
class PrivateKeyProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}KeySharing uses Python identifier KeySharing
    __KeySharing = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeySharing'), 'KeySharing', '__urnoasisnamestcSAML2_0ac_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acKeySharing', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}KeyActivation uses Python identifier KeyActivation
    __KeyActivation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyActivation'), 'KeyActivation', '__urnoasisnamestcSAML2_0ac_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acKeyActivation', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}KeyStorage uses Python identifier KeyStorage
    __KeyStorage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyStorage'), 'KeyStorage', '__urnoasisnamestcSAML2_0ac_PrivateKeyProtectionType_urnoasisnamestcSAML2_0acKeyStorage', False)
...
class AuthenticatorBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ComplexAuthenticator uses Python identifier ComplexAuthenticator
    __ComplexAuthenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ComplexAuthenticator'), 'ComplexAuthenticator', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acComplexAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}UserSuffix uses Python identifier UserSuffix
    __UserSuffix = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix'), 'UserSuffix', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acUserSuffix', True)

    
    UserSuffix = property(__UserSuffix.value, __UserSuffix.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ZeroKnowledge uses Python identifier ZeroKnowledge
    __ZeroKnowledge = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge'), 'ZeroKnowledge', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acZeroKnowledge', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}DigSig uses Python identifier DigSig
    __DigSig = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DigSig'), 'DigSig', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acDigSig', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}AsymmetricDecryption uses Python identifier AsymmetricDecryption
    __AsymmetricDecryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption'), 'AsymmetricDecryption', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acAsymmetricDecryption', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SharedSecretChallengeResponse uses Python identifier SharedSecretChallengeResponse
    __SharedSecretChallengeResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse'), 'SharedSecretChallengeResponse', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acSharedSecretChallengeResponse', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}AsymmetricKeyAgreement uses Python identifier AsymmetricKeyAgreement
    __AsymmetricKeyAgreement = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement'), 'AsymmetricKeyAgreement', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acAsymmetricKeyAgreement', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acPassword', True)

    
    Password = property(__Password.value, __Password.set, None, u'\n        This element indicates that a password (or passphrase)\n        has been used to\n        authenticate the Principal to a remote system.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}PreviousSession uses Python identifier PreviousSession
    __PreviousSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession'), 'PreviousSession', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acPreviousSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SharedSecretDynamicPlaintext uses Python identifier SharedSecretDynamicPlaintext
    __SharedSecretDynamicPlaintext = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext'), 'SharedSecretDynamicPlaintext', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acSharedSecretDynamicPlaintext', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ResumeSession uses Python identifier ResumeSession
    __ResumeSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession'), 'ResumeSession', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acResumeSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SubscriberLineNumber uses Python identifier SubscriberLineNumber
    __SubscriberLineNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber'), 'SubscriberLineNumber', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acSubscriberLineNumber', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acRestrictedPassword', True)

    
    RestrictedPassword = property(__RestrictedPassword.value, __RestrictedPassword.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}IPAddress uses Python identifier IPAddress
    __IPAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), 'IPAddress', '__urnoasisnamestcSAML2_0ac_AuthenticatorBaseType_urnoasisnamestcSAML2_0acIPAddress', True)
...
class PublicKeyType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_PublicKeyType_urnoasisnamestcSAML2_0acExtension', True)
    ...
    __keyValidation = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'keyValidation'), 'keyValidation', '__urnoasisnamestcSAML2_0ac_PublicKeyType_keyValidation', pyxb.binding.datatypes.anySimpleType)
...
class LengthType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0ac_LengthType_min', pyxb.binding.datatypes.integer, required=True)
    
    min = property(__min.value, __min.set, None, None)

    
    # Attribute max uses Python identifier max
    __max = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'max'), 'max', '__urnoasisnamestcSAML2_0ac_LengthType_max', pyxb.binding.datatypes.integer)
...
class RestrictedLengthType (LengthType):
    ...
    # Attribute min uses Python identifier min
    __min = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'min'), 'min', '__urnoasisnamestcSAML2_0ac_LengthType_min', STD_ANON_, required=True)
...
class SecretKeyProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}KeyStorage uses Python identifier KeyStorage
    __KeyStorage = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyStorage'), 'KeyStorage', '__urnoasisnamestcSAML2_0ac_SecretKeyProtectionType_urnoasisnamestcSAML2_0acKeyStorage', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_SecretKeyProtectionType_urnoasisnamestcSAML2_0acExtension', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}KeyActivation uses Python identifier KeyActivation
    __KeyActivation = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'KeyActivation'), 'KeyActivation', '__urnoasisnamestcSAML2_0ac_SecretKeyProtectionType_urnoasisnamestcSAML2_0acKeyActivation', False)
...
class OperationalProtectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_OperationalProtectionType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SecurityAudit uses Python identifier SecurityAudit
    __SecurityAudit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SecurityAudit'), 'SecurityAudit', '__urnoasisnamestcSAML2_0ac_OperationalProtectionType_urnoasisnamestcSAML2_0acSecurityAudit', False)

    
    SecurityAudit = property(__SecurityAudit.value, __SecurityAudit.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}DeactivationCallCenter uses Python identifier DeactivationCallCenter
    __DeactivationCallCenter = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DeactivationCallCenter'), 'DeactivationCallCenter', '__urnoasisnamestcSAML2_0ac_OperationalProtectionType_urnoasisnamestcSAML2_0acDeactivationCallCenter', False)
...
class SecurityAuditType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SwitchAudit uses Python identifier SwitchAudit
    __SwitchAudit = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SwitchAudit'), 'SwitchAudit', '__urnoasisnamestcSAML2_0ac_SecurityAuditType_urnoasisnamestcSAML2_0acSwitchAudit', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_SecurityAuditType_urnoasisnamestcSAML2_0acExtension', True)
...
class GoverningAgreementRefType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __governingAgreementRef = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'governingAgreementRef'), 'governingAgreementRef', '__urnoasisnamestcSAML2_0ac_GoverningAgreementRefType_governingAgreementRef', pyxb.binding.datatypes.anyURI, required=True)
...
class AuthenticatorTransportProtocolType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}PSTN uses Python identifier PSTN
    __PSTN = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PSTN'), 'PSTN', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acPSTN', False)

    
    PSTN = property(__PSTN.value, __PSTN.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}HTTP uses Python identifier HTTP
    __HTTP = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), 'HTTP', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acHTTP', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}MobileNetworkRadioEncryption uses Python identifier MobileNetworkRadioEncryption
    __MobileNetworkRadioEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkRadioEncryption'), 'MobileNetworkRadioEncryption', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acMobileNetworkRadioEncryption', False)

    
    MobileNetworkRadioEncryption = property(__MobileNetworkRadioEncryption.value, __MobileNetworkRadioEncryption.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SSL uses Python identifier SSL
    __SSL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SSL'), 'SSL', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acSSL', False)

    
    SSL = property(__SSL.value, __SSL.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using a transport mechnanism protected by an SSL or TLS\n        session.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ISDN uses Python identifier ISDN
    __ISDN = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ISDN'), 'ISDN', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acISDN', False)

    
    ISDN = property(__ISDN.value, __ISDN.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}WTLS uses Python identifier WTLS
    __WTLS = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'WTLS'), 'WTLS', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acWTLS', False)

    
    WTLS = property(__WTLS.value, __WTLS.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using a transport mechanism protected by a WTLS session.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}MobileNetworkNoEncryption uses Python identifier MobileNetworkNoEncryption
    __MobileNetworkNoEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkNoEncryption'), 'MobileNetworkNoEncryption', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acMobileNetworkNoEncryption', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ADSL uses Python identifier ADSL
    __ADSL = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ADSL'), 'ADSL', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acADSL', False)

    
    ADSL = property(__ADSL.value, __ADSL.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}IPSec uses Python identifier IPSec
    __IPSec = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPSec'), 'IPSec', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acIPSec', False)

    
    IPSec = property(__IPSec.value, __IPSec.set, None, u'\n        This element indicates that the Authenticator has been\n        transmitted using a transport mechanism protected by an IPSEC session.\n      ')

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}MobileNetworkEndToEndEncryption uses Python identifier MobileNetworkEndToEndEncryption
    __MobileNetworkEndToEndEncryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'MobileNetworkEndToEndEncryption'), 'MobileNetworkEndToEndEncryption', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acMobileNetworkEndToEndEncryption', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_AuthenticatorTransportProtocolType_urnoasisnamestcSAML2_0acExtension', True)
...
class KeyActivationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ActivationPin uses Python identifier ActivationPin
    __ActivationPin = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ActivationPin'), 'ActivationPin', '__urnoasisnamestcSAML2_0ac_KeyActivationType_urnoasisnamestcSAML2_0acActivationPin', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_KeyActivationType_urnoasisnamestcSAML2_0acExtension', True)
...
class KeyStorageType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __medium = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'medium'), 'medium', '__urnoasisnamestcSAML2_0ac_KeyStorageType_medium', mediumType, required=True)
...
class TokenType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}TimeSyncToken uses Python identifier TimeSyncToken
    __TimeSyncToken = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TimeSyncToken'), 'TimeSyncToken', '__urnoasisnamestcSAML2_0ac_TokenType_urnoasisnamestcSAML2_0acTimeSyncToken', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_TokenType_urnoasisnamestcSAML2_0acExtension', True)
...
class AuthnMethodBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}PrincipalAuthenticationMechanism uses Python identifier PrincipalAuthenticationMechanism
    __PrincipalAuthenticationMechanism = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PrincipalAuthenticationMechanism'), 'PrincipalAuthenticationMechanism', '__urnoasisnamestcSAML2_0ac_AuthnMethodBaseType_urnoasisnamestcSAML2_0acPrincipalAuthenticationMechanism', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_AuthnMethodBaseType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Authenticator uses Python identifier Authenticator
    __Authenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Authenticator'), 'Authenticator', '__urnoasisnamestcSAML2_0ac_AuthnMethodBaseType_urnoasisnamestcSAML2_0acAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}AuthenticatorTransportProtocol uses Python identifier AuthenticatorTransportProtocol
    __AuthenticatorTransportProtocol = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AuthenticatorTransportProtocol'), 'AuthenticatorTransportProtocol', '__urnoasisnamestcSAML2_0ac_AuthnMethodBaseType_urnoasisnamestcSAML2_0acAuthenticatorTransportProtocol', False)
...
class TechnicalProtectionBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}PrivateKeyProtection uses Python identifier PrivateKeyProtection
    __PrivateKeyProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PrivateKeyProtection'), 'PrivateKeyProtection', '__urnoasisnamestcSAML2_0ac_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acPrivateKeyProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acExtension', True)

    
    Extension = property(__Extension.value, __Extension.set, None, None)

    
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SecretKeyProtection uses Python identifier SecretKeyProtection
    __SecretKeyProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SecretKeyProtection'), 'SecretKeyProtection', '__urnoasisnamestcSAML2_0ac_TechnicalProtectionBaseType_urnoasisnamestcSAML2_0acSecretKeyProtection', False)
...
class AuthnContextDeclarationBaseType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}OperationalProtection uses Python identifier OperationalProtection
    __OperationalProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'OperationalProtection'), 'OperationalProtection', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acOperationalProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}TechnicalProtection uses Python identifier TechnicalProtection
    __TechnicalProtection = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'TechnicalProtection'), 'TechnicalProtection', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acTechnicalProtection', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Identification uses Python identifier Identification
    __Identification = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Identification'), 'Identification', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acIdentification', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}AuthnMethod uses Python identifier AuthnMethod
    __AuthnMethod = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AuthnMethod'), 'AuthnMethod', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acAuthnMethod', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}GoverningAgreements uses Python identifier GoverningAgreements
    __GoverningAgreements = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'GoverningAgreements'), 'GoverningAgreements', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acGoverningAgreements', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_urnoasisnamestcSAML2_0acExtension', True)
    ...
    __ID = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'ID'), 'ID', '__urnoasisnamestcSAML2_0ac_AuthnContextDeclarationBaseType_ID', pyxb.binding.datatypes.ID)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    __credentialLevel = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'credentialLevel'), 'credentialLevel', '__urnoasisnamestcSAML2_0ac_CTD_ANON__credentialLevel', STD_ANON_2)
...
class ComplexAuthenticatorType (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SharedSecretDynamicPlaintext uses Python identifier SharedSecretDynamicPlaintext
    __SharedSecretDynamicPlaintext = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext'), 'SharedSecretDynamicPlaintext', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acSharedSecretDynamicPlaintext', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Password uses Python identifier Password
    __Password = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Password'), 'Password', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acPassword', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}UserSuffix uses Python identifier UserSuffix
    __UserSuffix = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix'), 'UserSuffix', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acUserSuffix', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}IPAddress uses Python identifier IPAddress
    __IPAddress = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), 'IPAddress', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acIPAddress', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}DigSig uses Python identifier DigSig
    __DigSig = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'DigSig'), 'DigSig', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acDigSig', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ComplexAuthenticator uses Python identifier ComplexAuthenticator
    __ComplexAuthenticator = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ComplexAuthenticator'), 'ComplexAuthenticator', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acComplexAuthenticator', False)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}RestrictedPassword uses Python identifier RestrictedPassword
    __RestrictedPassword = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword'), 'RestrictedPassword', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acRestrictedPassword', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}AsymmetricDecryption uses Python identifier AsymmetricDecryption
    __AsymmetricDecryption = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption'), 'AsymmetricDecryption', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acAsymmetricDecryption', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}Extension uses Python identifier Extension
    __Extension = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Extension'), 'Extension', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acExtension', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}PreviousSession uses Python identifier PreviousSession
    __PreviousSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession'), 'PreviousSession', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acPreviousSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ZeroKnowledge uses Python identifier ZeroKnowledge
    __ZeroKnowledge = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge'), 'ZeroKnowledge', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acZeroKnowledge', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}AsymmetricKeyAgreement uses Python identifier AsymmetricKeyAgreement
    __AsymmetricKeyAgreement = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement'), 'AsymmetricKeyAgreement', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acAsymmetricKeyAgreement', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}ResumeSession uses Python identifier ResumeSession
    __ResumeSession = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession'), 'ResumeSession', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acResumeSession', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SharedSecretChallengeResponse uses Python identifier SharedSecretChallengeResponse
    __SharedSecretChallengeResponse = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse'), 'SharedSecretChallengeResponse', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acSharedSecretChallengeResponse', True)
    ...
    # Element {urn:oasis:names:tc:SAML:2.0:ac}SubscriberLineNumber uses Python identifier SubscriberLineNumber
    __SubscriberLineNumber = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber'), 'SubscriberLineNumber', '__urnoasisnamestcSAML2_0ac_ComplexAuthenticatorType_urnoasisnamestcSAML2_0acSubscriberLineNumber', True)
...
class TimeSyncTokenType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __DeviceType = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'DeviceType'), 'DeviceType', '__urnoasisnamestcSAML2_0ac_TimeSyncTokenType_DeviceType', DeviceTypeType, required=True)
    
    DeviceType = property(__DeviceType.value, __DeviceType.set, None, None)

    
    # Attribute SeedLength uses Python identifier SeedLength
    __SeedLength = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'SeedLength'), 'SeedLength', '__urnoasisnamestcSAML2_0ac_TimeSyncTokenType_SeedLength', pyxb.binding.datatypes.integer, required=True)
    ...
    __DeviceInHand = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'DeviceInHand'), 'DeviceInHand', '__urnoasisnamestcSAML2_0ac_TimeSyncTokenType_DeviceInHand', booleanType, required=True)
...
class KeySharingType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __sharing = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'sharing'), 'sharing', '__urnoasisnamestcSAML2_0ac_KeySharingType_sharing', pyxb.binding.datatypes.boolean, required=True)
...
class ActivationLimitDurationType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __duration = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'duration'), 'duration', '__urnoasisnamestcSAML2_0ac_ActivationLimitDurationType_duration', pyxb.binding.datatypes.duration, required=True)
...
PhysicalVerification = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PhysicalVerification'), CTD_ANON_, documentation=u'\n        This element indicates that identification has been\n        performed in a physical\n        face-to-face meeting with the principal and not in an\n        online manner.\n      ')
...
Generation = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Generation'), CTD_ANON, documentation=u'\n        Indicates whether the password was chosen by the\n        Principal or auto-supplied by the Authentication Authority.\n        principalchosen - the Principal is allowed to choose\n        the value of the password. This is true even if\n        the initial password is chosen at random by the UA or\n        the IdP and the Principal is then free to change\n        the password.\n        automatic - the password is chosen by the UA or the\n        IdP to be cryptographically strong in some sense,\n        or to satisfy certain password rules, and that the\n        Principal is not free to change it or to choose a new password.\n      ')
...
ExtensionType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(pyxb.binding.content.Wildcard(process_contents=pyxb.binding.content.Wildcard.PC_lax, namespace_constraint=(pyxb.binding.content.Wildcard.NC_not, u'urn:oasis:names:tc:SAML:2.0:ac')), min_occurs=1, max_occurs=None)
    )
...
PasswordType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Generation'), CTD_ANON, scope=PasswordType, documentation=u'\n        Indicates whether the password was chosen by the\n        Principal or auto-supplied by the Authentication Authority.\n        principalchosen - the Principal is allowed to choose\n        the value of the password. This is true even if\n        the initial password is chosen at random by the UA or\n        the IdP and the Principal is then free to change\n        the password.\n        automatic - the password is chosen by the UA or the\n        IdP to be cryptographically strong in some sense,\n        or to satisfy certain password rules, and that the\n        Principal is not free to change it or to choose a new password.\n      '))
...
RestrictedPasswordType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(RestrictedPasswordType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Length')), min_occurs=1L, max_occurs=1),
...
ActivationPinType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Generation'), CTD_ANON, scope=ActivationPinType, documentation=u'\n        Indicates whether the password was chosen by the\n        Principal or auto-supplied by the Authentication Authority.\n        principalchosen - the Principal is allowed to choose\n        the value of the password. This is true even if\n        the initial password is chosen at random by the UA or\n        the IdP and the Principal is then free to change\n        the password.\n        automatic - the password is chosen by the UA or the\n        IdP to be cryptographically strong in some sense,\n        or to satisfy certain password rules, and that the\n        Principal is not free to change it or to choose a new password.\n      '))
...
IdentificationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PhysicalVerification'), CTD_ANON_, scope=IdentificationType, documentation=u'\n        This element indicates that identification has been\n        performed in a physical\n        face-to-face meeting with the principal and not in an\n        online manner.\n      '))
...
AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Extension'), ExtensionType, scope=AuthenticatorBaseType))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ComplexAuthenticator'), ComplexAuthenticatorType, scope=AuthenticatorBaseType, documentation=u'\n        Supports Authenticators with nested combinations of\n        additional complexity.\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix'), ExtensionOnlyType, scope=AuthenticatorBaseType))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge'), ExtensionOnlyType, scope=AuthenticatorBaseType, documentation=u'\n        This element indicates that the Principal has been\n        authenticated by a zero knowledge technique as specified in ISO/IEC\n        9798-5.\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'DigSig'), PublicKeyType, scope=AuthenticatorBaseType, documentation=u'\n        This element indicates that the Principal has been\n        authenticated by a mechanism which involves the Principal computing a\n        digital signature over at least challenge data provided by the IdP.\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption'), PublicKeyType, scope=AuthenticatorBaseType, documentation=u"\n        The local system has a private key but it is used\n        in decryption mode, rather than signature mode. For example, the\n        Authentication Authority generates a secret and encrypts it using the\n        local system's public key: the local system then proves it has\n        decrypted the secret.\n      "))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse'), SharedSecretChallengeResponseType, scope=AuthenticatorBaseType))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement'), PublicKeyType, scope=AuthenticatorBaseType, documentation=u'\n        The local system has a private key and uses it for\n        shared secret key agreement with the Authentication Authority (e.g.\n        via Diffie Helman).\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Password'), PasswordType, scope=AuthenticatorBaseType, documentation=u'\n        This element indicates that a password (or passphrase)\n        has been used to\n        authenticate the Principal to a remote system.\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession'), ExtensionOnlyType, scope=AuthenticatorBaseType, documentation=u'\n        Indicates that the Principal has been strongly\n        authenticated in a previous session during which the IdP has set a\n        cookie in the UA. During the present session the Principal has only\n        been authenticated by the UA returning the cookie to the IdP.\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext'), ExtensionOnlyType, scope=AuthenticatorBaseType, documentation=u'\n        The local system and Authentication Authority\n        share a secret key. The local system uses this to encrypt a\n        randomised string to pass to the Authentication Authority.\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession'), ExtensionOnlyType, scope=AuthenticatorBaseType, documentation=u'\n        Rather like PreviousSession but using stronger\n        security. A secret that was established in a previous session with\n        the Authentication Authority has been cached by the local system and\n        is now re-used (e.g. a Master Secret is used to derive new session\n        keys in TLS, SSL, WTLS).\n      '))

AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber'), ExtensionOnlyType, scope=AuthenticatorBaseType))
...
AuthenticatorBaseType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'IPAddress'), ExtensionOnlyType, scope=AuthenticatorBaseType, documentation=u'\n        This element indicates that the Principal has been\n        authenticated through connection from a particular IP address.\n      '))
AuthenticatorBaseType._GroupModel_ = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DigSig')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Password')), min_occurs=1, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'IPAddress')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ComplexAuthenticator')), min_occurs=1, max_occurs=1)
    )
AuthenticatorBaseType._GroupModel_2 = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PreviousSession')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ResumeSession')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'DigSig')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Password')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'RestrictedPassword')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ZeroKnowledge')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretChallengeResponse')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SharedSecretDynamicPlaintext')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'IPAddress')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricDecryption')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AsymmetricKeyAgreement')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'SubscriberLineNumber')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'UserSuffix')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Extension')), min_occurs=0L, max_occurs=None)
    )
AuthenticatorBaseType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._GroupModel_, min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorBaseType._GroupModel_2, min_occurs=1, max_occurs=1)
    )
...
AuthenticatorTransportProtocolType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'PSTN'), ExtensionOnlyType, scope=AuthenticatorTransportProtocolType))

AuthenticatorTransportProtocolType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'HTTP'), ExtensionOnlyType, scope=AuthenticatorTransportProtocolType, documentation=u'\n        This element indicates that the Authenticator has been\n        transmitted using bare HTTP utilizing no additional security\n        protocols.\n      '))
...
AuthenticatorTransportProtocolType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ISDN'), ExtensionOnlyType, scope=AuthenticatorTransportProtocolType))
...
AuthenticatorTransportProtocolType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ADSL'), ExtensionOnlyType, scope=AuthenticatorTransportProtocolType))
...
AuthenticatorTransportProtocolType._GroupModel_ = pyxb.binding.content.GroupChoice(
    pyxb.binding.content.ParticleModel(AuthenticatorTransportProtocolType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'HTTP')), min_occurs=1, max_occurs=1),
    ...
    pyxb.binding.content.ParticleModel(AuthenticatorTransportProtocolType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'PSTN')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorTransportProtocolType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ISDN')), min_occurs=1, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthenticatorTransportProtocolType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ADSL')), min_occurs=1, max_occurs=1)
    )
AuthenticatorTransportProtocolType._GroupModel = pyxb.binding.content.GroupSequence(
    pyxb.binding.content.ParticleModel(AuthenticatorTransportProtocolType._GroupModel_, min_occurs=0L, max_occurs=1),
...
AuthnMethodBaseType._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(AuthnMethodBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Authenticator')), min_occurs=0L, max_occurs=1),
    pyxb.binding.content.ParticleModel(AuthnMethodBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AuthenticatorTransportProtocol')), min_occurs=0L, max_occurs=1),
...
AuthnContextDeclarationBaseType._GroupModel = pyxb.binding.content.GroupSequence(
    ...
    pyxb.binding.content.ParticleModel(AuthnContextDeclarationBaseType._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'AuthnMethod')), min_occurs=0L, max_occurs=1),
