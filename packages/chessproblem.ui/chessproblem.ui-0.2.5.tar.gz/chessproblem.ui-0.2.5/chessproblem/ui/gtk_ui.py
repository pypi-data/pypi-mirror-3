...
from gtk_input import FastBoardEntry, BoardInputState, BoardInputHandler, ChessImageSelector
...
class MainFrame(object):
    ...
    def _create_display_area(self):
        ...
        self.board_area_hbox.pack_start(self.board_display, True, True, padding=8)
    ...
    def _on_board_clicked(self, row, column):
        self.board_input_state.set_current_piece_to(row, column)
    ...
    def _create_menu(self):
        ...
        if len(DEFAULT_CONFIG.compile_menu_actions) > 0:
            ...
            for values in DEFAULT_CONFIG.compile_menu_actions:
                ...
                menu_item.show()
                menu_item.connect('activate', self._on_compile_menu, DialinesTemplate(workdir, template_file, include_file, target_file).execute)
