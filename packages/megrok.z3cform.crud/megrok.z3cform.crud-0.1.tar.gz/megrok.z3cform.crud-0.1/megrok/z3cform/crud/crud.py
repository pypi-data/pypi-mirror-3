...
from megrok.z3cform.crud.widget import singlecheckboxwidget_factory
from megrok.z3cform.crud import MessageFactory as _
...
class CrudForm(AbstractCrudForm, megrok.z3cform.base.Form):
    grok.baseclass()
...
class CrudPageForm(AbstractCrudForm, megrok.z3cform.base.PageForm):
    grok.baseclass()
    ...
    def update(self):
        super(CrudPageForm, self).update()
