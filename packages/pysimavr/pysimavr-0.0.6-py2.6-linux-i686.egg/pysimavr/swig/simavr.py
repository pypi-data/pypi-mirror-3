...
class avr_t(_object):
    ...
    __swig_setmethods__["cycle_timer_map"] = _simavr.avr_t_cycle_timer_map_set
    __swig_getmethods__["cycle_timer_map"] = _simavr.avr_t_cycle_timer_map_get
    if _newclass:cycle_timer_map = _swig_property(_simavr.avr_t_cycle_timer_map_get, _simavr.avr_t_cycle_timer_map_set)
    __swig_setmethods__["next_cycle_timer"] = _simavr.avr_t_next_cycle_timer_set
    __swig_getmethods__["next_cycle_timer"] = _simavr.avr_t_next_cycle_timer_get
    if _newclass:next_cycle_timer = _swig_property(_simavr.avr_t_next_cycle_timer_get, _simavr.avr_t_next_cycle_timer_set)
    __swig_setmethods__["vector"] = _simavr.avr_t_vector_set
    __swig_getmethods__["vector"] = _simavr.avr_t_vector_get
    if _newclass:vector = _swig_property(_simavr.avr_t_vector_get, _simavr.avr_t_vector_set)
    __swig_setmethods__["pending_wait"] = _simavr.avr_t_pending_wait_set
    __swig_getmethods__["pending_wait"] = _simavr.avr_t_pending_wait_get
    if _newclass:pending_wait = _swig_property(_simavr.avr_t_pending_wait_get, _simavr.avr_t_pending_wait_set)
    __swig_setmethods__["pending"] = _simavr.avr_t_pending_set
    __swig_getmethods__["pending"] = _simavr.avr_t_pending_get
    if _newclass:pending = _swig_property(_simavr.avr_t_pending_get, _simavr.avr_t_pending_set)
    ...
    __swig_getmethods__["cycle_timer"] = _simavr.avr_t_cycle_timer_get
    if _newclass:cycle_timer = _swig_property(_simavr.avr_t_cycle_timer_get)
...
class avr_t_cycle_timer(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, avr_t_cycle_timer, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, avr_t_cycle_timer, name)
    __repr__ = _swig_repr
    __swig_setmethods__["when"] = _simavr.avr_t_cycle_timer_when_set
    __swig_getmethods__["when"] = _simavr.avr_t_cycle_timer_when_get
    if _newclass:when = _swig_property(_simavr.avr_t_cycle_timer_when_get, _simavr.avr_t_cycle_timer_when_set)
    __swig_setmethods__["timer"] = _simavr.avr_t_cycle_timer_timer_set
    __swig_getmethods__["timer"] = _simavr.avr_t_cycle_timer_timer_get
    if _newclass:timer = _swig_property(_simavr.avr_t_cycle_timer_timer_get, _simavr.avr_t_cycle_timer_timer_set)
    __swig_setmethods__["param"] = _simavr.avr_t_cycle_timer_param_set
    __swig_getmethods__["param"] = _simavr.avr_t_cycle_timer_param_get
    if _newclass:param = _swig_property(_simavr.avr_t_cycle_timer_param_get, _simavr.avr_t_cycle_timer_param_set)
    def __init__(self): 
        this = _simavr.new_avr_t_cycle_timer()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _simavr.delete_avr_t_cycle_timer
    __del__ = lambda self : None;
avr_t_cycle_timer_swigregister = _simavr.avr_t_cycle_timer_swigregister
avr_t_cycle_timer_swigregister(avr_t_cycle_timer)
...
AVR_VCD_LOG_SIZE = _simavr.AVR_VCD_LOG_SIZE
