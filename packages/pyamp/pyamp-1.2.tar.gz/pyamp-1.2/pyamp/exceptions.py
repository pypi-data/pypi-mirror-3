...
class InvalidConfigurationPropertyValueError(Exception):
    '''The InvalidConfigurationPropertyValueError is raised in the event that
    a configuration property has an invalid value.

    '''

    def __init__(self, optionName, acceptedValues, section=None):
        '''
        * optionName -- The name of the option
        * acceptedValues -- The list of values accepted for this option
        * section -- The section name

        '''
        if section is not None:
            message = "Option '%s' in section '%s' has an invalid " \
                "value." % (optionName, section)
        else:
            message = "Option '%s' has an invalid value." % optionName

        message += " Valid values are %s" % acceptedValues
