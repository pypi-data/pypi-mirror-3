...
model.Make.declare_attribute("Rc")
model.Make.declare_attribute("Lrc")
model.Make.declare_attribute("Urc")

# tons inventoried
model.Inv = Var(model.PROD, model.TWOPLUSWEEKS, domain=NonNegativeReals)
model.Inv.declare_attribute("Rc")
model.Inv.declare_attribute("Lrc")
model.Inv.declare_attribute("Urc")
...
model.Sell.declare_attribute("Rc")
model.Sell.declare_attribute("Lrc")
model.Sell.declare_attribute("Urc")
