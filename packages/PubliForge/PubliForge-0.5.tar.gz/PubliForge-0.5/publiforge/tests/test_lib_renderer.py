...
class UnitTestLibRendererHasPermission(unittest.TestCase):
    ...
    def test_unauthenticated(self):
        ...
        self.assertFalse(has_permission(request, 'usr_viewer'))
    ...
    def test_with_user(self):
        ...
        from ..lib.renderer import has_permission
        request = testing.DummyRequest()
        request.session['perms'] = ('usr_manager', 'grp_modifier')
        self.assertTrue(has_permission(request, 'usr_viewer'))
        self.assertTrue(has_permission(request, 'usr_modifier'))
        self.assertTrue(has_permission(request, 'usr_manager'))
        self.assertTrue(has_permission(request, 'grp_viewer'))
        self.assertTrue(has_permission(request, 'grp_modifier'))
        self.assertFalse(has_permission(request, 'grp_manager'))
        self.assertFalse(has_permission(request, 'stg_viewer'))
        self.assertFalse(has_permission(request, 'stg_modifier'))
...
class UnitTestLibRendererMenu(ModelTestCase):
    ...
    def _make_one(self):
        ...
        project.users.append(ProjectUser(self._user_id, True))
        ...
        request.session['perms'] = (
            'stg_viewer', 'prj_viewer', 'usr_manager', 'grp_modifier')
