...
class CPLEXDirect(OptSolver):
    ...
    def _populate_cplex_instance(self, pyomo_instance):
        ...
        self._symbol_map.getSymbol(the_objective, labeler)
        self._symbol_map.alias(the_objective,'__default_objective__')


        if is_constant(the_objective[None].repn):
