...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field child_types on 'ResourceType'
        db.create_table('warthog_resourcetype_child_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_resourcetype', models.ForeignKey(orm['warthog.resourcetype'], null=False)),
            ('to_resourcetype', models.ForeignKey(orm['warthog.resourcetype'], null=False))
        ))
        db.create_unique('warthog_resourcetype_child_types', ['from_resourcetype_id', 'to_resourcetype_id'])


    def backwards(self, orm):
        # Removing M2M table for field child_types on 'ResourceType'
        db.delete_table('warthog_resourcetype_child_types')
    ...
    models = {
        ...
        'warthog.resourcetype': {
            ...
            'child_types': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'child_types_rel_+'", 'null': 'True', 'to': "orm['warthog.ResourceType']"}),
