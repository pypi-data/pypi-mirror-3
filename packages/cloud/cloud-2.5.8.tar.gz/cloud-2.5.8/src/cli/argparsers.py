...
"""Files Parser"""
files_parser = picloud_subparsers.add_parser('files', description="Module for managing files stored on PiCloud's key-value store", 
...
bucket_getmd5_parser.add_argument('name', default=None, help='Name of bucket object stored on PiCloud')
...
bucket_put_parser.add_argument('name', default=None, help='Name for bucket object specified by source when stored on PiCloud')
...
bucket_syncfromcloud_parser.add_argument('name', default=None, help='Name of bucket object stored on PiCloud')
...
bucket_synctocloud_parser.add_argument('name', default=None, help='Name for bucket object specified by source when stored on PiCloud')
