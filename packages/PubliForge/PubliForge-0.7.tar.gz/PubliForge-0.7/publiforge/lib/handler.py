# $Id: handler.py c9b32baf8fa9 2012/07/28 21:07:17 patrick $
...
from .utils import _, EXCLUDED_FILES, decrypt, unzip, get_mime_type
...
class HandlerManager(object):
    ...
    def __init__(self, settings, cache_manager):
        ...
        vcs_classes = {'none': VcsNone, 'local': VcsLocal, 'hg': VcsMercurial,
                       'svn': VcsSubversion}
        self.vcs_classes = {}
        for vcs in settings.get('storage.vcs', '').split():
   ...
   # -------------------------------------------------------------------------
    ...
    def file_infos(self, path, filenames):
        ...
        for filename in filenames:
            ...
            file_infos.append([
                filename, filetype, size, vcs_infos[0], vcs_infos[1],
                vcs_infos[2], vcs_infos[3]])
