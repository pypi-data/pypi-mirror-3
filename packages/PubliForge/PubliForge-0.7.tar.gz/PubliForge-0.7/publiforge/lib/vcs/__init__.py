# $Id: __init__.py 8e0eacb6ec37 2012/08/05 17:55:59 patrick $
"""Version Control System library."""

from abc import ABCMeta, abstractmethod
from os import mkdir, remove
from os.path import exists, join, normpath, getmtime
...
class Vcs(object):
    ...
    def file_infos(self, path, filename):
        ...
        if log is not None:
            return len(log) and log[0] or (datetime.fromtimestamp(getmtime(
