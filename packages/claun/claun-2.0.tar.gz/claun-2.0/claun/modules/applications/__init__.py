...
Admin submodule depends on couchdb, users, applications, environment (admin submodule) and distribappcontrol.
...
__version__ = '0.2'
__author__ = 'chadijir'
__dependencies__ = ['couchdb', 'users', 'environment', 'distribappcontrol']
