...
def check_sys_package(name, compVersion = None, platform = "all"):
	...
	pVersion = check_sys_package_version(name)
...
def check_sys_package_version(name, index = 0):
	...
	if version:
		...
		return check_sys_package_version(name, index+1)
