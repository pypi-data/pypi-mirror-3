 ...
 *          DO NOT MODIFY THIS FILE, MODIFY include/SquareWell.h
...
static PyObject * CSquareWellStructureError = NULL;
...
static void
CSquareWellStructure_dealloc(CSquareWellStructure* self)
{
...
static PyObject *
CSquareWellStructure_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CSquareWellStructure *self;
    
    self = (CSquareWellStructure *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CSquareWellStructure_init(CSquareWellStructure *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        PyDict_SetItemString(self->params,"welldepth",Py_BuildValue("d",1.500000000000));
        PyDict_SetItemString(self->params,"effect_radius",Py_BuildValue("d",50.000000000000));
        PyDict_SetItemString(self->params,"volfraction",Py_BuildValue("d",0.040000000000));
        PyDict_SetItemString(self->params,"wellwidth",Py_BuildValue("d",1.200000000000));
...
static PyMemberDef CSquareWellStructure_members[] = {
    {name_params, T_OBJECT, offsetof(CSquareWellStructure, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CSquareWellStructure, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CSquareWellStructure, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CSquareWellStructure_readDouble(PyObject *p) {
 ...
 */
static PyObject * run(CSquareWellStructure *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CSquareWellStructureError, 
	    	"CSquareWellStructure.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CSquareWellStructureError, 
	    		"CSquareWellStructure.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CSquareWellStructure_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CSquareWellStructure_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CSquareWellStructure_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CSquareWellStructure *self) {
 ...
 */
static PyObject * calculate_VR(CSquareWellStructure *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CSquareWellStructure *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CSquareWellStructure_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CSquareWellStructure_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CSquareWellStructure_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CSquareWellStructure *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CSquareWellStructure *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CSquareWellStructureError,
	    	"CSquareWellStructure.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "effect_radius")) {
	    ...
	    PyErr_SetString(CSquareWellStructureError,
	    	"CSquareWellStructure.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CSquareWellStructure_methods[] = {
...
static PyTypeObject CSquareWellStructureType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CSquareWellStructure",             /*tp_name*/
    sizeof(CSquareWellStructure),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CSquareWellStructure_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CSquareWellStructure objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CSquareWellStructure_methods,             /* tp_methods */
    CSquareWellStructure_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CSquareWellStructure_init,      /* tp_init */
    0,                         /* tp_alloc */
    CSquareWellStructure_new,                 /* tp_new */
};
...
void addCSquareWellStructure(PyObject *module) {
    ...
    if (PyType_Ready(&CSquareWellStructureType) < 0)
        return;

    Py_INCREF(&CSquareWellStructureType);
