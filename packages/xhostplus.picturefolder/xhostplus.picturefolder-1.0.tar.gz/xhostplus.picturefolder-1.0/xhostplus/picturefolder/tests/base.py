...
def setup_product():
    ...
    import xhostplus.picturefolder
    zcml.load_config('configure.zcml', xhostplus.picturefolder)
    ...
    ztc.installPackage('xhostplus.picturefolder')
...
setup_product()
ptc.setupPloneSite(products=['xhostplus.picturefolder'])
