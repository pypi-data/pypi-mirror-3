...
class QtImagen():
    ...
    def __init__(self, ruta):
        ...
        self._imagen = pygame.image.load(ruta)

    def ancho(self):
        return self._imagen.get_rect().width

    def alto(self):
        return self._imagen.get_rect().height
...
class Android(motor.Motor):
    ...
    def timerEvent(self, event):
        ...
        #self.update()
        pygame.draw.circle(self.screen, (255, 100, 100), (100, 100), 50)
        pygame.display.flip()
