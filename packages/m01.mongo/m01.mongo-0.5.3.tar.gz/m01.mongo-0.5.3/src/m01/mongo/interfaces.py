...
_ = zope.i18nmessageid.MessageFactory('m01') 
...
class IMongoListData(zope.location.interfaces.ILocation):
    ...
    def order(orderNames=None):
        """Order items by the given name order and set names by enumeration"""
...
class IMongoItem(ICreatedModified):
