...
def setup_product():
    ...
    import my315ok.watermarkImage
    zcml.load_config('configure.zcml', my315ok.watermarkImage)
    ...
    ztc.installPackage('my315ok.watermarkImage')
...
setup_product()
ptc.setupPloneSite(products=['my315ok.watermarkImage'])
