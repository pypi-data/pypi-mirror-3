...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coop_cms_articlesection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('coop_cms', ['ArticleSection'])

        # Adding field 'Article.logo'
        db.add_column('coop_cms_article', 'logo', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Article.summary'
        db.add_column('coop_cms_article', 'summary', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Article.section'
        db.add_column('coop_cms_article', 'section', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='coop_cms_article_rel', null=True, blank=True, to=orm['coop_cms.ArticleSection']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ArticleSection'
        db.delete_table('coop_cms_articlesection')

        # Deleting field 'Article.logo'
        db.delete_column('coop_cms_article', 'logo')

        # Deleting field 'Article.summary'
        db.delete_column('coop_cms_article', 'summary')

        # Deleting field 'Article.section'
        db.delete_column('coop_cms_article', 'section_id')
    ...
    models = {
        ...
        'coop_cms.article': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'coop_cms_article_rel'", 'null': 'True', 'blank': 'True', 'to': "orm['coop_cms.ArticleSection']"}),
