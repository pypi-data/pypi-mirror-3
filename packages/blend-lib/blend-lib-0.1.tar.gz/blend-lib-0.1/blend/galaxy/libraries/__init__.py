...
class LibraryClient(Client):
    ...
    def upload_small_file_from_filename(self, library_id, filename, folder_id=None,
        ...
        with open(filename, 'r') as f:
            contents = f.read()
        return self.upload_file_contents(library_id, contents, folder_id, file_type, dbkey)
