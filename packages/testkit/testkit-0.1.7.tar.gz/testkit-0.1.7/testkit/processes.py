...
class ProcessManager(object):
    ...
    def run(self):
        # Force garbage collection before anything happens.
        # This is to ensure that the multiprocess won't segfault I'm not sure
        # if this really works but it seems to remedy the issue.
        gc.collect()
        try:
