...
cdo and ncview (an ncdf package). It should be working with normal numpy data. However,
if you want to process netcdf-files, we recommend to use the ncdf-extra (still not available)
