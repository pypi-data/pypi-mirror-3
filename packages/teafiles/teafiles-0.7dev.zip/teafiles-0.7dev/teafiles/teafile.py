...
class TeaFile:
    ...
    def _write(self, *itemValues):
        ...
        if use_time_decoration:
            itemValues = tuple([f._decorateTime(itemValues) for f in self._description.itemdescription.fields])
