# -*- coding: utf-8 -*-
#------------------------------------------------------------------------------
# file: $Id: test_client.py 29 2012-06-30 22:52:55Z griff1n $
# lib:  pysyncml.test_client
...
import sqlalchemy
import pysyncml
from .common import adict, ts_iso
...
class TestClient(unittest.TestCase, test_helpers.XmlEqual):
  ...
  def test_sync_init(self):
    ...
    self.assertEqual(dict(cli_memo=dict(mode=pysyncml.SYNCTYPE_SLOW_SYNC, conflicts=0,
                                        hereAdd=1,hereMod=0,hereDel=0,hereErr=0,
                                        peerAdd=0,peerMod=0,peerDel=0,peerErr=0)),
                     stats)

#------------------------------------------------------------------------------
# end of $Id: test_client.py 29 2012-06-30 22:52:55Z griff1n $
#------------------------------------------------------------------------------
