; YAREST 32-bit windows installer script
...
!define AppOutputFile "yarest-x86.exe"
...
Function InstallShortcuts
  ...
  CreateShortCut "${AppShortcutsFolder}\${AppName}.lnk" "$PYTHON_DIR\Scripts\yarest.exe" "" "$INSTDIR\${AppIcon}"
FunctionEnd

Function un.InstallShortcuts
  SetShellVarContext all
  Delete "${AppShortcutsFolder}\${AppName}.lnk"
