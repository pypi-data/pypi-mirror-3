...
from pypapi.app.forms import connectDb, connectCm
...
def demoData():
    s = db.session
    a1 = entities.Author(idauthor=1, name=u"Tarun J", surname=u"Tejpal")
    g1 = entities.Genre(idgenre=1, description=u"Comedy")
    g2 = entities.Genre(idgenre=2, description=u"Romance")
    g3 = entities.Genre(idgenre=3, description=u"Thriller")
    b1 = entities.Book(idbook=1, isbn=u"978-88-11-68102-1",
...
# create db and content managementutilities
db = createDatabase()
