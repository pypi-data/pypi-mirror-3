...
class Test(unittest.TestCase):
    ...
    def test_mod_lp1(self):
        ...
        try:
            ...
            return
        self.assertEqual(ans[0],("glpsol.lp",))
        self.assertFileEqualsBaseline(ans[0][0], currdir+"test2_convert.lp")
    ...
    def test_mod_lp2(self):
        ...
        try:
            ...
            return
        self.assertEqual(ans[0],("glpsol.lp",))
        self.assertFileEqualsBaseline(ans[0][0], currdir+"test3_convert.lp")
