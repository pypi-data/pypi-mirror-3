...
class Buttons(ViewletBase):
    ...
    def two_click_import_script(self):
        ...
        """ % {
            ...
            'txt_help' : self.context.translate(_(u'Only if you activate the buttons, data will get sent to Facebook, Twitter or Google. This data might get stored in the USA. Get more information by clicking on <em>i</em>.')),
