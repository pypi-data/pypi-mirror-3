...
class Import(object):
    ...
    .. note::
        ...
        `sys.argv` is integrated if you want to use the command line parser.
    ...
    @property
    def server(self):
        """ Return the current socket connection to the OpenERP server (xml-rpc)
        of this session.
    ...
    @property
    def host(self):
        """ Return the current connection host of this session.
    ...
    @property
    def port(self):
        """ Return the current connection port of this session.
    ...
    @property
    def db(self):
        """ Return the current database name of this session.
    ...
    @property
    def user(self):
        """ Return the current username of this session.
    ...
    @property
    def uid(self):
        """ Return the current UID of this session. Mandatory for a self.server call
    ...
    @property
    def pwd(self):
        """ Return the current password of this session
    ...
    def lines(self):
        ...
        :returns: list of lines (already a list)
    ...
    def connect(self, host=HOST, port=PORT, user=USER, pwd=PWD, dbname=DB):
        """Set nistance's contants needed to initialize a connection to openerp
    ...
    def _check_mapping(self, mapping):
        """Check mapping fro semantic errors

         .. note::
        
            Also start the logger and initialize the connection to OpenERP
