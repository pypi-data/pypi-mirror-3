...
static PyObject * CPearlNecklaceModelError = NULL;
...
static void
CPearlNecklaceModel_dealloc(CPearlNecklaceModel* self)
{
...
static PyObject *
CPearlNecklaceModel_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    CPearlNecklaceModel *self;
    
    self = (CPearlNecklaceModel *)type->tp_alloc(type, 0);
   
    return (PyObject *)self;
}

static int
CPearlNecklaceModel_init(CPearlNecklaceModel *self, PyObject *args, PyObject *kwds)
{
    if (self != NULL) {
        ...
        self->model = new PearlNecklaceModel();
...
static PyMemberDef CPearlNecklaceModel_members[] = {
    {name_params, T_OBJECT, offsetof(CPearlNecklaceModel, params), 0, def_params},
	{name_dispersion, T_OBJECT, offsetof(CPearlNecklaceModel, dispersion), 0, def_dispersion},     
    {name_log, T_OBJECT, offsetof(CPearlNecklaceModel, log), 0, def_log},
    {NULL}  /* Sentinel */
};
...
/** Read double from PyObject
    ...
    @return double
*/
double CPearlNecklaceModel_readDouble(PyObject *p) {
...
static PyObject *evaluateOneDim(PearlNecklaceModel* model, PyArrayObject *q){
 ...
 * @return: numpy array object 
 */
 static PyObject * evaluateTwoDimXY( PearlNecklaceModel* model, 
...
#pragma omp parallel for
        ...
        return PyArray_Return(result); 
		    ...
		    PyErr_SetString(CPearlNecklaceModelError, 
                   "CPearlNecklaceModel.evaluateTwoDimXY couldn't run.");
	        return NULL;
		}      	
}
/**
 ...
 *
 */ 
static PyObject * evalDistribution(CPearlNecklaceModel *self, PyObject *args){
	PyObject *qx, *qy;
	PyArrayObject * pars;
	int npars ,mpars;
    ...
    self->model->thick_string = PyFloat_AsDouble( PyDict_GetItemString(self->params, "thick_string") );
    self->model->sld_string = PyFloat_AsDouble( PyDict_GetItemString(self->params, "sld_string") );
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CPearlNecklaceModelError, 
	    	"CPearlNecklaceModel.evalDistribution expects a q value.");
		return NULL;
	}
    // Check params
    ...
    if(PyArray_Check(pars)==1) {
	    ...
	    if(npars==1) {
		    ...
		    PyErr_SetString(CPearlNecklaceModelError, 
                   "CPearlNecklaceModel.evalDistribution expect numpy array of one dimension.");
	        return NULL;
		}
	    ...
	    if(mpars!=2) {
	    	PyErr_SetString(CPearlNecklaceModelError, 
	    		"CPearlNecklaceModel.evalDistribution expects a list of dimension 2.");
	    	return NULL;
	    }
	     ...
	     if (PyArray_Check(qx) && PyArray_Check(qy)) {
		    ...
		    PyErr_SetString(CPearlNecklaceModelError, 
                   "CPearlNecklaceModel.evalDistribution expect 2 numpy arrays in list.");
	        return NULL;
	     }
	}
	PyErr_SetString(CPearlNecklaceModelError, 
                   "CPearlNecklaceModel.evalDistribution couln't be run.");
	return NULL;
 ...
 */
static PyObject * run(CPearlNecklaceModel *self, PyObject *args) {
	...
	if ( !PyArg_ParseTuple(args,"O",&pars) ) {
	    PyErr_SetString(CPearlNecklaceModelError, 
	    	"CPearlNecklaceModel.run expects a q value.");
		return NULL;
	}
	...
	if( PyList_Check(pars)==1) {
	    ...
	    if(npars!=2) {
	    	PyErr_SetString(CPearlNecklaceModelError, 
	    		"CPearlNecklaceModel.run expects a double or a list of dimension 2.");
	    	return NULL;
	    }
	    // We have a vector q, get the q and phi values at which
	    // to evaluate I(q,phi)
	    q_value = CPearlNecklaceModel_readDouble(PyList_GET_ITEM(pars,0));
	    phi_value = CPearlNecklaceModel_readDouble(PyList_GET_ITEM(pars,1));
	    // Skip zero
	    if (q_value==0) {
		...
		q_value = CPearlNecklaceModel_readDouble(pars);		
 ...
 */
static PyObject * calculate_ER(CPearlNecklaceModel *self) {
 ...
 */
static PyObject * calculate_VR(CPearlNecklaceModel *self) {
 ...
 * @return: function value
 */
static PyObject * runXY(CPearlNecklaceModel *self, PyObject *args) {
	...
	if( PyList_Check(pars)==1) {
	    ...
	    // to evaluate I(qx,qy)
	    qx_value = CPearlNecklaceModel_readDouble(PyList_GET_ITEM(pars,0));
	    qy_value = CPearlNecklaceModel_readDouble(PyList_GET_ITEM(pars,1));
	    return Py_BuildValue("d",(*(self->model))(qx_value,qy_value));

	} else {

		// We have a scalar q, we will evaluate I(q)
		qx_value = CPearlNecklaceModel_readDouble(pars);		
		
		return Py_BuildValue("d",(*(self->model))(qx_value));
	}	
}

static PyObject * reset(CPearlNecklaceModel *self, PyObject *args) {
    

    return Py_BuildValue("d",0.0);
}

static PyObject * set_dispersion(CPearlNecklaceModel *self, PyObject *args) {
	PyObject * disp;
	const char * par_name;

	if ( !PyArg_ParseTuple(args,"sO", &par_name, &disp) ) {
	    PyErr_SetString(CPearlNecklaceModelError,
	    	"CPearlNecklaceModel.set_dispersion expects a DispersionModel object.");
		return NULL;
	}
    ...
    if (!strcmp(par_name, "radius")) {
	    ...
	    PyErr_SetString(CPearlNecklaceModelError,
	    	"CPearlNecklaceModel.set_dispersion expects a valid parameter name.");
		return NULL;
	}
...
static PyMethodDef CPearlNecklaceModel_methods[] = {
...
static PyTypeObject CPearlNecklaceModelType = {
    PyObject_HEAD_INIT(NULL)
    0,                         /*ob_size*/
    "CPearlNecklaceModel",             /*tp_name*/
    sizeof(CPearlNecklaceModel),             /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)CPearlNecklaceModel_dealloc, /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    ...
    "CPearlNecklaceModel objects",           /* tp_doc */
    0,		               /* tp_traverse */
    0,		               /* tp_clear */
    0,		               /* tp_richcompare */
    0,		               /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    CPearlNecklaceModel_methods,             /* tp_methods */
    CPearlNecklaceModel_members,             /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset */
    (initproc)CPearlNecklaceModel_init,      /* tp_init */
    0,                         /* tp_alloc */
    CPearlNecklaceModel_new,                 /* tp_new */
};
...
void addCPearlNecklaceModel(PyObject *module) {
    ...
    if (PyType_Ready(&CPearlNecklaceModelType) < 0)
        return;

    Py_INCREF(&CPearlNecklaceModelType);
