...
from coopr.pyomo.base import ConstraintBase, Objective, Var, maximize
...
if FD_available:
    ...
    intrinsic_function_expressions = {
        ...
        'asinh':FuncDesignerExt.arcsinh,
        'acosh':FuncDesignerExt.arccosh,
        'atanh':FuncDesignerExt.arctanh,
        'pow':fd_pow,
