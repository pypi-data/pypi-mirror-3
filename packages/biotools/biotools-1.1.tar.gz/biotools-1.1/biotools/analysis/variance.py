...
[1] var		= the measure of sequence variation,
[2] starts = the starting positions for each gene model in amino acids,
[3] ends	 = the ending positions for each gene model in amino acids, and
[4] count  = the number of sequences with a particular gene model.
