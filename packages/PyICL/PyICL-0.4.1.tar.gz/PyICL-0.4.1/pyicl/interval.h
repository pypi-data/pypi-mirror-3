...
#ifndef PYICL_INTERVAL_HPP_JORE_110217
#define PYICL_INTERVAL_HPP_JORE_110217
...
struct interval_exposer {
	...
	typedef typename traits_t::domain_type                 domain_t;     ///< Domain type.
...
//		bp::scope( bp_class ).attr( "__asymmetric__" ) = icl::is_asymmetric_interval< domain_t >::value;
        ...
        // Miscellaneous
        bp_class.def( "distance",                 icl::distance< exposed_t > );
...
//		bp_class.def( "__ge__",                   ptr_greaterequals, "Greater or equals." );
	...
	PYICL_DECLARE_FN_1(bool, contains, ::boost::icl::contains, const exposed_t, (domain_t, (exposed_t, BOOST_PP_NIL)))
...
#endif //PYICL_INTERVAL_HPP_JORE_110217
