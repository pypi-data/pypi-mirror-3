# -*- coding: utf-8 -*-
#------------------------------------------------------------------------------
# file: $Id: state.py 28 2012-06-28 03:26:05Z griff1n $
# lib:  pysyncml.state
...
state related objects, including :class:`pysyncml.session.Session`,
:class:`pysyncml.session.Request` and
:class:`pysyncml.session.Command`.
...
class Session(adict):
  ...
  @property
  def nextMsgID(self):
    # TBD: what if the session is in server mode... then the msgID is
...
#------------------------------------------------------------------------------
# end of $Id: state.py 28 2012-06-28 03:26:05Z griff1n $
#------------------------------------------------------------------------------
