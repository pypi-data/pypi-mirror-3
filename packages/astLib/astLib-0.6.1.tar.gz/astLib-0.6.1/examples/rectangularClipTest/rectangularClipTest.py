...
clip=astImages.clipRotatedImageSectionWCS(d, wcs, RADeg, decDeg, [widthDeg, heightDeg])
clipnr=astImages.clipImageSectionWCS(d, wcs, RADeg, decDeg, [widthDeg, heightDeg])
...
d=img[0].data
clip=astImages.clipUsingRADecCoords(img[0].data, wcs, 30.0, 50.0, -55.0, -50.0)
