...
__version__ = open("src/lazr/json/version.txt").read().strip()
...
setup(
    ...
    long_description=generate(
        'src/lazr/json/README.txt',
        'src/lazr/json/NEWS.txt'),
    license='LGPL v3',
    install_requires=[
        'setuptools',
        'lazr.enum>=1.1.4',
        ],
    url='https://launchpad.net/lazr.json',
