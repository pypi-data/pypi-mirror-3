...
def setup_product():
    ...
    import collective.doormat
    zcml.load_config('configure.zcml', collective.doormat)
    ...
    ztc.installPackage('collective.doormat')
...
setup_product()
ptc.setupPloneSite(products=['collective.doormat'])
