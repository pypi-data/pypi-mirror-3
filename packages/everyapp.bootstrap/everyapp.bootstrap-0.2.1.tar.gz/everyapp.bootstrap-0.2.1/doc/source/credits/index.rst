...
This chapter provides the list of the authors of *everyapp.bootstrap*, as well as
a list of acknowledgements to the people and organizations that the author(s)
would like to thank.
