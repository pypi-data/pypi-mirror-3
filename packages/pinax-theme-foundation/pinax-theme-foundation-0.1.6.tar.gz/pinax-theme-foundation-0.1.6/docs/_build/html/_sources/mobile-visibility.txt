...
allow you to target for display on various devices with different screen resolutions using *'show/hide-for-x'* where "x" can be 
...
Will display the two lines corresponding to you you devices screen size.
