#!/usr/bin/env python
"""
TEST_STDLIB_IO_ERR.PY -- test script for sub-package STDLIB of package PLIB
...
if hasattr(signal, 'SIGCHLD'):
    ...
    from plib.stdlib.io import SigChldServerMixin, SigIntServerMixin
    
    from stdlib_io_testlib import IOChannelTest
    from stdlib_io_testlib_blocking import BlockingHandler, ForkingServer
    from stdlib_io_testlib_blocking import SocketClient as BlockingClient
