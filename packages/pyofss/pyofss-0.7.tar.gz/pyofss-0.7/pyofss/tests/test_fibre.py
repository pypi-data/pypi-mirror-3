...
class Default_parameters( unittest.TestCase ):
   def test_none( self ):
      ...
      #self.assertEqual( fibre.alpha, None )
      #self.assertEqual( fibre.beta, None )
      #~self.assertEqual( fibre.gamma, 0.0 )
      #~self.assertEqual( fibre.linear, fibre.default_linear )
      #~self.assertEqual( fibre.nonlinear, fibre.default_nonlinear )
      #self.assertEqual( fibre.generate_dispersion, fibre.default_dispersion )
# ==============================================================================
class Bad_parameters( unittest.TestCase ):
   ...
   def test_wrong_type( self ):
      ...
      pass
# ==============================================================================
class Check_input_and_output( unittest.TestCase ):
