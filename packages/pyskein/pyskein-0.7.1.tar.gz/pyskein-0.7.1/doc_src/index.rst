...
`Skein hash algorithm`_, one of the finalists in the
`NIST SHA-3 Competition`_. While originally based on the
...
`GNU General Public License`_. Its highlights are:
