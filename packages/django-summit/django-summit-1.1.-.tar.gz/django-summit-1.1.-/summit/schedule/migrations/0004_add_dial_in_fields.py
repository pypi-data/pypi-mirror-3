...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.requires_dial_in'
        db.add_column('schedule_meeting', 'requires_dial_in', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Room.has_dial_in'
        db.add_column('schedule_room', 'has_dial_in', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.requires_dial_in'
        db.delete_column('schedule_meeting', 'requires_dial_in')

        # Deleting field 'Room.has_dial_in'
        db.delete_column('schedule_room', 'has_dial_in')
