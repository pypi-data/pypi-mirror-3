    ...
    try:
      while True:
        ...
        try:
          ...
          test_result = portal.createTestResult(revision, [],
              config['test_node_title'], False, test_suite_title,
          ...
          if test_result is not None:
            ...
            if revision != test_result.test_revision:
              previous_revision = test_result.test_revision
