...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.created_date'
        db.add_column('blog_status', 'created_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 9, 21)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Status.created_date'
        db.delete_column('blog_status', 'created_date')
    ...
    models = {
        ...
        'blog.status': {
            'Meta': {'ordering': "['-twitter_id']", 'object_name': 'Status'},
            'created_at': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'created_date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tweet': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
