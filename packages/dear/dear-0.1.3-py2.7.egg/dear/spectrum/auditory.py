...
class GammatoneSpectrum(SpectrumBase):
    ...
    def walk(self, N=84, freq_base=A1, freq_max=A8,  start=0, end=None, each=True, combine=False, twin=0.020, thop=0.010):
...
class Y2(Y1):
    ...
    def walk(self, N=84, freq_base=A1, freq_max=A8,  start=0, end=None, each=True, combine=False, twin=0.020, thop=0.010, gamma=10, cof=4000):
        ''''''
        samplerate = self.audio.samplerate
        level = 6
        vpre = np.zeros((1,N))
...
class Y5(Y4):
    ...
    def walk(self, N=84, freq_base=A1, freq_max=A8,  start=0, end=None, each=True, combine=False, twin=0.020, thop=0.010, gamma=10, cof=4000, tinteg=0.020, tconst=0.008):
        ''''''
        samplerate = self.audio.samplerate
        tinv = 1./samplerate
