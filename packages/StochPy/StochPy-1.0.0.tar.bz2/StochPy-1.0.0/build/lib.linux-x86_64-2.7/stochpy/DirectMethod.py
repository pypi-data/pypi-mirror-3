...
Furthermore, even larger problems arise if the model contains distinct processes operating on different timescales [2].
...
class DirectMethod(PySCeS_Connector):
  ...
  def Execute(self,Trajectories,Endtime,Timesteps,TrackPropensities):       
    ...
    while traj<=self.Trajectories:
      ...
      if self.IsTrackPropensities:                                       # Moved (14 September 2011)
      ...
      all_species = copy.copy(self.species) # species_ids
