...
!define AppVersion "0.5"                              ; current version information
...
!define PythonDownloadUrl "http://python.org/ftp/python/2.7.3/python-2.7.3.msi"
; file name only of the Python msi installer
!define PythonDownloadFile "python-2.7.3.msi"
