...
class OhsnapApp(SubCommandApp):
    """An abstract class to represent a subcommand for the ohsnap base
    application."""
...
class OhsnapBackupApp(OhsnapApp):
    """The backup application which inherits :class:`.OhsnapApp`"""

    def snap(self):
        """Creates an ohsnap formatted backup.  The tarsnap archive is labeled
        in a unique format like so:
        ``ohsnap:creationtime:retention:name``."""
...
class OhsnapListApp(OhsnapApp):
    """The list application which inherits :class:`.OhsnapApp`"""
...
class OhsnapPurgeApp(OhsnapApp):
    """The purge application which inherits :class:`.OhsnapApp`"""
