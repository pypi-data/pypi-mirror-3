...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.is_private'
        db.add_column('coop_cms_document', 'is_private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.is_private'
        db.delete_column('coop_cms_document', 'is_private')
