# $Id: test_models_groups.py 0875d8dc7fd1 2011/12/31 18:06:04 patrick $
# -*- coding: utf-8 -*-
...
class UnitTestModelsGroupsGroup(ModelTestCase):
    ...
    def _make_one(self):
        """Make a ``Group`` object."""
        from ..models.groups import Group
        group = Group(u'Les éditeurs', u"Un groupe d'éditeurs")
        group.group_id = self._group_id
        return group
    ...
    def test_repr(self):
        ...
        self.assertTrue('%d' % self._group_id in info)
...
class UnitTestModelsGroupsGroupPerm(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        self.assertTrue(str(self._group_id) in info)
