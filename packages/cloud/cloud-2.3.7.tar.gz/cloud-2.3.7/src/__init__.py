...
def setkey(api_key, api_secretkey, server_url=None, restart=False, immutable=False):
    """
    Connect cloud to your PiCloud account,
    Your *api_key* and *api_secretkey* are provided by PiCloud on the 
