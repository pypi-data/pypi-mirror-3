...
# Generated 2012-02-07 09:42:35.115718 by PyXB version 1.1.3
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __mechanism = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'mechanism'), 'mechanism', '__urnoasisnamestcSAML2_0acclassesPasswordProtectedTransport_CTD_ANON_mechanism', STD_ANON, required=True)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    __credentialLevel = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'credentialLevel'), 'credentialLevel', '__urnoasisnamestcSAML2_0acclassesPasswordProtectedTransport_CTD_ANON__credentialLevel', STD_ANON_)
