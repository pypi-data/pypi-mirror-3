...
from ztfy.blog.browser.interfaces.skin import IBaseIndexView, IBaseForm, \
                                              IDialogAddFormButtons, IDialogDisplayFormButtons, IDialogEditFormButtons, \
...
from ztfy.skin.form import AjaxForm, AddForm, DialogAddForm, EditForm, DialogEditForm, DisplayForm, DialogDisplayForm
...
class BaseDisplayForm(DisplayForm):
...
class BaseDialogDisplayForm(AjaxForm, BaseDisplayForm, DialogDisplayForm):
