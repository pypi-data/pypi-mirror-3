...
def translate(x):
  '''translate( sequence )
Translate a nucleotide using the standard genetic code. The sequence parameter 
can be either a string or a Sequence object. Stop codons are denoted with an
asterisk (*).
'''
