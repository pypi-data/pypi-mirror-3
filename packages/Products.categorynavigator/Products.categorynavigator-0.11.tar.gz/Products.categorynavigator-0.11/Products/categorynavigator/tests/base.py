...
def setup_product():
    ...
    import Products.categorynavigator
    zcml.load_config('configure.zcml', Products.categorynavigator)
    ...
    ztc.installPackage('Products.categorynavigator')
...
setup_product()
ptc.setupPloneSite(products=['Products.categorynavigator'])
