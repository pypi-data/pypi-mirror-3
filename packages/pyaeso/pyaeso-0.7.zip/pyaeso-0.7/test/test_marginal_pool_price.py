...
AESO_BUG_1_CANARY = '''"09/01/2004 02","01:00","20.01"
...
class TestRemoteShort(unittest.TestCase):
    ...
    def _ignore_test_aeso_bug_1(self):
        ...
        Disabling test until this is sorted out.  See aeso.mpp tests.
        '''
...
class TestMarginalPoolPrice(unittest.TestCase):
    def assertMppDtEquals(self, cells, naive_ab_dt, is_dst = None):
        self.assertEqual(ets._marginal_pool_price_dt(cells), ab_to_utc(naive_ab_dt, is_dst))
